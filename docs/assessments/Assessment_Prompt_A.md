...
* **Project Design Guidelines**: `IMPLEMENTATION_CHECKLIST.md` and `AGENTS.md` - **MANDATORY reference documents**
...
You **MUST** compare the current implementation against the requirements specified in the project documentation. For **EACH** requirement section, explicitly state:
