...
- **DRY** [MAJOR]: Duplicate code block
  - Found in 3 locations
  - Files: /app/scripts/check_contract_coverage.py, /app/scripts/check_dependency_boundaries.py, /app/scripts/check_styles_budget.py
- **DRY** [MAJOR]: Duplicate code block
  - Found in 2 locations
...
- **DRY** [MAJOR]: Duplicate code block
  ...
  - Files: /app/scripts/generate_bibliography_data.py, /app/scripts/validate_accessibility.py, /app/src/tools/convert_all_latex.py
- **DRY** [MAJOR]: Duplicate code block
  - Found in 3 locations
...
- **DRY** [MAJOR]: Duplicate code block
  - Found in 2 locations
  - Files: /app/tests/test_validate_accessibility.py
- **DRY** [MAJOR]: Duplicate code block
  - Found in 2 locations
  - Files: /app/tests/test_validate_accessibility.py
- **DRY** [MAJOR]: Duplicate code block
