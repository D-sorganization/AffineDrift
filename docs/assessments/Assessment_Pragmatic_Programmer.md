...
- **DRY** [MAJOR]: Duplicate code block
  - Found in 2 locations
  - Files: /app/scripts/generate_bibliography_data.py, /app/scripts/seo_audit.py
- **DRY** [MAJOR]: Duplicate code block
  - Found in 4 locations
...
- **DRY** [MAJOR]: Duplicate code block
  - Found in 2 locations
  - Files: /app/scripts/generate_assessment_summary.py, /app/src/tools/matlab_utilities/scripts/matlab_quality_check.py
- **DRY** [MAJOR]: Duplicate code block
  - Found in 3 locations
