...
PR #4306 is protected-merged and published as 022fc21c808ba76ba1bdf67855d89cc0e0090dcc. Replay coverage is 92.65%. Four unrelated generated outputs changed during validation (dates, formatting and hashes of pre-existing inputs); those changes were restored. Every push hook passed. Main CI 34327124830, textbook build 34327124759 and deployment 34327124720 succeeded. The exact live artifact 10095422596 was downloaded and inspected: 956/956 checks across 239 routes, zero failures, serious/critical axe findings, retries or transient responses. This verifies the manifest's Quarto routes, not every auxiliary HTML resource.
