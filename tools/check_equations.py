...
def find_qmd_md_files(root_dir):
    files_list = []
                ...
                while i < length:
                    ...
                    if curr == '$':
                        if i + 1 < length and content[i+1] == '$':
                             ...
                             errors.append(f"Line {start_line}: Encountered '$$' inside inline math starting at line {start_line}")
                             i += 2
                             break
                        ...
                        if has_leading_space:
                             ...
                             if not re.match(r'^\s*[\d\.,]+\s*$', content_str):
                                 errors.append(f"Line {start_line}: Inline math has leading space: '${content_str}$'")
