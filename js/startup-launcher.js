...
(function () {
  ...
  function createSplashScreen() {
    ...
    if (document.body) {
      ...
      // If body not ready, wait for it and set progressElement after insertion
   ...
   */
  function hideSplash() {
    // Guard against duplicate calls during fade animation
    if (!state.splashElement ||
        state.splashElement.classList.contains('ad-splash-exit') ||
        state.splashElement.classList.contains('ad-splash-hidden')) {
      return;
    }
