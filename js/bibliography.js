...
(function () {
  ...
  const init = async () => {
    ...
    listEl.addEventListener("click", (event) => {
      // ⚡ Bolt Optimization: Consolidate multiple .closest() queries into a single CSS selector to reduce JS-to-C++ boundary crossings
      ...
      const entryId = target.dataset.detailsId || target.dataset.entryId;
