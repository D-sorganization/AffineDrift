...
The ZVCF therefore isolates the configuration-dependent passive component of generalized forces. The pure input contribution is then inferred from the deviation of $F_{\mathrm{total}}$ from $F_{\mathrm{ZVCF}}$.
