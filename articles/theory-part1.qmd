...
This mathematical operation has a profound physical interpretation. By inverting the Schur complement, we are not just solving a matrix equation; we are calculating the **Effective Mobility** of the system. This term $H_{qq}$ tells us exactly how much joint acceleration results from a unit of torque, accounting for the fact that some energy "leaks" into vibrating the shaft. It is the distinct mechanical signature of the golfer's agency in a flexible world.
