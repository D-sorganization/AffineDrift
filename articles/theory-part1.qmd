...
This control-affine structure is the backbone for the drift--input decomposition and the counterfactual constructions developed in the next sections. Specifically, the identification of the drift vector field $f(x)$ and the input vector fields $g(x)$ allows us to mathematically separate the passive evolution of the system from the active intervention of the golfer. In Part II, we will exploit this separation to define the Zero Torque Counterfactual and formalize the causal decomposition of forces.
