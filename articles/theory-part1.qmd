...
The velocity of any differential mass element $dm = \rho(s)ds$ on the shaft is given by the transport theorem, summing the rigid-body transport velocity and the local elastic velocity:
