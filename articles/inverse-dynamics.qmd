...
The total generalized moment required to produce the observed angular acceleration is fixed by the kinematics. Drag contributes $-2.0$ Nm, so the net moment available from the hands is reduced. Given a measured hand force of $F_{\text{hands}} = 24.5$ N (5.5 lbs) with drag included:

$$
F_{\text{hands}} = 24.5 \text{ N}, \quad M_{\text{hands}} = 24.5 \text{ N} \times 0.597 \text{ m} = 14.6 \text{ Nm}
$$
...
The residual couple required to balance the equations of motion:
