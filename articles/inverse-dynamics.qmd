...
$$
\begin{align}
\sum \mathbf{F} &= m\mathbf{a}_{\text{COM}} \label{eq-force_balance}\\
\sum \mathbf{M}_{\text{COM}} &= \mathbf{I}\boldsymbol{\alpha} + \boldsymbol{\omega} \times (\mathbf{I}\boldsymbol{\omega}) \label{eq-moment_balance}
\end{align}
$$
