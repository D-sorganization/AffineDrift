...
$$
\begin{aligned}
\sum \mathbf{F} &= m\mathbf{a}_{\text{COM}} \tag{1} \label{eq-force_balance}\\
\sum \mathbf{M}_{\text{COM}} &= \mathbf{I}\boldsymbol{\alpha} + \boldsymbol{\omega} \times (\mathbf{I}\boldsymbol{\omega}) \tag{2} \label{eq-moment_balance}
\end{aligned}
$$ {#eq-euler-laws}
