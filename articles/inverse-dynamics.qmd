...
=======
Since we know $\sum \mathbf{M}_{\text{COM}}$ from @eq-moment_balance, we can calculate the required moment about point $P$.
>>>>>>> origin/main
...
=======
**Proposition (Couple Transformation Formula).** For points along a one-dimensional grip, the equivalent couple at point $i$ is given by:
>>>>>>> origin/main
...
:::: {.callout-note title="Example: Single Force Creating Apparent Couple"}
>>>>>>> origin/main
