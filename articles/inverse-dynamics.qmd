...
1. **Spatial ambiguity (Spatial Distribution):** Where are forces applied along the grip?
    
2. **Drift-input ambiguity (Drift vs. Control):** What portion of measured forces is passive vs. active?
    
3. **External force ambiguity (External Forces & Aerodynamics):** How much do neglected external forces (especially air resistance) affect the results?
