...
For the canonical next step, continue to [Part 5: Contraction](./part-5-contraction.html), [Part 6: Hybrid Systems](./part-6-hybrid.html), and [Part 7: Residual-Aware Control](./part-7-residual-aware.html). The older advanced source article remains available as a reference manuscript: [Residual-Aware Control](../tangent-hyperplane-articles/Advanced/Residual-Aware_Control.html).
...
- **[Superposition in Affine Control Systems](../superposition.html)** — The fixed-state linear map whose dropped higher-order terms this part bounds
:::
