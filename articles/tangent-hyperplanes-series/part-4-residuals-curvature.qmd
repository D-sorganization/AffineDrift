...
aliases:
  - ../tangent-hyperplane-articles/Drafts_Original_Articles/Tangent_Hyperplanes_Series_Package/04_Residuals_and_Curvature.html
  - ../tangent-hyperplane-articles/Drafts_Original_Articles/Tangent_Hyperplanes_Series_Package/A_Mathematical_Appendix.html
---
...
where $H$ represents the Hessian tensor of $f$. These second derivatives capture the curvature, and they propagate through the dynamics to create the quadratic residual.
...
This quadratic scaling encodes the **margin before breakdown**. You can use it to set error tolerances, determine when to re-linearize, and decide if a linear approximation is good enough for your application.

## Residuals in DDP/iLQR

In iterative linear-quadratic methods, the iteration scheme handles residuals implicitly:
...
For the canonical next step, continue to [Part 5: Contraction](./part-5-contraction.qmd), [Part 6: Hybrid Systems](./part-6-hybrid.qmd), and [Part 7: Residual-Aware Control](./part-7-residual-aware.qmd). The older advanced source article remains available as a reference manuscript: [Residual-Aware Control](../tangent-hyperplane-articles/Advanced/Residual-Aware_Control.qmd).
