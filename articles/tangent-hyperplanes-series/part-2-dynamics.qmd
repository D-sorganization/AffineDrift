...
We can extract a linear system from nonlinear dynamics, and that linear system is exact infinitesimally. This opens the door to powerful control tools. In [Part 3](./part-3-control.qmd), we will see how differential dynamic programming and iterative linear-quadratic regulation exploit it to design nonlinear controllers.
