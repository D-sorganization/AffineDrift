...
The ability to extract a first-order linear system from smooth nonlinear dynamics is the local fact used by many trajectory-optimization methods. In [Part 3](./part-3-control.html), we will see how differential dynamic programming and iterative linear-quadratic regulation use this variational equation inside iterative nonlinear-control algorithms.
