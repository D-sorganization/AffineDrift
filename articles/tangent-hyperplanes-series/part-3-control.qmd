...
The site's [Stability-Optimality Duality](../tangent-hyperplane-contraction/chapters/04-stability-optimality-duality.html) framework reveals a deep connection: **The Riccati matrix $S(t)$ serves a dual role.**
...
- **[Force and Mobility Ellipsoids](../force-mobility-matrices.html)** — The geometric view of the state-dependent input map that LQR and iLQR exploit
- **[Degrees of Freedom and the Curse of Dimensionality](../degrees-of-freedom-and-dimensionality.html)** — Why high-dimensional mechanical systems stay tractable for these local methods
:::
