...
aliases:
  - ../tangent-hyperplane-articles/Tangent_Hyperplanes.html
  - ../tangent-hyperplane-contraction/index.html
  - ../tangent-hyperplane-contraction/chapters/01-foundations.html
  - ../tangent-hyperplane-articles/Drafts_Original_Articles/Tangent_Hyperplanes_Series_Package/Landing_Manifesto.html
  - ../tangent-hyperplane-articles/Drafts_Original_Articles/Tangent_Hyperplanes_Series_Package/01_Tangent_Hyperplanes_I_Geometry.html
categories:
- tangent-space
---
...
Now that we have a rigorous understanding of tangent spaces, we can ask: what happens to the dynamics when the system evolves along a manifold? In [Part 2](./part-2-dynamics.html), we will see how the equations of motion decompose into a linear system on the moving tangent space.
...
- **[Screw Theory Reference](../screw-theory-reference.html)** — Lie algebra se(3), twists, and infinitesimal generators of rigid-body motion
- **[Tangent-Space Series](../../pages/tangent-hyperplanes.html)** — The series hub: full reading order, provenance, and companion material
- **[The Null Space of the Constraint Jacobian](../null-space-constraint-jacobian.html)** — Constraint gradients and their kernels: the implicit-surface view of the same geometry
