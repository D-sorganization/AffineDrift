...
Two observations matter for interpreting this. First, the comparison is against marker-based systems, which are themselves corrupted by soft tissue artefact — so "agreement with marker-based" is not the same as "accuracy," and disagreement is not automatically the markerless system's error. Second, markerless systems remove the marker-placement variability that is a large source of between-lab inconsistency, which means they can be *more* repeatable while being less accurate in a given trial.
