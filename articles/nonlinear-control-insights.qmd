    ...
    <div class="critics-comments-inner">
      ...
      <div class="critic-item">
        ...
        <div class="author-response">
          <strong>Our Response:</strong> This is a valid physiological nuance. However, at the system level of joint torques, the control-affine approximation ($\tau = G(x)u$) remains robust. The "Skeletal Baseline" validation (Part 5) shows that treating inputs as additive torques captures a large fraction of the variance in clubhead motion (empirical estimate; see [citation needed]), suggesting that variable stiffness effects are second-order at high swing speeds.
        </div>
      </div>
