  ...
  <div class="laymans-terms-content">
    <div class="laymans-terms-inner">
      <p class="laymans-terms-intro">
        This article looks at the golf swing through the lens of "Nonlinear Control Theory"—a field of math used to control robots and spacecraft. It reveals that a swing isn't just about muscle power; it's about partnering with physics.
      </p>

      <div class="laymans-item">
        <h3>Drift vs. Input</h3>
        <p>The "Drift" is what the club and body want to do naturally because of momentum and gravity. "Input" is what your muscles actually do. The swing is a constant dance between these two.</p>
        <div class="analogy">
<strong>Think of it like:</strong> Steering a sled down a hill. The gravity and speed (Drift) provide the main movement; you just nudge it left or right (Input). You aren't pushing the sled the whole way—you're guiding its momentum.
        </div>
      </div>

      <div class="laymans-item">
        <h3>Underactuation (You Can't Control Everything)</h3>
        <p>You cannot directly force every part of the club to be exactly where you want it at every moment because your hands are far away from the clubhead. You have to influence the clubhead indirectly by moving your body and arms.</p>
        <div class="analogy">
<strong>Think of it like:</strong> Cracking a whip. You only move the handle, but if you time your movements right, the energy travels down the whip and the tip moves incredibly fast. You don't grab the tip and move it yourself.
        </div>
      </div>

      <div class="laymans-item">
        <h3>Inertial Harvesting (The "Brake" Effect)</h3>
        <p>To speed up the club, you actually have to slow down your body segments in a specific order (sequencing). By "braking" the larger parts, energy is catapulted into the smaller, faster parts.</p>
        <div class="analogy">
<strong>Think of it like:</strong> A car crash test dummy. When the car hits a wall and stops abruptly (brakes), the dummy keeps flying forward at high speed (energy transfer). In golf, you stop your hips and torso so the club "flies" forward.
        </div>
      </div>

      <div class="key-takeaway">
        <strong>Key Takeaway:</strong> An elite golf swing doesn't fight physics; it sets up a powerful natural motion (drift) and then skillfully steers it to the ball.
      </div>
    </div>
  </div>
</section>
