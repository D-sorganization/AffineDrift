...
*   **[Part 1: Affine Control Interpretation](theory-part1.html):** Establishes the fundamental $\dot{x} = f(x) + G(x)u$ equation.
*   **[Part 2: Counterfactual Trajectories](theory-part2.html):** Defines the **ZTCF** and **ZVCF** counterfactuals derived from this structure.
*   **[Part 3: Drift Invariance](theory-part3.html):** Proves the **Drift Invariance** property essential for causal attribution.
*   **[Part 5: Skeletal Baseline Numerical Validation](theory-part5.html):** Provides the numerical **Skeletal Baseline** validation of these control-theoretic concepts.
...
- [Degrees of Freedom and the Curse of Dimensionality](degrees-of-freedom-and-dimensionality.html) — Why few inputs can steer a high-dimensional drift-dominated system
- [Passive Distributed Control: Frans Bosch Framework](passive-distributed-control.html) — Exploiting passive dynamics rather than canceling them
- [Ideomotor Theory and the Predictive Brain Model](ideomotor-theory-and-predictive-brain.html) — Forward-model prediction and sensory error minimization in motor control
- [The Physics of Golf: Chapter 24 Motor Control I](The_Physics_of_Golf/quarto/ch24_motor_control_brain.html) — The brain as controller: delayed estimation, actuation limits, and control-affine formulation
- [The Physics of Golf: Chapter 27 Passive and Distributed Control](The_Physics_of_Golf/quarto/ch27_passive_distributed_control.html) — Mechanics, distributed feedback, and stability in golf dynamics
- [Volume IV: Human Motor Control](../books/human-motor-control.html) — Book volume on neural architecture, internal models, and computational movement intelligence
- [Learning Path: Biomechanics & Motor Control](../resources/learning-path-biomechanics.html) — Comprehensive 14-week learning path through biomechanics and motor control
