...
- which clubhead trajectories are mechanically reachable,

- which degrees of freedom cannot be independently influenced,

- how torque applied at one joint influences dynamics at another through geometric coupling.
This offers a mathematically grounded explanation for the structure of reachable motions.

This mathematical structure formalizes the biomechanical concept of **sequencing**. In a Lie bracket interpretation, proximal deceleration is not an aesthetic choice but a necessary control action to trigger non-holonomic acceleration in distal segments—effectively "steering" the drift field to generate clubhead speed that cannot be produced by direct torque alone.
