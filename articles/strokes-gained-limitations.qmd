...
- **[Impact Mechanics and Ball Flight](impact-mechanics-and-ball-flight.html)** — The collision and launch physics that produce the shot-level outcomes strokes-gained aggregates
- **[Rotation-Induced Spin](rotation-induced-spin.html)** — The spin channel whose measured value strokes-gained inference absorbs
- **[The Physics of the Rolling Putt](putting-roll-models.html)** — Putting outcomes, the component where baseline sensitivity bites hardest
- **[Simulating the Green](green-simulation.html)** — Simulated shot distributions as an alternative to Broadie-style aggregation
:::
