...
For experimental contrast, the finite model inputs are labeled "early drive" and "retain early/release late." They are not a survey of coaching doctrine or coaching cues. The comparison tests a behavior established in double-pendulum studies since the 1960s: higher modeled clubhead speeds can occur when distal drive is delayed [@cochran1968; @jorgensen1970; @milburn1982; @pickering1999]. The contribution here is a reproducible force, power, work, and counterfactual audit rather than a claim of novelty for delayed release.
...
- **E2 Drift/Control Split & E4 Robertson–Winter Accounting:** Pointwise ZTCF decomposition and interface power balance $\mathbf{F} \cdot \mathbf{v} + \tau \omega$, using analytic COM acceleration and an exact interpolated early/late integration boundary.
