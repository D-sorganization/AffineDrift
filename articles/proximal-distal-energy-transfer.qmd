...
geometry, enter delivery with compatible relative club motion, and reduce direct
distal opposition only when drift power is positive. Optimize club speed
...
parameter or configuration perturbations, or if negative grip work or peak force
dominates the speed gain. It is also weakened if matching distal
laboratory-frame state removes the effect, or if a two-hand model attributes the
gain to direct wrist work rather than interaction-force transport.
