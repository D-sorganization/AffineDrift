...
However, this passive transmission comes with a critical caveat: because neither constraint torques nor transmitted proximal torques can be directly controlled at the wrist, they inherit all the variability present in the proximal segments that generate them. As noted in discussion of this phenomenon:

::: {.callout-note}
## Source note
The following passage describes the transmission property. The specific wording is paraphrased from internal AffineDrift review notes; a citable primary source should be substituted when available.
:::

> *"[These torques] are dependent on motion of other components—any rotation or torque in the forearm will directly affect these and there are no degrees of freedom in the wrist to modulate or control any of these torques induced from the forearm axis. It is forced to transmit whatever it receives on the rotational axis."*
