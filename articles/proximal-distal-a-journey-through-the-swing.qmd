...
link-citations: true
filters:
  - ../scripts/filters/companion-hierarchy.lua
format:
  html:
    toc: true
...
For the complete measured treatment behind this tour, see the summary article
[Proximal-to-Distal Energy Transfer in the Golf Swing](proximal-distal-energy-transfer.html),
which connects the companion narrative to the monograph's evidence ledger.
