...
To change the models yourself, open the
[interactive proximal–distal workbench](proximal-distal-model-workbench.html).
Its paired PyQt6 and React/Tauri interfaces share guided experiments, hover
help, falsifiers, limitations, and a searchable glossary.
