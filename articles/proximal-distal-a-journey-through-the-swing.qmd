...
- **A Concrete Picture** begins with an ordinary situation you can hold in mind
  while the mechanics develops.
...
[complete scientific monograph](https://raw.githubusercontent.com/D-sorganization/UpstreamDrift/main/docs/research/proximal_distal_energy_transfer/proximal_distal_energy_transfer.pdf).
...
[transmission robustness study](https://github.com/D-sorganization/UpstreamDrift/blob/main/docs/research/proximal_distal_energy_transfer/data/transmission_robustness_study.json)
...
**Zero-Torque Counterfactual Force:** The force predicted at a fixed state when
the selected torque input is set to zero for a pointwise decomposition.
