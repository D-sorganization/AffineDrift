...
- **[Screw Theory Reference](screw-theory-reference.html)** — Twists, wrenches, and the spatial force-torque duality in screw coordinates
- **[Rotation Representations Reference](rotation-representations-reference.html)** — Kinematics and coordinate representations for 3D orientation and angular velocity
- **[Mathematical Notation Reference](../pages/notation.html)** — Normative symbols, control-affine notation, and counterfactual definitions
- **[Affine Control Interpretation (Theory Part 1)](theory-part1.html)** — Foundational control-affine derivation of the drift and input decomposition
- **[The Physics of Golf: Chapter 5 Affine Structure](The_Physics_of_Golf/quarto/ch05_affine_structure.html)** — Multibody equations of motion and drift-control ratio in textbook form
- **[The Physics of Golf Glossary](The_Physics_of_Golf/quarto/glossary.html)** — Definitions of Lagrangian mechanics, drift, control, and ZTCF
:::
