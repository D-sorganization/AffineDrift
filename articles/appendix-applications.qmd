...
- **[Part 5: Numerical Consistency Check](theory-part5.html)** — The reproducibility protocol that governs the simulations these applications rely on
- **[Part 3: Drift Invariance and Force Taxonomy](theory-part3.html)** — Defines the drift/input partition this appendix applies to practical contexts
- **[Affine Nature of the Golf Swing](affine-nature-golf-swing.html)** — The unabridged theoretical foundations monograph of the same framework
:::
