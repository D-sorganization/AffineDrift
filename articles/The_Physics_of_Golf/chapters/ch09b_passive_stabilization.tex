...
\end{equation}
where $M_1 = 0.5, M_2 = 0.1 \, \mathrm{kg}\cdot\mathrm{m}^2$, $D_i = 0.5$ (Ns/rad), and $K_i(\alpha) = K_{0,i} + \alpha \Delta K_i$ with $K_{0,1} = 50, K_{0,2} = 20, \Delta K_1 = 50, \Delta K_2 = 30$ (N\cdot m/rad).
