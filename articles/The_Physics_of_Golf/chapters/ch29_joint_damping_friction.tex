...
\[
\massmat\ddot{\bm{q}} + \cormat\dot{\bm{q}} + \gravvec = \bm{B}(\bm{q})\control + \bm{J}_c^T(\bm{q})\constraintforce
\]
...
\[
\boxed{\massmat\ddot{\bm{q}} + \cormat\dot{\bm{q}} + \bm{D}(\bm{q})\dot{\bm{q}} + \gravvec = \bm{B}(\bm{q})\control + \bm{J}_c^T(\bm{q})\constraintforce}
\]
