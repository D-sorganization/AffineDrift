...
\begin{definition}{Viscous Damping}{viscous_damping}
...
\begin{definition}{Nonlinear Damping Models}{nonlinear_damping}
\begin{enumerate}
...
\begin{principle}{Proximal Damping Has System-Wide Cost}{proximal_damping_cost}
...
\begin{theorem}{Damping and Stability}{damping_stability}
...
\begin{definition}{Damping Ratio Regimes}{damping_ratio}
\begin{itemize}
...
\begin{definition}{Quality Factor (Q-factor)}{q_factor}
