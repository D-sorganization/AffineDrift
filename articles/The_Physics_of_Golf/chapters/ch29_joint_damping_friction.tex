...
Empirically, this derivative is approximately $-0.02$ m/s per (Nm$\cdot$s/rad) of damping.\citeneeded{sensitivity-analysis or simulation source for club-speed derivative with respect to joint damping} Thus:
\begin{itemize}
