...
\begin{figure}[H]
\centering
% every node/.style={align=center}: several nodes below break their text with
% \\, and a node's text is set in LR mode unless it is told how to align
% multiple lines -- without this each one is "LaTeX Error: Not allowed in LR
% mode". Matches the convention in Volume V, whose diagrams compile.
...
\begin{example}{Inertia at the Shoulder}{ch04_inertia_shoulder}
...
\begin{definition}{Centrifugal Acceleration}{ch04_centrifugal}
...
\begin{example}{Centrifugal Force in a Driver Swing}{ch04_centrifugal_numbers}
...
\begin{example}{Centrifugal Force in the Golf Swing}{ch04_centrifugal_golf}
...
\begin{definition}{Coriolis Force (in Rotating Frames)}{ch04_coriolis}
...
\begin{example}{Coriolis Torque in the Downswing}{ch04_coriolis_golf}
...
\begin{definition}{Constraint Forces}{ch04_constraint_forces}
...
\begin{definition}{Wrench}{ch04_wrench}
