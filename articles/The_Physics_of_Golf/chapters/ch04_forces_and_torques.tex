...
\textbf{Numerical illustration:} If $\ddot{\theta}_1 = 40 \text{ rad/s}^2$, $M_{11} = 1.54 \text{ kg m}^2$, $\bm{C} \dot{\bm{q}} \approx 15 \text{ N m}$, and $\bm{g} \approx 5 \text{ N m}$, then:
\begin{equation}
