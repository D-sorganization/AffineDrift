...
\textit{Note on moment of inertia:} We use the point-mass approximation $I = M L_{\text{cm}}^2$. For link 1: $I_1 = 2.5 \times 0.175^2 = 0.077$ kg\,m$^2$. For link 2: $I_2 = 1.5 \times 0.5^2 = 0.375$ kg\,m$^2$.
