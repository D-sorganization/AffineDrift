...
&\approx 0.015 + 2.5 \cdot (0.35)^2 + 2.5 \cdot (0.5)^2 + 0.4 + 2 \cdot 2.5 \cdot 0.35 \cdot 0.5 \cos(-5°) \\
...
&= (2.5 \cdot 0.175 + 2.5 \cdot 0.35) \cdot 9.81 \cdot \sin(0°) + 2.5 \cdot 9.81 \cdot 0.5 \cdot \sin(-5°) \\
&\approx 0 + 12.25 \cdot (-0.087) \\
&\approx -1.1 \text{ N m}
\end{align}
...
&= 2.5 \cdot 0.35 \cdot 0.5 \cdot (10)^2 \cdot \sin(-5°) \\
&= 2.5 \cdot 0.35 \cdot 0.5 \cdot 100 \cdot (-0.087) \\
&\approx -3.8 \text{ N m}
\end{align}
...
\begin{itemize}
\item The effective inertia $M_{11} \approx 2.22$ kg m$^2$ determines how much acceleration results from a given applied torque.
\item The gravitational torque $g_1 \approx -1.1$ N m acts to rotate the system back toward the downward position (negative indicates restoring direction).
\item The centrifugal term $C_{21} \approx -3.8$ N m arises from the high rotational velocity and acts to influence the relative joint motion.
\end{itemize}
