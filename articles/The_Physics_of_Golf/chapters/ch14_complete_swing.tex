...
In the early downswing, the DCR is low (approximately 1--3; see Chapter~\ref{ch:zero_torque_counterfactual}). Low DCR indicates high control authority: the magnitude of the control field $G(\state)\control$ can significantly alter the state evolution compared to the drift field alone.
...
Mid-downswing lasts from approximately $t=0.08$ to $t=0.12$ s. During this phase, the angular velocity of the body and the magnitudes of gravitational, Coriolis, and centrifugal accelerations increase substantially. The DCR rises (approximately 3--10; see Chapter~\ref{ch:zero_torque_counterfactual}), indicating that the drift field magnitude increases relative to the achievable control magnitude.
...
\begin{enumerate}
\item \textbf{High centrifugal acceleration:} The rotation rate of the clubhead about the shoulder is substantial (approximately 15--20~rad/s, combining shoulder, elbow, and wrist joint velocities through the kinetic chain; the shoulder joint itself contributes $\sim$8--10~rad/s \citep{Nesbit2005}). The centrifugal acceleration scales with $\omega^2$, producing large accelerations (approximately 500--1000~m/s$^2$). This acceleration pulls the shaft outward and, through centrifugal stiffening, increases the effective bending stiffness of the shaft.
...
Late downswing lasts from approximately $t=0.12$ to $t=0.16$ s (40 milliseconds before impact). During this phase, angular velocities reach their maximum. The shoulder joint angular velocity reaches approximately 10--12~rad/s \citep{Nesbit2005}, while the \emph{clubhead} angular velocity about the shoulder---the sum of all joint angular velocities through the kinetic chain---reaches 30+~rad/s. The control authority is minimal; the DCR reaches 5--30 (see Chapters~\ref{ch:05_affine_structure} and~\ref{ch:zero_torque_counterfactual}), indicating that the drift field dominates the state evolution.
...
\begin{enumerate}
\item \textbf{Extremely high centrifugal acceleration:} The clubhead centripetal acceleration about the instantaneous center of rotation reaches approximately 2000~m/s$^2$ ($\sim$200$g$) or higher \citep{Nesbit2005}. (This is much larger than the $\sim$18$g$ figure in Chapter~\ref{ch:04_forces_and_torques}, which uses a simplified shoulder-referenced centripetal calculation; the full acceleration includes contributions from all three kinetic chain joints.) The centrifugal stiffening of the shaft is at its maximum, increasing the effective bending stiffness. The elastic restoring force of the bent shaft reaches its maximum magnitude.
...
\item \textbf{Heat:} The inefficiency of muscle contraction dissipates energy as heat. Muscle mechanical efficiency (mechanical work output divided by metabolic energy input) is approximately 20--25\% \citep{Nesbit2005}; the remainder is dissipated thermally.
...
The overall energy transfer efficiency from muscle input to ball kinetic energy is relatively low \citep{Nesbit2005}. This low efficiency results from multiple dissipative mechanisms: muscle thermal losses, damping in connective tissue, air resistance, and joint friction. The energy transfer efficiency depends on the swing mechanics, biomechanical parameters, and equipment properties \citep{Nesbit2005}.
