...
\begin{enumerate}
\item \textbf{High centrifugal acceleration:} The rotation rate is now large (perhaps $15{-}20$ rad/s at the shoulder). The centrifugal acceleration of the clubhead is enormous (perhaps 500--1000 m/s$^2$). This is pulling the shaft outward and stiffening it simultaneously.
...
Understanding drift and control teaches a profound lesson: \emph{most of the swing is beyond your control.}
...
\begin{itemize}
\item \textbf{Chapter 3} showed how even a simple double pendulum exhibits drift and control.

\item \textbf{Chapter 5} developed the affine structure that underlies all golfs physics.

\item \textbf{Chapter 6} introduced the ZTCF, the autopilot trajectory.

\item \textbf{Chapters 7--10} showed how constraints and energy flow reshape the swing.

\item \textbf{Chapter 11} revealed how shaft flexibility contributes entirely to drift.

\item \textbf{Chapter 12} debunked myths about fascia and placed it correctly in the framework.

\item \textbf{Chapter 13} showed how multiple disciplines all speak the language of drift and control.
...
\item \textbf{The shaft catapult effect is real.} Stored elastic energy in the bent shaft is released near impact, boosting clubhead speed by 5--15\%.
...
% ─────────────────────────────────────────────────────────────────
\begin{exercises}{Chapter 14 Exercises}{exercises:ch14}
