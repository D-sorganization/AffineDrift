...
% TODO(citation): "0.6--0.8 seconds" backswing duration should be sourced from motion capture studies (e.g., Nesbit 2005, McTeigue 1994).
...
% TODO(citation): "50--100 milliseconds" transition duration should be sourced from high-speed motion capture studies (e.g., Nesbit 2005, McTeigue 1994, or similar).
...
% TODO(citation): Angular velocity ranges "$4{-}6$ rad/s at the hip, $8{-}10$ rad/s at the shoulders" during early downswing should be sourced from inverse-dynamics or motion-capture studies (e.g., Nesbit 2005, Coleman \& Rankin 2005).
...
% TODO(citation): "0.5 milliseconds" ball contact duration should cite high-speed camera studies of golf impact (e.g., Penner 2003, Gobush 1990, or similar experimental work).
