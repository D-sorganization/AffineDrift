...
% TODO(citation): "2.3 N·m per degree" shoulder stiffness is an illustrative example value, not a measured quantity here; typical ranges from impedance-control experiments can be found in Hogan (1985) or Burdet et al. (2001) if a specific value is required.
