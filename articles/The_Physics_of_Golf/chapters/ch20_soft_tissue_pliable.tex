...
Consider the upper arm during the downswing. The humerus (upper arm bone) is accelerating forward and down at perhaps 500 m/s$^2$ during peak downswing acceleration \citep{Nesbit2005}. The soft tissue hanging on the arm---the muscles, the fat, the skin---has inertial mass. This soft tissue experiences an inertial force that tries to keep it moving in its old direction. The tissue oscillates relative to the bone, creating a secondary motion superimposed on the primary swing motion.

Similarly, the torso during a full downswing rotation is not a solid block. It contains approximately 35 kg of additional mass beyond the skeletal framework: viscera, organs, blood, fat distributed throughout the abdomen \citep{DeLeva1996,Winter2009}. During the violent rotation of a golf downswing (torso angular velocity reaching 600${}^\circ$/s \citep{Hume2005}), this soft mass does not rotate in perfect lockstep with the skeletal torso. It shifts, it redistributes, it creates time-varying inertial properties that the rigid body model assumes away.
...
\begin{definition}{The Wobbling Mass Model}{wobbling_mass}
...
\begin{example}{Wobble Dynamics During Downswing}{wobble_downswing}
...
During the downswing (which lasts $\sim$0.15 seconds), the arm accelerates at peak rates of 500 m/s$^2$. This high-frequency content excites the wobble mass oscillation. Typical wobble amplitudes are 1--3 cm during the swing and post-swing phases. The wobble mass will oscillate for several cycles after the swing ends, dissipating energy through damping.
\end{example}
...
\begin{itemize}
\item Heart: $\sim$0.3 kg
\item Lungs: $\sim$1.2 kg
\item Liver: $\sim$1.5 kg
\item Kidneys: $\sim$0.3 kg
\item Stomach, intestines, spleen, pancreas: $\sim$2 kg
\item Blood: $\sim$5 kg (in the torso cavity)
\item Abdominal fat and other organs: $\sim$3--8 kg
\item \textbf{Total: approximately 13--18 kg out of the torso's total mass of $\sim$25--35 kg}
\end{itemize}
...
\begin{example}{Visceral Mass Redistribution}{visceral_redistribution}
...
\begin{definition}{Intra-Abdominal Pressure (IAP)}{iap}
...
\begin{example}{IAP Force Calculation for Golf Downswing}{iap_force}
...
\item Pelvic floor area: $\sim$0.03 m$^2$
...
\begin{example}{Model Selection Guide}{model_selection}
\begin{center}
...
\item The torso contains $\sim$50\% fluid-like material (viscera, blood) that redistributes during rotation, creating time-varying inertial properties.
