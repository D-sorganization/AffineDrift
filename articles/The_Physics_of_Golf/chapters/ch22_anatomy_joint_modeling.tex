...
\[
R=I_3,\qquad e_1^T p=0,\qquad e_2^T p=0,
\qquad p=d u.
\]
...
\[
R=R_x(\alpha)R_y(\beta),\qquad
\omega=W(\alpha)\dot q,
\qquad \dot q=(\dot\alpha,\dot\beta)^T,
\]

\[
W(\alpha)=\begin{bmatrix}1&0\\0&\cos\alpha\\0&\sin\alpha\end{bmatrix},
\qquad W(\alpha)^T W(\alpha)=I_2.
\]
