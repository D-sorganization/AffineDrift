...
We've examined forces (Chapter 6), constraint forces (Chapter 7), multiple segments (Chapter 8), and parallel mechanisms (Chapter 9). Now we ask: \textbf{where does the energy go?}
...
\textbf{Energy partition: 66.45 J kinetic (81\%), 15 J potential (19\%). Most energy is in torso rotation.}
...
\textbf{Energy partition: 185 J kinetic (97\%), 5 J potential (3\%). Most energy is still in torso, but arm is accelerating.}
...
\textbf{Energy partition: Club now carries 31.25 J out of 281.25 J total, or 11\%. Energy is being transferred to the club.}
...
\textbf{Energy partition: Club carries 125 J out of 245.25 J, or 51\%. At impact, more than half the total energy is in the club.}
\end{enumerate}
...
\hline
\textbf{Phase} & \textbf{Time} & $T_1$ & $T_2$ & $T_3$ & $T_{\text{total}}$ & \textbf{Club\%} & \textbf{Notes} \\
\hline
...
\noindent\footnotesize The energy values in this table are computed from the double pendulum model with parameters from Chapter~3. They are order-of-magnitude estimates appropriate for a typical male amateur golfer (90~kg, driver swing). Individual swings will vary by $\pm$30\% depending on technique, anthropometry, and swing speed. Measured values from instrumented club and force plate studies \citep{Nesbit2005} are broadly consistent with these estimates.
\normalsize
...
\item \textbf{Energy peak:} At late downswing, kinetic energy reaches $200$ J. This is the sum of muscular work plus energy from gravity (falling arms during downswing adds $\sim 100$ J).
...
\item \textbf{Efficiency:} A typical swing is about 50\% efficient—100 J of muscular input results in 50 J of kinetic energy in the ball. Losses come from air resistance, inefficient constraint transfers, and incomplete energy capture at impact.
...
\textbf{What comes next:} This concludes our journey through the physics of the golf swing. We've examined forces (Chapter 6), their transmission through constraints (Chapter 7), multi-segment systems (Chapter 8), parallel body structure (Chapter 9), and energy flow (Chapter 10).
