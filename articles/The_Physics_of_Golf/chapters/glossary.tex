...
\item[Clubhead speed] The velocity of the clubhead at impact. This is the primary determinant of ball distance (along with launch angle and spin rate). Clubhead speed varies widely across skill levels; representative ranges are published by launch monitor manufacturers and in the biomechanics literature \cite{penner2003physics, cochran1968search}.

\item[Coefficient of restitution (COR)] The ratio of the separation speed to the approach speed in a collision. The USGA limits COR for drivers to 0.83; typical measured values for conforming equipment are near this limit \cite{penner2003physics}. Note: COR is a speed ratio, not an energy ratio; the fraction of kinetic energy transferred also depends on the mass ratio of ball to clubhead.
...
\item[Degrees of freedom] The number of independent ways a system can move. A single rigid body in 3D space has 6 degrees of freedom (3 translational, 3 rotational). The number of degrees of freedom in a human arm depends on the modeling assumptions for shoulder, elbow, and wrist joints.
