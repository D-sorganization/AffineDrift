...
\item[DCR] Abbreviation for drift-to-control ratio. The raw textbook usage is the ratio of passive to active torques or, more generally, drift magnitude to control magnitude. In the late downswing, DCR can be much greater than 1.
...
\item[Kinetic chain] See kinematic chain.
