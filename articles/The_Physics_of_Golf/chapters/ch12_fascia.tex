...
% ─────────────────────────────────────────────────────────────────
\begin{laymansbox}{Why We Must Separate Fact from Fiction}{ch12:myth_landscape}
...
\begin{definition}{Fascia}{ch12:fascia}
...
\begin{mythreality}{Fascial Slings as Power Generators}{ch12:slings}
...
\begin{mythreality}{Fascia as an Energy Storage Spring}{ch12:spring}
...
\begin{mythreality}{Myofascial Meridians and Kinetic Chains}{ch12:meridians}
...
\begin{mythreality}{Fascia-Specific Training Methods}{ch12:training}
...
\begin{tikzpicture}[scale=1.0]
  ...
  \draw[fill=brown!30] (0,0) rectangle (4,1) node[midway] {\small Bone};
...
\begin{example}{Fascia Coupling in the Shoulder}{ch12:shoulder_coupling}
...
\begin{laymansbox}{Viscoelasticity and Stretch Speed}{ch12:viscoelasticity}
...
\begin{principle}{Fascia in Drift and Control}{ch12:fascia_drift_control}
\begin{itemize}
...
\begin{example}{Fascia and Rotator Cuff Health}{ch12:rotator_cuff}
...
\begin{laymansbox}{Why Proprioceptive Feedback Matters}{ch12:proprioception_golf}
...
\begin{principle}{Fascial Injury and Recovery}{ch12:fascial_injury}
\begin{itemize}
...
% ─────────────────────────────────────────────────────────────────
\begin{exercises}{Chapter Exercises}{ch12}
