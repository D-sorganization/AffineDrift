...
\begin{enumerate}
\item Starting from the two COM positions above, recover all entries of $M$ using $T=\tfrac12\sum_i m_i\|\dot c_i\|^2+\tfrac12J_1v_1^2+\tfrac12J_2(v_1+v_2)^2$. Explain why a COM inertia and a pivot inertia cannot be interchanged without a parallel-axis correction.
