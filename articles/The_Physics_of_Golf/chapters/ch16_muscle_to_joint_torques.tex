...
Force plate and EMG (electromyography) studies indicate that grip force is not constant but varies systematically across the phases of the swing:
\begin{itemize}
\item Early in the backswing: grip force is relatively low.
\item At the top of the backswing: grip force increases to resist gravity and prepare for the downswing.
\item During the downswing: grip force increases further as the club accelerates.
\item At impact: grip force is near its peak, providing stiffness to resist deformation and maintain club face alignment.
...
At impact, the club experiences a large force from the ball---estimates from ball-impact models suggest several thousand Newtons for a driver impact, depending on swing speed \citep{Penner2003}. This force tries to deform the shaft and move the club head. To maintain club face alignment and transmit energy efficiently, the grip must be stiff.
