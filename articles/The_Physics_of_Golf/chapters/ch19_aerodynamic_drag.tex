...
% TODO(citation): "arms move at speeds up to 10--15 m/s" and "frontal area roughly 0.05 m$^2$" are order-of-magnitude estimates; should be sourced from motion capture studies or biomechanical models (e.g., Nesbit 2005).
The moving mass of the golfer's arms and torso also experiences drag. The arms move at speeds up to 10--15 m/s (much slower than the club), and the frontal area is roughly 0.05 m$^2$ (shoulders and torso width). The drag force on the arms is:
\begin{equation}
...
% TODO(citation): "5--10\% of total kinetic energy" dissipated by drag is an illustrative order-of-magnitude estimate; exact values depend on swing speed, club design, and atmospheric conditions.
For a single swing, the energy dissipated by drag is about 5--10\% of the total kinetic energy produced (a rough estimate that depends on conditions), a small but non-negligible amount.
\end{laymansbox}
