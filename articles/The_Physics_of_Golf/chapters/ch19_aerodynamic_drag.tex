...
The moving mass of the golfer's arms and torso also experiences drag. The arms move at speeds up to 10--15 m/s (much slower than the club) \citep{Nesbit2005}, and the frontal area is roughly 0.05 m$^2$ (shoulders and torso width).\citeneeded{anthropometric source for effective upper-limb frontal area during the swing} The drag force on the arms is:
\begin{equation}
...
For a single swing, the energy dissipated by drag is about 5--10\% of the total kinetic energy produced (a rough estimate that depends on conditions), a small but non-negligible amount.\citeneeded{published measurement or CFD estimate for aerodynamic energy loss over a single golf swing}
\end{laymansbox}
