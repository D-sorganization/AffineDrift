...
\begin{warning}{The familiar ``85/15'' figure is a different quantity}{eightyfive}
Almost every golf source states this split as 85\% face and 15\% path. That figure is a \emph{vertical}-plane number---launch \emph{angle} relative to dynamic loft---and it is being applied here to a \emph{horizontal}-plane relationship.

The only peer-reviewed measurement of the horizontal ratio \cite{wood2018launch} used 157 golfers and 1{,}575 shots, tracked at 720\,fps and filtered to centred strikes, and found \textbf{76\% $\pm$ 8\% for a driver}, 69\% for a 7-iron and 61\% for a wedge, with a robot test returning 63\% for the 7-iron. The vertical ratios from the same study \emph{are} 83\%, 81\% and 72\%---which is where the folklore number comes from.
