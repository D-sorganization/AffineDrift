...
1. **Vertical force:** The golfer's weight is $90 \times 9.81 = 883$ N. As the golfer rotates and transfers weight forward, the ground reaction force increases to $1200$--$1500$ N (1.4--1.7 times body weight). This is a constraint force—the ground must push up harder to prevent the golfer from accelerating downward.
2. **Horizontal force:** As the upper body rotates and accelerates forward, the golfer's momentum would carry them forward. The friction between feet and ground provides a horizontal constraint force to prevent sliding. This force can reach $200$--$300$ N.
