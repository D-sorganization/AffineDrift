...
In Chapters~\ref{ch:zero_torque_counterfactual}--8, we modeled the golf swing as a *serial* kinematic chain: hips → shoulders → arms → club. This is pedagogically useful, but it's *biomechanically wrong*.
