...
Wait, this gives $M = -9$, which is nonsensical. The issue is that the 6 legs are *redundantly constrained*—the structure is over-constrained but still rigid. The correct formula for parallel mechanisms accounts for this via:
