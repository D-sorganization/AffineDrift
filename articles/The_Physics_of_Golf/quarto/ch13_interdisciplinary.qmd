...
Typical smash factors for drivers are 1.45--1.50. These two quantities are related but distinct: COR describes the collision efficiency, while smash factor describes the speed amplification (which depends on the mass ratio as well as COR).
