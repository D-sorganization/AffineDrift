...
Biomechanics had historically treated the swing as a list of muscle activations: "the infraspinatus fires, then the pectoralis major, then the forearm extensors," and so on. This is descriptive but not explanatory. Why does the infraspinatus fire at that moment? How does its activation contribute to the clubhead trajectory?
...
Carbon fiber composites are strong, stiff, and light. This is why they are used in golf shafts. A carbon shaft can be engineered to have specific stiffness properties: the bending stiffness (described by $EI$ in [Chapter 11](./ch11_flexible_shaft.qmd#sec-flexible_shaft)) can be tuned by varying the fiber orientation and the resin matrix.
...
## Synthesis: The ZTCF Family Framework Unifies These Perspectives
...
In the context of injury prevention, use the affine framework to argue why optimizing the ZTCF (through technique) might be more effective long-term than simply strengthening muscles. What evidence would be needed to validate this hypothesis?
