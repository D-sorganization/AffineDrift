...
From equation @eq-cor_definition:
$$
\begin{aligned}
v_b' - v_c' = e \cdot v_c
\end{aligned}
...
From equation @eq-momentum_conservation:
$$
\begin{aligned}
...
::: {.callout-note}
## Effective Mass {#sec-ch28_effective_mass}
...
How is this possible if the collision is isolated? The mechanism is that grip force (axial tension) changes the effective mass $m_{\text{eff}}$ participating in the collision. A tighter grip increases shaft pre-tension, which couples more of the arm mass into the collision. The effective mass rises slightly, and by equation @eq-ball_velocity_after, if $m_{\text{eff}}$ increases, $v_b'$ increases (slightly).
