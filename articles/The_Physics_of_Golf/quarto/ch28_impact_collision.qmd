...
Biomechanical analyses using high-speed camera tracking and force plate measurements suggest effective mass values in the range:
$$
\begin{aligned}
m_{\text{eff}} \approx 1.1 \text{ to } 1.2 \times m_{\text{clubhead}}
\end{aligned}
$$
<!-- TODO: citation needed for the effective mass estimate (1.1--1.2× clubhead mass) from high-speed camera and force plate studies -->
...
The second argument is even more powerful. During the downswing, the centripetal acceleration required to swing a 200g clubhead at approximately 90 mph in an arc of roughly 4 feet (typical values for an intermediate golfer; values vary by club and individual) creates enormous tension along the shaft.
<!-- TODO: citation needed for representative clubhead mass (200g), swing speed (90 mph), and arc radius (4 feet) values used in this calculation -->
