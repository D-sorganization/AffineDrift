...
Note: this formula uses clubhead mass $m_c$. In practice, the *effective mass* at impact is larger (Section @sec:ch28_effective_mass), typically $m_{\mathrm{eff}} \approx 1.05$--$1.3 \times m_c$, because the shaft and proximal arm contribute inertia. The spread across this range depends on shaft stiffness, hand/grip stiffness, and grip position---values at the upper end are reached only when a stiff shaft and firm grip couple substantial arm inertia into the collision window [@worobets2012effects]. Using $m_{\mathrm{eff}}$ instead of $m_c$ increases the predicted smash factor slightly and matches measured values more closely.
...
Across launch-monitor and high-speed video studies spanning a range of shaft stiffnesses and grip conditions, reported effective-mass ratios fall in the band [@worobets2012effects; @miura2001parametric]:
$$
\begin{aligned}
