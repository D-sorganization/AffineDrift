...
- $\bm{R}(\bm{q}) \in \mathbb{R}^{n_m \times n_j}$: the moment arm matrix (Zajac 1989 convention [@Zajac1989]), whose entry $R_{ji}(\bm{q})$ is the moment arm of muscle $j$ about joint $i$. Equivalently, rows index muscles and columns index joints.
\end{itemize}
