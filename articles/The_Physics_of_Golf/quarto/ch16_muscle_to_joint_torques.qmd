...
Force plate and EMG (electromyography) studies suggest that grip force changes during the swing [<!-- TODO: citation needed for EMG measurements of grip force modulation throughout the golf swing -->]. The following are illustrative estimates of typical patterns; actual values vary with golfer and swing type:
...
At impact, the club experiences a large force from the ball (roughly 5000--8000 N for a driver impact, depending on swing speed [<!-- TODO: citation needed for measured ball-on-club impact force magnitudes -->]). This force tries to deform the shaft and move the club head. To maintain club face alignment and transmit energy efficiently, the grip must be stiff.
