...
Force plate and EMG (electromyography) studies suggest that grip force changes during the swing [<!-- TODO: citation needed for EMG measurements of grip force modulation throughout the golf swing ; exact values depends on individual biomechanics -->]. The following are illustrative estimates of typical patterns; actual values vary with golfer and swing type:
- Early in the backswing: grip force is relatively low (perhaps 20--30\% of maximum).
- At the top of the backswing: grip force increases to resist gravity and prepare for the downswing (perhaps 40--50\% of maximum).
- During the downswing: grip force increases further (perhaps 60--80\% of maximum).
- At impact: grip force may peak at 80--100\% of maximum, providing stiffness to resist deformation and maintain club face alignment.
...
At impact, the club experiences a large force from the ball (illustrative estimate: roughly 5000--8000 N for a driver impact, depending on swing speed; exact values vary [<!-- TODO: citation needed for measured ball-on-club impact force magnitudes ; exact values depends on individual biomechanics -->]). This force tries to deform the shaft and move the club head. To maintain club face alignment and transmit energy efficiently, the grip must be stiff.
