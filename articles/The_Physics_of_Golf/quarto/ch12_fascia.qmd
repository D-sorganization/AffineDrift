...
In this simplified mechanical picture, the golf swing forces are large---the clubhead experiences high centripetal and tangential accelerations, on the order of hundreds of $g$ at impact (@sec-04_forces_and_torques works through the specific numbers; [@Jorgensen1994] reports similar orders of magnitude), and these forces are transmitted through the arm to the shoulder to the torso, and eventually to the ground. The fascia in the rotator cuff, the arm, and the torso is critical for distributing these forces so that no single tendon or muscle attachment is overloaded.
