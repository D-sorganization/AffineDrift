...
This is a representative example, not a universal measurement; golf swing and impact studies report clubhead speeds in this general range and contact windows on the order of milliseconds [@nesbit2005three; @cross2014impact].
...
- After impact, the ball follows a trajectory. You see where it lands, but the visual feedback arrives too late to alter the already-completed swing; sensorimotor learning therefore relies more on prediction and stored error signals than on real-time correction [@wolpert2011principles; @krakauer2019motor].
