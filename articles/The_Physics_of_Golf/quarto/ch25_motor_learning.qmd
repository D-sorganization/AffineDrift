...
Consider the moment of impact. The clubhead, which may be traveling at approximately 90 mph or more for advanced golfers (illustrative; varies with skill level), undergoes rapid deceleration during ball contact (contact duration is typically estimated at roughly 0.5 ms for a driver; illustrative estimate, depends on ball construction and swing speed <!-- TODO: add citation for typical clubhead speed and impact contact duration values, e.g., high-speed photography studies -->). This requires an enormous force from the ground (reaction force). This force must be transferred through the body to the club.
...
Learning the golf swing, in Bernstein's framework, is a progression from freezing (beginners: few DOF, low efficiency) to coupling (intermediate: moderate DOF, moderate efficiency) to exploiting (experts: many DOF, high efficiency), exactly the progression Bosch emphasizes for skilled movement under pressure [@bosch2020agility; @bernstein1967coordination].
...
- After impact, the ball follows a trajectory. You see where it lands (visual feedback delay that varies with distance and individual; roughly 150 ms or more is a typical estimated latency for visual processing, but depends on individual visual processing speed and attention <!-- TODO: add citation for approximate visual feedback latency in ball-sport contexts, e.g., sensorimotor neuroscience literature -->).
...
- In this illustrative learning loop, your brain compares predicted and actual outcomes. The ball landed where you expected---success! A large reward signal (dopamine) is released from the midbrain [@wolpert2011principles, @krakauer2019motor].
