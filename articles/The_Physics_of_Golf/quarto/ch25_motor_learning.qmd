...
- The shot is executed as a feedforward motor command (Chapter @sec-motor_control_brain).
...
Recall ideomotor theory from Chapter @sec-motor_control_brain: actions are represented by their effects, not by motor commands. When you focus on the ball flight (external), you activate the action effect pathway directly. Your motor system automatically retrieves the learned motor program.
