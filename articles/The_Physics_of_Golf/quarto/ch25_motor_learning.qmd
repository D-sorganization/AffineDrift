...
In 1967, Paul Fitts and Michael Posner proposed a three-stage model of motor learning that has become foundational in sports psychology and motor control [@fitts1967human]. It applies perfectly to the golf swing.
...
- The shot is executed as a feedforward motor command (see the previous chapter on the brain as controller).
...
$$\Delta w_{ij} \propto -e(t) \cdot a_i(t) \cdot c_j(t)$$ {#eq-ltd-rule}
...
Recall ideomotor theory from the previous chapter on the brain as controller: actions are represented by their effects, not by motor commands. When you focus on the ball flight (external), you activate the action effect pathway directly. Your motor system automatically retrieves the learned motor program.
