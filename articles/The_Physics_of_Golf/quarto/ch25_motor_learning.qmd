...
::: {.callout-important}
## The Setpoint Hypothesis: A Candidate Mechanistic Model

The following is a candidate mechanistic account consistent with known motor-learning neuroscience; individual claims have varying empirical support:
...
- **Automaticity (hypothesized):** Eventually, the reference trajectory is so stable and well-learned that it activates automatically, without conscious attention. The swing becomes autonomous.
