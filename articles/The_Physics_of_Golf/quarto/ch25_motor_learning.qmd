...
- After impact, the ball follows a trajectory. You see where it lands (visual feedback, roughly 150 ms or more after landing depending on distance and individual visual processing speed).
<!-- TODO: citation needed for approximate visual feedback latency (~150 ms) in the context of observing ball landing -->
