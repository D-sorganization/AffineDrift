...
Record electromyographic (EMG) signals from major muscles during the swing. These signals (motor unit action potentials) are correlated with muscle activation [<!-- TODO: citation needed for EMG-to-muscle-force models in golf biomechanics -->]. Use these measurements as *constraints* on the inverse dynamics problem:
