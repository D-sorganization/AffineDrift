...
Forward dynamics is well determined even in parallel systems when the constrained KKT system remains regular (recall @theorem:forward_wellposed). Therefore, ZTCF avoids muscle load-sharing ambiguity, but it remains model- and parameter-dependent.
