...
- **Shoulder**: the rotator cuff (supraspinatus, infraspinatus, teres minor, subscapularis) stabilizes the joint, while deltoids, pectoralis major, and latissimus dorsi generate the gross torque. Peak resultant torque in elite golfers is on the order of $\tau_{\max}^{\text{sh}} \sim 40\text{--}60$ N m [@nesbit2005three].
