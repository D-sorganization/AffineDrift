...
- **Gravity**: at impact ($\theta_1 \approx 0°$), gravity is nearly balanced. Gravity's contribution is small, maybe 5–10 N m, and mostly neutral (neither helping nor hurting).
- **Coriolis/Centrifugal**: these are huge. At 100 mph, $\dot{\theta}_1$ and $\dot{\theta}_2$ are both large. The velocity-dependent forces are on the order of 10–20 N m, and they're helping (pushing the arm in the direction it's accelerating).
- **Muscular**: the total muscular torque must be roughly $40 + 10 = 50$ N m (inertia plus gravity, minus the velocity-dependent forces that are helping). Humans can generate this.
