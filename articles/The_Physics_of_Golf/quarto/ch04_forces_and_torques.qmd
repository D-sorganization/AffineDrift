...
More precisely, the centrifugal term in $\bm{C}$ (using the canonical parameter set from Ch03 Table 3.1: $M_2 = 1.5$ kg, $L_1 = 0.35$ m, $L_{2,\text{cm}} = 0.5$ m) is:

$$M_2 L_1 L_{2,\text{cm}} \dot{\theta}_1^2 \sin \theta_2 = 1.5 \times 0.35 \times 0.5 \times 10.47^2 \times \sin(-5°) \approx -4.0 \text{ N m}$$
...
At impact ($\dot{\theta}_1 = 10.47$ rad/s, $\dot{\theta}_2 = 8.73$ rad/s, $\theta_2 = -5°$), using canonical $M_2 = 1.5$ kg:
...
The hand exerts a force on the club. That force has two components:
