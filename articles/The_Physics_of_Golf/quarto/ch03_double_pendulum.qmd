...
&\approx 0.077 + 0.306 + 0.625 + 0.4 + 0.872 \\
...
At impact:
- The total mass/inertia of the arm+club is about 1.50 kg m$^2$.
...
For comparison, a human can generate roughly 30–50 N m of torque at the shoulder (illustrative; values vary with body size, training, and joint angle <!-- TODO: add citation for peak shoulder torque capacity, e.g., inverse-dynamics golf studies -->). So gravity and centrifugal effects are much smaller than the muscular torque budget in this illustrative example. The muscles do the rest.
