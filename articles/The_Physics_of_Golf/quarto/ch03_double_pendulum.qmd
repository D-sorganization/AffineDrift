...
From $T$ (Equation @eq:ch03_T_rearranged), the terms involving $\dot{\theta}_1$ are:
...
Equations @eq:ch03_eq1_raw and @eq:ch03_eq2_raw are the equations of motion for the double pendulum. They're complicated, with many terms. Let's parse them:
...
2. **Potential Energy Change**. At address, both arms are down ($\theta_1 = 0°, \theta_2 = 0°$). At the top of the backswing, $\theta_1 = 150°, \theta_2 = -70°$. Using the parameters in Section @ch03_numerical, compute the change in potential energy. How much gravitational work is available during the downswing?
