...
For a typical golf shaft, the first bending mode natural frequency is in the range of 3--6 Hz (approximately 19--38 radians per second) [@Nesbit2005b; @MacKenzie2009]. The swing duration is about 0.2 seconds, so the shaft goes through approximately one bending cycle during the entire downswing.
...
5. **The catapult effect is real.** Elastic energy stored in the bent shaft is released near impact, providing an estimated 1--5\% extra clubhead speed (depending on swing speed and shaft fit) [@Nesbit2005b; @MacKenzie2009].
