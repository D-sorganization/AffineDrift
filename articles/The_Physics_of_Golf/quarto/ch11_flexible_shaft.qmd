...
For a typical golf shaft, the first bending mode natural frequency is in the range of 3--6 Hz (approximately 19--38 radians per second) [@Nesbit2005; @MacKenzie2009]. The swing duration is about 0.2 seconds, so the shaft goes through approximately one bending cycle during the entire downswing.
