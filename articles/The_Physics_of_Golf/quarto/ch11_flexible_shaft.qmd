...
For a typical golf shaft, the first bending mode natural frequency is in the range of about 12--15 rad/s (approximately 1.9--2.4 Hz) [@Nesbit2005; @MacKenzie2009]. The swing duration is about 0.2 seconds, so the shaft goes through roughly half a bending cycle during the entire downswing.
