...
- First-mode natural frequency: $\omega_n \approx 30$ rad/s ($\approx 5$ Hz), so shaft stiffness $\shaftstiff = \omega_n^2 m_{\text{eff}} \approx 180$ N/m and damping $\shaftdamp = 2\zeta\omega_n m_{\text{eff}} \approx 1.0$ N$\cdot$s/m.
