...
This seems small (3 N for a 50 m/s clubhead), but over the course of a downswing lasting approximately 0.25 seconds (illustrative; depends on golfer [<!-- TODO: citation needed for measured downswing duration ; exact values depends on individual biomechanics -->]) with the club accelerating and decelerating, the impulse (integrated force) can be significant. Moreover, drag acts throughout the downswing, not just at impact.
...
So the shaft alone produces a drag torque of about 0.7 N·m at the shoulder in this model. For reference, the total shoulder torque at impact is typically on the order of 50--100 N·m (illustrative range; depends on golfer and swing speed [<!-- TODO: citation needed for measured peak shoulder torque at impact during golf swing ; exact values depends on individual biomechanics -->]), so shaft drag accounts for approximately 1% of the total resistive effect in this estimate. While small for the shaft alone, the combined drag from the shaft and clubhead together is more significant (see below).
...
The moving mass of the golfer's arms and torso also experiences drag. The arms move at speeds up to 10--15 m/s (much slower than the club) [<!-- TODO: citation needed for measured arm velocities during golf downswing ; exact values depends on individual biomechanics -->], and the frontal area is roughly 0.05 m$^2$ (shoulders and torso width, an illustrative estimate). The drag force on the arms is:
$$
