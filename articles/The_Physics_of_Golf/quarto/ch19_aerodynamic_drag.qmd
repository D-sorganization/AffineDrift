...
So the shaft alone produces a drag torque of about 0.7 N·m at the shoulder. For reference, the total shoulder torque at impact is typically 50--100 N·m, so shaft drag accounts for approximately 1% of the total resistive effect. While small for the shaft alone, the combined drag from the shaft and clubhead together is more significant (see below).
