...
### Looking Ahead
After specifying aerodynamic loads, a further question is what the observed motion and boundary measurements reveal about applied loading. [The inverse-dynamics chapter](./ch18_inverse_dynamics_parallel.qmd#sec-inverse_dynamics_parallel) distinguishes net loads from individual muscle forces and shows how closed contacts, actuator redundancy, and sensor placement affect identification. A two-handed grip does not by itself prove that every inverse problem is nonunique.
