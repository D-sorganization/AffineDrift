...
description: "Drag is the force exerted by a fluid (in this case, air) on an object moving through it, opposing the motion. Unlike gravity and inertial forces (which..."
---
...
The moving mass of the golfer's arms and torso also experiences drag. The arms move at speeds up to 10--15 m/s (much slower than the club; illustrative range, depends on individual and swing speed [@Nesbit2005; @Hume2005]), and the frontal area is roughly 0.05 m$^2$ (shoulders and torso width, an illustrative estimate). The drag force on the arms is:
$$
