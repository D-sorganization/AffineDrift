...
The muscle-force model in [the muscle-force chapter](ch17_muscle_force_generation.html) and the closed-chain mechanics in [the parallel-mechanisms chapter](ch09_parallel_mechanisms.html) supply complementary details about force generation and constraints. [The complete-swing chapter](ch14_complete_swing.html) connects these mechanisms to preparation, delivery and outcome across the complete swing.

::: {.callout-note}
## On This Site

- **[Degrees of Freedom and Dimensionality](../../degrees-of-freedom-and-dimensionality.html)** — Choosing coordinates and DOF for complex spinal motion
- **[The Wrist as a Universal Joint](../../wrist-universal-joint.html)** — Contrasting serial and coupled joint idealizations
:::
