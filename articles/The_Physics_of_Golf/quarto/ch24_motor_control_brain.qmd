...
- **Noisy sensors:** Proprioceptive acuity varies by joint and is coarser at proximal joints than distal ones [@Kandel2013]. Vision has high acuity but slow feedback. The nervous system must work with uncertain, delayed measurements.
...
Signal transmission in these fibers is fast---roughly 70--120 m/s in myelinated fibers [@Kandel2013]. This means a motor command takes on the order of 30--50 ms to reach the upper limb muscles.
