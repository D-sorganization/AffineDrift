...
description: "Recall from Chapters @sec-zerotorquecounterfactual and @sec-zerotorquecounterfactual that the golf swing is a control-affine system:"
---
...
Recall from Chapters @sec-zero_torque_counterfactual and @sec-zero_torque_counterfactual that the golf swing is a control-affine system:
$$
...
- **Bounded control:** Maximum torques are limited. In this illustrative range, the shoulder can produce roughly 100--200 N$\cdot$m of torque, the elbow 100--150 N$\cdot$m, the wrist 30--50 N$\cdot$m. The brain cannot exceed these.
...
This is a *mismatch between the controller bandwidth and the plant dynamics*---a classic problem in control engineering, which we encountered as the Disturbance Rejection vs. Control (DCR) problem in Chapter @sec-zero_torque_counterfactual.
...
- In Chapter @sec-zero_torque_counterfactual, we introduced the Disturbance Rejection vs. Control (DCR) problem: high control of small disturbances, or low control of large changes. How does the bandwidth limitation of the brain (10--40 Hz) relate to the plant bandwidth (50--200 Hz) in the context of DCR?
