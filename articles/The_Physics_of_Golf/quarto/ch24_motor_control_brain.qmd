...
Total round-trip delay: approximately 250--330~ms. This exceeds the entire downswing duration. The implication is stark: **no corrective feedback is possible during the downswing.** The entire downswing is a pre-programmed ballistic action. Every ``correction'' you feel yourself making was actually planned before the downswing began, triggered by predicted (not actual) sensory feedback.
