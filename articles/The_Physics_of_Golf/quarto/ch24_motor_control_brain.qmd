...
This is a *mismatch between the controller bandwidth and the plant dynamics*---a classic problem in control engineering, which we encountered as the Drift-to-Control Ratio (DCR) problem in Chapter @sec-zero_torque_counterfactual.
...
- In Chapter @sec-zero_torque_counterfactual, we introduced the Drift-to-Control Ratio (DCR) problem: high control of small disturbances, or low control of large changes. How does the bandwidth limitation of the brain (10--40 Hz) relate to the plant bandwidth (50--200 Hz) in the context of DCR?
