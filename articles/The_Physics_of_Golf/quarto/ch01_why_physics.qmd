...
In simplified double-pendulum models, gravity and passive dynamics can account for a substantial portion of the total work during the downswing, with the model parameters explored in this book suggesting magnitudes on the order of 70--80% in certain configurations (see @ch:10_energy_transfer for the derivation). Muscular torques contribute the remainder, primarily as corrective steering.
...
### Chapter~\ref{ch:02_language_of_motion}: The Language of Motion
...
### Chapter~\ref{ch:03_double_pendulum}: The Double Pendulum
...
### Chapter~\ref{ch:04_forces_and_torques}: Forces and Torques
...
### Chapter~\ref{ch:05_affine_structure}: Drift and Control
