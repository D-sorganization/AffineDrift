...
In @sec-03_double_pendulum, we'll actually solve the equations for what happens if you let go mid-swing in a double-pendulum model with realistic golf parameters. The answer will surprise you.
