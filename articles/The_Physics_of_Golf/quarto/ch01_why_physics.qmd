...
In simplified double-pendulum models, gravity and passive dynamics can account for a substantial portion of the total work during the downswing, with the model parameters explored in this book suggesting magnitudes on the order of 70--80% in certain configurations (see @sec-energy-transfer for the derivation). Muscular torques contribute the remainder, primarily as corrective steering.
