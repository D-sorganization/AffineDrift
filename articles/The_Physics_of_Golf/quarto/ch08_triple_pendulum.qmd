...
In @sec-zero_torque_counterfactual and 7, we modeled the arm as a double pendulum: shoulder and elbow. This was useful for illustration, but it's incomplete.
...
## Triple Pendulum ZTCF Family: Passive Dynamics Become Even More Dominant {#sec-triple_pendulum_ztcf}
...
{Whip Effect}
Simulate the triple-pendulum forward ZTCF trajectory, with the declared applied generalized-control channel set to zero, from the state given in @sec-triple_pendulum_ztcf.
