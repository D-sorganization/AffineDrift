---
pagetitle: "The Triple Pendulum: Coupling, Release and Control"
description: "Derive three-link golf-swing dynamics, constraint release, segment power and task sensitivity, with verified counterfactuals and bounded wrist-control evidence."
css:
...
# The Triple Pendulum: Coupling, Release and Control {#sec-triple_pendulum}
[]{#ch-triple_pendulum}
...
::: {.callout-note}
## What an Additional Joint Lets Us Investigate

[]{#context:triple_pendulum_motivation}
...
## The Triple Pendulum Model {#the-triple-pendulum-model}
[]{#sec-triple_pendulum_setup}

::: {.callout-note}
## Three Rigid Links and Three Relative Angles
...
[]{#inplain-triple_pendulum_segments}
...
On narrow screens, scroll the figure or [open it at full size](../figures/triple_pendulum_verified.svg).


::: {#fig-triple_pendulum_diagram}

::: {.aba-diagram-scroll role="region" aria-label="Three-link geometry and computed rates; scroll horizontally" tabindex="0"}
<img src="../figures/triple_pendulum_verified.svg" alt="A fixed-pivot upper-arm, forearm and club chain at relative angles 50, 80 and 100 degrees. Over a computed 50-millisecond unforced continuation, absolute club rate falls from 57 to 15.12 radians per second while proximal rates rise.">

:::


Three-Link Geometry and an Unforced Continuation From the Declared Initial State. Absolute Club Angular Velocity Decreases in This Example; an Additional Joint Does Not Guarantee Distal Acceleration. These Are Manufactured Dynamics, Not a Measured Golf Swing.
...
## Equations of Motion for the Triple Pendulum {#equations-of-motion-for-the-triple-pendulum}
[]{#sec-triple_pendulum_eom}

::: {.callout-note}
## Kinetic Energy, Gravity and Applied Torque

[]{#theorem:triple_pendulum_dynamics}
...
::: {.callout-note}
## Complete Three-Link Inertia

[]{#triple_pendulum_mass_matrix}
...
::: {.callout-tip}
## A Computed Matrix and Its Inverse

[]{#triple_pendulum_mass_numerical}
...
### The Velocity-Dependent Terms and Their Signs {#inplain:triple_coriolis_complexity}
[]{#inplain-triple_coriolis_complexity}
...
::: {.callout-tip}
## A Signed Inertial Term

[]{#triple_coriolis_whip}
...
## The Whip Effect: What Constraint Release Changes {#the-whip-effect-sequential-joint-unlocking}
[]{#sec-whip_effect}

::: {.callout-note}
## An Ideal Release Event
...
### Why the State at Release Matters {#inplain:sequential_unlocking_why}
[]{#inplain-sequential_unlocking_why}
...
## Wrist Cock and Release as a Constraint Mechanism {#wrist-cock-and-release-as-a-constraint-mechanism}
[]{#sec-wrist_cock_release}

::: {.callout-note}
## A Pose, a Lock and a Spring Are Different Models
...
### Wrist Cock and Recoverable Energy {#inplain:wrist_cock_energy}
[]{#inplain-wrist_cock_energy}
...
## Triple Pendulum ZTCF Family: A Computed Counterfactual {#sec-triple_pendulum_ztcf}
...
::: {.table-wrapper role="region" aria-label="Computed absolute rates and tip speed; scroll horizontally" tabindex="0"}
| Time (ms) | Upper Arm (rad/s) | Forearm (rad/s) | Club (rad/s) | Tip Speed (m/s) |
| ---: | ---: | ---: | ---: | ---: |
...
Manufactured Zero-Torque Continuation: Absolute Rates and Tip Speed.
...
### Drift, Available Control and the Task Output {#constraint:triple_dcr_blowup}
[]{#constraint-triple_dcr_blowup}
...
## Comparison: Double vs. Triple Pendulum {#comparison-double-vs.-triple-pendulum}
[]{#sec-double_vs_triple_pendulum}
The comparison must specify what the two-link model represents. An upper-arm/forearm chain has no club. An arm/club chain has a wrist hinge but lumps arm shape. A torso/arm/club model has three segments but resolves different anatomy from this chapter. Counting links does not make these models interchangeable.
...
## Energy Redistribution in the Triple Pendulum {#energy-redistribution-in-the-triple-pendulum}
[]{#sec-triple_energy_redistribution}

::: {.callout-note}
## Segment Energy and Joint Power
...
To identify a particular transfer, compute each body's external and intersegment force/couple power and include gravitational and elastic terms in the chosen balance. A sequence of angular-speed peaks alone does not identify the transfer path, amount of work or actuator responsible. Nor does one body's decrease in rotational kinetic energy prove its muscles actively brake to accelerate another body.

### When a Distal Segment Can Move Faster {#inplain:distal_faster_explanation}
[]{#inplain-distal_faster_explanation}
For a single rotation with an identified rotational energy $E_{\mathrm{rot}}$,

$$
|\omega|=\sqrt{\frac{2E_{\mathrm{rot}}}{I}}.
$$
[]{#eq-energy_velocity_relation}
...
## Summary: The Triple Pendulum and the Kinetic Chain {#summary-the-triple-pendulum-and-the-kinetic-chain}
[]{#sec-triple_pendulum_summary}
...
Continue with [Zero-Torque Counterfactuals](ch06_zero_torque_counterfactual.html), [Constraint Release](ch07_constraint_forces.html), [Passive Distributed Control](ch27_passive_distributed_control.html), [Fascia Mechanics](ch12_fascia.html), and [Proximal-to-Distal Energy Transfer in the Golf Swing](../../proximal-distal-energy-transfer.html).

::: {.callout-note}
## On This Site

- **[Proximal-to-Distal Energy Transfer in the Golf Swing](../../proximal-distal-energy-transfer.html)** — Sequential power flow and release timing in linked segments
- **[Zero-Torque Counterfactual](../../zero-torque-counterfactual.html)** — Counterfactual release and passive continuation after constraint removal
:::

## Chapter Exercises and Worked Answers {#chapter-exercises-the-triple-pendulum}
### 1. Release Timing and the Comparison Being Made
