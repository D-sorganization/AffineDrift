...
M_{13} &= I_3 + m_3\!\left(L_{3,\text{cm}}^2 + L_2 L_{3,\text{cm}} \cos q_3 + L_1 L_{3,\text{cm}} \cos(q_2 + q_3)\right)
M_{23} &= I_3 + m_3\!\left(L_{3,\text{cm}}^2 + L_2 L_{3,\text{cm}} \cos q_3\right)
