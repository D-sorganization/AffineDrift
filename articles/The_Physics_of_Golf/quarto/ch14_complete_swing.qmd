...
The fraction of muscular power output ultimately transferred to the ball is not well established in the literature [citation needed for specific efficiency values]. However, it is widely accepted that elite golfers are more efficient at transferring energy to the clubhead than amateurs, losing less energy to heat, damping, and suboptimal sequencing.
...
Understanding drift and control teaches an important lesson: *most of the swing is beyond your control.*
...
1. **The late downswing clubhead path:** Once you are in mid-to-late downswing, the path is determined by drift. You cannot steer it without impossibly large muscle torques.
...
This is the secret that elite golfers know intuitively and that physics-informed coaches can teach explicitly: *power comes from exploiting drift, not from controlling it.*
...
9. **Control is ineffective late.** In mid-to-late downswing, the drift is so strong that muscle torques have negligible effect.
