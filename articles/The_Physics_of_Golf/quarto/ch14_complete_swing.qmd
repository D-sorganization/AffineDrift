...
- **Chapter~\ref{ch:03_double_pendulum}** showed how even a simple double pendulum exhibits drift and control.
- **Chapter~\ref{ch:05_affine_structure}** developed the affine structure that underlies all golfs physics.
- **Chapter~\ref{ch:zero_torque_counterfactual}** introduced the ZTCF, the autopilot trajectory.
- **Chapters~\ref{ch:constraint_forces}--10** showed how constraints and energy flow reshape the swing.
- **Chapter~\ref{ch:flexible_shaft}** revealed how shaft flexibility contributes entirely to drift.
- **Chapter~\ref{ch:fascia}** debunked myths about fascia and placed it correctly in the framework.
- **Chapter~\ref{ch:interdisciplinary}** showed how multiple disciplines all speak the language of drift and control.
