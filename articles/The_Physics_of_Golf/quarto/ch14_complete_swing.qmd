...
This is where the shaft flexibility ([Chapter 11](./ch11_flexible_shaft.qmd#sec-flexible_shaft)) matters most. The elastic energy stored in the bent shaft is now being released. As the shaft snaps back toward straight, it does work on the clubhead, accelerating it further.
...
4. **Heat:** Some of the chemical energy liberated during muscle contraction is lost as heat. While isolated muscle metabolic efficiency during cyclic contraction is physiologically bounded ($\approx 20\text{--}25\%$), mechanical work ratios in the golf swing are defined differently: for instance, @Nesbit2005b defines mechanical swing efficiency as clubhead work divided by reconstructed total body joint work (reporting $\approx 20\text{--}25\%$ mechanical work transfer), rather than a metabolic conversion. The remaining mechanical joint work is absorbed in segment deceleration or dissipated.
...
- **[Chapter 3](./ch03_double_pendulum.qmd#sec-03_double_pendulum)** showed how even a simple double pendulum exhibits drift and control.
- **[Chapter 5](./ch05_affine_structure.qmd#sec-05_affine_structure)** developed the affine structure that underlies all golfs physics.
- **[Chapter 6](./ch06_zero_torque_counterfactual.qmd#sec-zero_torque_counterfactual)** introduced the ZTCF as a passive reference trajectory.
- **The constraint-forces and energy-flow chapters** showed how constraints and energy flow reshape the swing.
- **[Chapter 11](./ch11_flexible_shaft.qmd#sec-flexible_shaft)** revealed how shaft flexibility contributes entirely to drift.
- **[Chapter 12](./ch12_fascia.qmd#sec-fascia)** debunked myths about fascia and placed it correctly in the framework.
- **[Chapter 13](./ch13_interdisciplinary.qmd#sec-interdisciplinary)** showed how multiple disciplines all speak the language of drift and control.
