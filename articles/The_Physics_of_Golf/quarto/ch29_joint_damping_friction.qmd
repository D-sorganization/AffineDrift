...
<!-- TODO: citation needed for the peak shoulder rotation rate (~7000°/s) and wrist rotation rate (~3000°/s) figures; these should be validated against motion capture data -->
...
<!-- TODO: citation needed for the energy dissipation breakdown table; these estimates should be supported by published biomechanical measurement studies -->
...
During the final 100 ms of the downswing, club speed is changing at a rate of $\sim 50$ m/s$^2$ (local acceleration; this is a typical-order estimate from simulation). At these speeds, a damping torque of even 1 Nm becomes significant.
<!-- TODO: citation needed for the ~50 m/s² club acceleration rate in the final 100 ms; this should be validated against high-speed motion capture data -->
...
For a driver swing (club speed 80--90 mph, a typical range for intermediate to advanced golfers), a 2 mph change is about 5% of club speed. This is not negligible, but it's not dominant either. Most of the sensitivity in club speed comes from muscular timing and force magnitude, not from damping.
<!-- TODO: citation needed for representative driver swing speed range (80--90 mph) and the claim that damping sensitivity is ~5% of club speed -->
