...
$$
\zeta = \frac{c}{2\sqrt{kI}}
$$
where $c$ is the damping coefficient, $k$ the stiffness, and $I$ the moment of inertia (for rotational systems, $m$ is replaced by the moment of inertia $I$).
