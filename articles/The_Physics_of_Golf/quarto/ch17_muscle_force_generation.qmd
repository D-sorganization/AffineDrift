...
Powerful golf swings place high demands on fast force development, so Type II fiber recruitment and training history are relevant [@Hume2005]. This chapter does not assume a universal elite-golfer fiber profile without subject-specific measurement.
...
Hill's hyperbolic relationship, discovered by A.V. Hill in 1938 [@Hill1938], in its normalized form for *concentric contraction* (shortening under load), is:
$$
...
For *eccentric contraction* (lengthening under load, e.g., a muscle applying brakes), force *increases* beyond $F_0$ [@Hill1938]. Following the formulation of Thelen (2003), the eccentric force-velocity relationship asymptotes to a finite maximum rather than diverging:
$$
...
Consider the extensor carpi radialis brevis (ECRB), a wrist extensor involved in club control [@Delp1990; @Delp2007; @Thelen2006; @Rajagopal2016]:
...
The following ranges are illustrative values based on biomechanical studies using motion capture, force plates, and inverse dynamics [@Nesbit2005; @Gatt1998; @McTeigue1994]. They should be replaced by study-specific numbers when a chapter makes a quantitative claim about a measured swing.
...
### Looking Ahead
Muscle biology sets the envelope of what is physically possible: maximum forces, activation speeds, and the velocity--force tradeoff. But there is one more force we have not yet accounted for---aerodynamic drag. [Chapter 19](./ch19_aerodynamic_drag.qmd#sec-aerodynamic-drag) shows why drag is *not* negligible in the golf swing, and why omitting it leads to systematic errors in inverse dynamics calculations.
