...
For example, published cadaveric data suggest the latissimus dorsi (primary force generator in the downswing) has a PCSA on the order of $\sim 30$ cm$^2$, giving a maximum force around 1000 N at $\sigma_{\max} = 35$ N/cm$^2$ [@Zajac1989].
