...
For *eccentric contraction* (lengthening under load, e.g., a muscle applying brakes), Hill's equation is different and shows a counterintuitive result: force *increases* beyond $F_0$:
\begin{equation}
...
- From Eq. \eqref{eq:hill-concentric} with $k = 0.4$: $f_V \approx 0.5$--$0.55$ --- roughly a 45--50% reduction from isometric
...
Muscle biology sets the envelope of what is physically possible: maximum forces, activation speeds, and the velocity--force tradeoff. But there is one more force we have not yet accounted for---aerodynamic drag. Chapter~\ref{ch:aerodynamic-drag} shows why drag is *not* negligible in the golf swing, and why omitting it leads to systematic errors in inverse dynamics calculations.
