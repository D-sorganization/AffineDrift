...
\item[Type IIa (fast-twitch oxidative)] Intermediate speed ($\sim 40$ ms), high force production, moderate fatigue resistance. Oxidative capacity good. The *most powerful* fiber type. Used for athletic power movements. About 20--30% of muscles.
...
\noindent**Result:** The drift-to-control ratio at impact is $\approx 5$--$10$:$1$, meaning inertial and gravitational forces dominate. No amount of muscular effort can overcome this—it is written into the physics of muscle tissue itself.
\end{driftcontrol}
...
\begin{description}
\item[**The Myth:**] A golfer should produce maximum muscle torque all the way to impact. Bigger muscles = bigger torque = longer drive.

\item[**The Reality:**] At impact speeds ($v > 50$ m/s), muscle force-velocity limitations mean muscles produce $\lesssim 20\%$ of isometric force. Trying to ``accelerate into the ball'' at this point is both ineffective (muscles are weak) and risky (joints experience extreme reactive forces). The efficient swing accelerates heavily in the transition and early downswing (when muscles are capable) and then *coasts* (controlled descent of inertia) into impact. Deceleration forces at impact are controlled by eccentric muscle activation (muscles braking), not concentric acceleration.

\item[**Coaching Cue Reframe:**] Instead of ``accelerate to impact,'' say ``accelerate the transition''—this is where muscles are most effective. The downswing should feel like release and flow, not continued muscular effort at the end.
\end{description}
\end{mythreality}
