---
title: "The Affine Structure: Drift and Control"
...
In this illustrative estimate, your muscular contribution is maybe 20 N m. DCR is extremely high under this simplified comparison, but the conclusion should be checked against the stated model and torque bounds.
...
11. **The model structure is shared**. While individual golfers vary in geometry and strength, smooth multibody models commonly share the manipulator-equation structure $\bm{M}, \bm{C}, \bm{g}$; the numerical predictions remain individual and model-dependent.
