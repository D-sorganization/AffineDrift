...
\item **Optimal Control Intuition**. If you were solving the optimal control problem to maximize distance, when would you apply maximum muscular torque? Would it be early (backswing) or late (downswing)? Why?

\item **Weak vs. Strong Golfer**. A weak golfer has less max muscular torque (say, 30 N m vs. 50 N m for a strong golfer). How would this affect:
1. The swing speed?
2. The reliance on drift in the downswing?
3. The optimal control strategy?

\item **Comparison to Throwing**. How is the control-affine structure of the golf swing similar to or different from the baseball throw? In both, you accelerate a mass. Are the regimes of DCR different?
