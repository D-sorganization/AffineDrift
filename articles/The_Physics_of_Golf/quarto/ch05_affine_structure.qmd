...
Your muscular contribution is perhaps on the order of 10--30 N m in this scenario (illustrative; exact values depend on golfer strength and technique---see @Nesbit2005 for inverse-dynamics measurements). DCR is extremely high (passive forces dominating).
...
2. **Initiates transition**: applies modest muscular torque at the transition, perhaps on the order of 10--30 N m (illustrative; depends on golfer---see @Nesbit2005).
...
Total muscular effort: perhaps on the order of 60--80 N m generated over the whole swing in this conceptual example (illustrative; actual values depend on golfer and swing style), with a distribution that works with physics.

Compare to a novice:

1. At the top, applies roughly 40 N m to start the downswing in this illustrative scenario.
