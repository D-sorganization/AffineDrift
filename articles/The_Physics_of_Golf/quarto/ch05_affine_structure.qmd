...
Your muscular contribution is perhaps on the order of 10--30 N m (illustrative; exact values vary by golfer and depend on technique---see @Nesbit2005 for inverse-dynamics measurements). DCR is extremely high (passive forces dominating).
...
2. **Initiates transition**: applies modest muscular torque at the transition (illustrative: perhaps on the order of 10--30 N m; exact values depend on golfer strength and technique [@Nesbit2005]).
...
Total muscular effort: perhaps on the order of 60--80 N m generated over the whole swing---an illustrative range showing that efficient swings work with physics rather than against it; specific values depend on the individual golfer.

Compare to a novice:

1. At the top, applies a large torque (illustrative: perhaps 40 N m) to start the downswing.
2. Applies large torques throughout, fighting the increasing drift.
3. At impact, applies another large torque, overaccelerating.
4. Total muscular effort: substantially more than an efficient swing, and inconsistent, because the novice is constantly fighting the passive forces instead of working with them.
