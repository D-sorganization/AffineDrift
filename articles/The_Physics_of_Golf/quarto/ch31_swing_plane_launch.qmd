...
where SMF is the smash factor, typically ranging from 1.40 to 1.50 for drivers on well-struck shots. (@sec-impact_collision discusses smash factor in detail.)
...
- **Second:** Optimize ball speed by improving the efficiency of energy transfer (@sec-impact_collision) and by matching swing speed to equipment (@sec-impact_collision).
