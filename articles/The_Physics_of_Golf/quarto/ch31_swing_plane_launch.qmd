...
\begin{enumerate}
- \textbf{Face angle} ($\alpha_{\text{face}}$): The rotation of the clubface about the shaft axis, measured in the horizontal plane. Negative angles represent a \textit{closed} face (toe higher than heel); positive angles represent an \textit{open} face (heel higher than toe). A 1$^{\circ}$face angle error at impact with a driver produces approximately 17--20 yards of offline displacement at 250 yards of carry distance.
...
\begin{itemize}
-$\alpha_{\text{forearm}}$is the supination/pronation (rotation about the long axis of the forearm). Supination (palm-up rotation) opens the face; pronation (palm-down rotation) closes it. This is the \textbf{dominant} contributor, accounting for approximately 70\% of total face angle change from address to impact. 
...
- **Second:** Optimize ball speed by improving the efficiency of energy transfer (Chapter~\ref{ch:impact_collision_collision}) and by matching swing speed to equipment (Chapter~\ref{ch:impact_collision_collision}).
