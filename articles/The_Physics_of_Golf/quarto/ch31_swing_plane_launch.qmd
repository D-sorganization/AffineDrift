...
For a golfer with a typical clubhead speed of 90 mph and swing-dependent characteristics, the gate width is approximately (values based on trajectory sensitivity analysis; individual results vary):
<!-- TODO: citation needed for the gate width estimates below; these are model-derived values and should be validated against empirical data -->
...
<!-- TODO: citation needed for the 1.48 smash factor as a typical well-struck driver value -->
...
<!-- TODO: citation needed for the regression equation for optimal launch angle; the specific launch-monitor dataset and regression methodology should be referenced -->
...
<!-- TODO: citation needed for the table values of optimal launch angles and carry distances; these should be validated against launch monitor data or aerodynamic trajectory simulations -->
