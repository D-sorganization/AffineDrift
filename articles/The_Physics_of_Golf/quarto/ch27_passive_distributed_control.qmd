...
Recall from [Chapter 6](./ch06_zero_torque_counterfactual.qmd#sec-zero_torque_counterfactual) the Zero Torque Counterfactual (ZTCF) decomposition:
...
In [Chapter 10](./ch10_energy_transfer.qmd#sec-energy_transfer), we saw that power flows from proximal segments (large muscles, high inertia) to distal segments (small muscles, low inertia). The mechanism is the inertial load on the distal joints.
...
- **[Chapter 24](./ch24_motor_control_brain.qmd#sec-motor_control_brain):** The brain and spinal cord have limited bandwidth. Real-time independent control of 20+ DOF is infeasible within the available time budget.
- **[Chapter 25](./ch25_motor_learning.qmd#sec-motor_learning):** The motor system learns and adapts by modifying forward models and internal representations.
- **[Chapter 25](./ch25_motor_learning.qmd#sec-motor_learning):** Movement inherently exhibits variability; the motor system manages it through noise shaping and regularization.
