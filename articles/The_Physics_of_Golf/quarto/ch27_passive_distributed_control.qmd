...
<!-- TODO: citation needed for the 10--40 bits per second human motor processing rate estimate -->
...
<!-- TODO: citation needed for the 40--50% and 70--80% ZTCF estimates; these are based on simulation and should be validated against published biomechanical measurements -->
...
<!-- TODO: citation needed for the 70--80% ZTCF estimate in this callout; consistent with the caveat above -->
...
<!-- TODO: citation needed for the 10--20 ms sensory conduction time to the spinal cord -->
- Spinal circuits activate the motor neurons of the *same muscle*
- Muscle contracts and resists the stretch


This is called the *monosynaptic stretch reflex* because it involves only one synapse in the spinal cord. The latency is remarkably short: 20--30 ms. By contrast, conscious reflexes (routing through the brain) have latencies of 100--300 ms.
<!-- TODO: citation needed for monosynaptic stretch reflex latency (20--30 ms) and conscious reflex latency (100--300 ms) -->
