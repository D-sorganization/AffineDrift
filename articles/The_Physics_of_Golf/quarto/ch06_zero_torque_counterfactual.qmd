...
At any time during the swing, the **Drift-Control Ratio (DCR)** compares modeled drift against bounded modeled control under an explicit norm or weighting. Consistent with Chapter @sec-05_affine_structure, use:
