...
6. **Model-dependence:** ZTCF requires a biomechanical model; it cannot be measured directly. Qualitative conclusions should be reported with sensitivity checks rather than asserted as model-independent facts.
