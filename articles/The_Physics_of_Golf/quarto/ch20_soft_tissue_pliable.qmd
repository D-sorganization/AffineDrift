...
Consider the upper arm during the downswing. The humerus (upper arm bone) is accelerating forward and down at perhaps 500 m/s$^2$ during peak downswing acceleration (an illustrative estimate; exact values depend on golfer size and swing speed; approximately 300--700 m/s$^2$ is a typical order-of-magnitude range <!-- TODO: add citation for measured upper arm acceleration magnitudes during golf downswing, e.g., accelerometer or motion capture studies -->). The soft tissue hanging on the arm---the muscles, the fat, the skin---has inertial mass. This soft tissue experiences an inertial force that tries to keep it moving in its old direction. The tissue oscillates relative to the bone, creating a secondary motion superimposed on the primary swing motion.

Similarly, the torso during a full downswing rotation is not a solid block. It contains approximately 35 kg of additional mass beyond the skeletal framework (illustrative estimate; varies with body size and composition <!-- TODO: add citation for typical torso soft tissue mass estimates, e.g., anthropometric or cadaver studies -->): viscera, organs, blood, fat distributed throughout the abdomen. During the violent rotation of a golf downswing (torso angular velocity reaching 600${}^\circ$/s, illustrative; depends on individual), this soft mass does not rotate in perfect lockstep with the skeletal torso. It shifts, it redistributes, it creates time-varying inertial properties that the rigid body model assumes away.
...
During the downswing (which lasts approximately 0.15--0.3 seconds; illustrative; depends on individual and swing style <!-- TODO: add citation for measured downswing duration, e.g., high-speed video studies -->), the arm accelerates at peak rates on the order of 500 m/s$^2$ (illustrative estimate; depends on golfer size and swing speed <!-- TODO: add citation for measured peak arm acceleration during golf downswing -->). This high-frequency content excites the wobble mass oscillation. Typical wobble amplitudes are approximately 1--3 cm during the swing and post-swing phases (illustrative; varies with tissue composition). The wobble mass will oscillate for several cycles after the swing ends, dissipating energy through damping.
...
- Heart: approximately 0.3 kg (illustrative; depends on individual <!-- TODO: add citation for mean organ mass values, e.g., anatomical reference texts or forensic anthropology studies -->)
...
- **Total: approximately 13--18 kg out of the torso's total mass of roughly 25--35 kg (illustrative; varies with body size and composition <!-- TODO: add citation for typical torso total mass and soft tissue fraction, e.g., anthropometric data -->)**
