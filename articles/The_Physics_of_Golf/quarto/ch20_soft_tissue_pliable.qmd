...
- **Total: approximately 13--18 kg [@deleva1996adjustments; @Winter2009] (illustrative; varies with body size and composition)**
...
Research in spinal biomechanics has shown that appropriate IAP can reduce the compressive load on the L4/L5 disc by a task-dependent amount typically reported in the 20--40% range [@McGill2007], though individual studies have placed the reduction anywhere from $\sim$10% to as high as 50% depending on loading geometry and measurement technique. Report the 20--40% as a central estimate with the wider 10--50% spread as a caveat rather than a tight number.
