...
Consider the upper arm during the downswing. The humerus (upper arm bone) is accelerating forward and down at perhaps 500 m/s$^2$ during peak downswing acceleration (an illustrative estimate; exact values depend on golfer size and swing speed [<!-- TODO: citation needed for measured upper arm acceleration magnitudes during golf downswing -->]). The soft tissue hanging on the arm---the muscles, the fat, the skin---has inertial mass. This soft tissue experiences an inertial force that tries to keep it moving in its old direction. The tissue oscillates relative to the bone, creating a secondary motion superimposed on the primary swing motion.

Similarly, the torso during a full downswing rotation is not a solid block. It contains approximately 35 kg of additional mass beyond the skeletal framework: viscera, organs, blood, fat distributed throughout the abdomen [<!-- TODO: citation needed for typical torso soft tissue mass estimates -->]. During the violent rotation of a golf downswing (torso angular velocity reaching 600${}^\circ$/s), this soft mass does not rotate in perfect lockstep with the skeletal torso. It shifts, it redistributes, it creates time-varying inertial properties that the rigid body model assumes away.
...
During the downswing (which lasts approximately 0.15--0.3 seconds [<!-- TODO: citation needed for measured downswing duration -->]), the arm accelerates at peak rates on the order of 500 m/s$^2$ [<!-- TODO: citation needed for measured peak arm acceleration during golf downswing -->]. This high-frequency content excites the wobble mass oscillation. Typical wobble amplitudes are 1--3 cm during the swing and post-swing phases. The wobble mass will oscillate for several cycles after the swing ends, dissipating energy through damping.
...
- Heart: ~0.3 kg [<!-- TODO: citation needed for mean organ mass values -->]
- Lungs: ~1.2 kg
- Liver: ~1.5 kg
- Kidneys: ~0.3 kg
...
- **Total: approximately 13--18 kg out of the torso's total mass of ~25--35 kg [<!-- TODO: citation needed for typical torso total mass and soft tissue fraction -->]**
