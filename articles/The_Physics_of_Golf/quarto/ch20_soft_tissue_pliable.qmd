...
During the downswing (which lasts approximately 0.15--0.3 seconds [<!-- TODO: citation needed for measured downswing duration ; exact values depends on individual biomechanics -->]), the arm accelerates at peak rates on the order of 500 m/s$^2$ (illustrative estimate; depends on golfer size and swing speed [<!-- TODO: citation needed for measured peak arm acceleration during golf downswing ; exact values depends on individual biomechanics -->]). This high-frequency content excites the wobble mass oscillation. Typical wobble amplitudes are 1--3 cm during the swing and post-swing phases. The wobble mass will oscillate for several cycles after the swing ends, dissipating energy through damping.
...
- Heart: ~0.3 kg [<!-- TODO: citation needed for mean organ mass values ; exact values depends on individual biomechanics -->]
...
- **Total: approximately 13--18 kg out of the torso's total mass of ~25--35 kg [<!-- TODO: citation needed for typical torso total mass and soft tissue fraction ; exact values depends on individual biomechanics -->]**
