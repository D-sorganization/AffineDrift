...
Consider the upper arm during a fast downswing. The parameters below are illustrative scaling estimates chosen to be consistent with wobble-mass identification studies in running and landing [@gruber1998comparative]; they are *not* measurements on golfers. Published wobble-mass studies report stiffness in the $k_w \sim 2{,}000$--$10{,}000$ N/m range and damping in the $c_w \sim 100$--$400$ N$\cdot$s/m range, with natural frequencies of order 8--15 Hz. Actual values depend on individual body composition and tissue properties.
...
- Estimated stiffness (tissue elasticity): roughly $k_w \approx 5{,}000$ N/m (illustrative; within published range)
- Estimated damping (viscous dissipation): roughly $c_w \approx 200$ N$\cdot$s/m (illustrative; within published range)
...
- Heart: approximately 0.3 kg [@deleva1996adjustments] (illustrative; depends on individual)
- Lungs: ~1.2 kg  <!-- approx.; varies with individual -->
- Liver: ~1.5 kg  <!-- approx.; varies with individual -->
- Kidneys: ~0.3 kg  <!-- approx.; varies with individual -->
- Stomach, intestines, spleen, pancreas: ~2 kg  <!-- approx.; varies with individual -->
- Blood: ~5 kg (in the torso cavity)  <!-- approx.; varies -->
- Abdominal fat and other organs: ~3--8 kg  <!-- varies widely -->
- **Total: approximately 13--18 kg [@deleva1996adjustments; @winter2009biomechanics] (illustrative; varies with body size and composition)**

*Accounting consistency check.* For an 80 kg subject, de Leva's "trunk" segment (neck-base to hip, excluding head) is $\approx 43\%$ of body mass, or $\approx 34$ kg, of which the head-and-neck contribution has been excluded. If instead we take the tighter "torso" conventionally used in segmented-body models ($\approx 30\%$ of body mass), that is $\approx 24$ kg. The 13--18 kg visceral total above is therefore $\approx 40$--$55\%$ of a 30% torso segment, or $\approx 35$--$55\%$ of a 43% trunk segment. Whichever convention the reader prefers, the conclusion stands: *a substantial fraction of torso mass is fluid or semi-fluid organ tissue, not rigidly attached to the skeleton.* Different chapters in this book use slightly different torso conventions; when the arithmetic looks mismatched below, it is because the segment definition has changed, not because the mass fractions have.

Now consider a much larger effect: the torso itself. The human torso is not a solid block of muscle and bone. It is a container filled with organs, blood, other fluids, and fat. The total visceral mass (everything inside the ribcage and abdomen excluding the spine) constitutes a substantial fraction of total torso mass. Standard anatomical reference values indicate that organs, blood, and fat together account for roughly half of total torso mass. These contents are not rigidly attached to the skeleton. They can move, shift, and redistribute during motion.
...
Even moderate angular velocities produce centrifugal accelerations that are a meaningful fraction of gravity. **The organs in the rotating torso experience centrifugal forces pulling them outward.** The liver, suspended by ligaments and tissue connections, shifts and stretches in response to this loading.
...
- At any given angular velocity $\omega$ and radial distance $r$, the centrifugal acceleration is $a = \omega^2 r$
- This acts on every organ and fluid mass inside the torso, creating outward forces proportional to mass
- These forces are resisted by the ligaments, mesentery, and connective tissue suspending each organ
...
- Diaphragm area (representative): 0.04 m$^2$
- Upward force on diaphragm: $F = 13,300 \times 0.04 = 532$ N
- Pelvic floor (smaller area, representative): force in the opposite direction of similar order

*Caveat:* this 532 N IAP force is dimensionally correct but is *not* subtracted directly from disc compression one-for-one. Disc compression is determined by the full 3D force balance on the lumbar spine, including muscle co-contraction, ligament tension, and the geometry of trunk flexion. IAP contributes an extensor-moment-producing upward force on the diaphragm and a downward force on the pelvic floor; how much of this appears as disc unloading depends on torso posture, which co-contraction pattern is active, and how the pressure is distributed across the abdominal wall. The common summary that "IAP reduces disc loading by 20--40%" [@mcgill2007ultimate] is itself an average with published estimates spanning roughly 10--50% across studies (different loading tasks, different measurement modalities); treat 20--40% as a typical middle-of-the-range figure, not a tight band.

The pressurized cavity creates forces that:

- Reduce the net compressive load on the intervertebral discs (by a task-dependent fraction, typically in the 10--50% range)
...
Research in spinal biomechanics has shown that appropriate IAP can reduce the compressive load on the L4/L5 disc by a task-dependent amount typically reported in the 20--40% range [@mcgill2007ultimate], though individual studies have placed the reduction anywhere from $\sim$10% to as high as 50% depending on loading geometry and measurement technique. Report the 20--40% as a central estimate with the wider 10--50% spread as a caveat rather than a tight number.
...
- IAP rises substantially during the golf downswing, generating forces on the order of hundreds of newtons that help support the spine. The exact pressure achieved depends on how forcefully the golfer braces and the breathing strategy used.
...
- **Visceral Centrifugal Force:** A rotating torso at 500${}^\circ$/s carries visceral mass $m_v$ with centroid at $r = 0.1$ m from the rotation axis. Write an expression for the centrifugal force as a function of $m_v$. How does this force compare to the weight of that same mass? At what angular velocity would the centrifugal acceleration equal $g$?

- **IAP Structural Force:** If IAP reaches 110 mmHg and the diaphragm area is 0.045 m$^2$, what is the total upward force on the diaphragm? Comment on whether this force is significant compared to the order of magnitude of forces expected from the back extensor muscles.
