...
This is why the ZTCF framework (Chapter @sec-zero_torque_counterfactual) is so important. It offers a way to ask whether a seemingly complicated motion contains a large state-driven component that reduces the burden on moment-to-moment control.
...
Chapters @sec-motor_control_brain and @sec-motor_learning established that the brain learns internal models. Let's now think carefully about what, exactly, the brain learns.
