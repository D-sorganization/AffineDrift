...
<!-- TODO: citation needed for illustrative shoulder stiffness values in impedance control; these are order-of-magnitude estimates -->
...
- These pre-activations happen approximately 50--100 ms before the event (illustrative; depends on task and individual), anticipating it using the forward model.
<!-- TODO: citation needed for the 50--[ms value] anticipatory pre-activation window estimate ; exact values depends on individual biomechanics and model assumptions -->
