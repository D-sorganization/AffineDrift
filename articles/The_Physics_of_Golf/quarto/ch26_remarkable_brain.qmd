...
This is why the ZTCF family framework ([Chapter 6](./ch06_zero_torque_counterfactual.qmd#sec-zero_torque_counterfactual)) is so important. It offers a way to ask whether a seemingly complicated motion contains a large state-driven component that reduces the burden on moment-to-moment control.
...
[Chapter 24](./ch24_motor_control_brain.qmd#sec-motor_control_brain) and [Chapter 25](./ch25_motor_learning.qmd#sec-motor_learning) established that the brain learns internal models. Let's now think carefully about what, exactly, the brain learns.
