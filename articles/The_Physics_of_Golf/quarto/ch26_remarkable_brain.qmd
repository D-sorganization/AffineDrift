...
This is why the ZTCF family framework (@sec-zero_torque_counterfactual) is so important. It offers a way to ask whether a seemingly complicated motion contains a large state-driven component that reduces the burden on moment-to-moment control.
