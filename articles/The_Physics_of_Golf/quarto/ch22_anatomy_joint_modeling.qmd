...
The lead wrist experiences the highest angular velocities of any joint in the swing ($\sim50$--70 rad/s at impact). Combined with the impact shock (3000--5000 N over 0.5 ms from @sec-impact_collision), the wrist is vulnerable to:
