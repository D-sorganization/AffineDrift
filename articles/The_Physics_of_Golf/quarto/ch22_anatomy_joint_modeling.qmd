...
**Interpreting golf measurements:** Pelvis turn in the laboratory frame is not anatomical hip internal rotation. A hip rotation describes the femur relative to the pelvis; its numerical components depend on the anatomical frames, rotation sequence, sign convention and reference posture. Cheetham and colleagues computed X-factor from pelvis and upper-torso sensor orientations near transition [@Cheetham2001]. That measurement does not establish a 35--50-degree lead-hip internal-rotation range or a universal requirement for professional swings.
...
- **[Degrees of Freedom and Dimensionality](../../degrees-of-freedom-and-dimensionality.html)** — Model-ladder choices for anatomical complexity
- **[The Wrist as a Universal Joint](../../wrist-universal-joint.html)** — Lead-wrist kinematics and impact vulnerability
:::
