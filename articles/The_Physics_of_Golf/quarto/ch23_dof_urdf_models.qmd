...
This is why motion capture shows that no two golfers swing identically [@Glazier2011; @Myers2008]. Glazier (2011) reviews movement variability in the golf swing and argues it is partly functional rather than simply error, and Myers (2008) report the spread across 100 golfers. The task (club trajectory) is constrained, but the arm configuration is not. Different golfers choose different null-space motions.
