...
<!-- TODO: citation needed for motion capture evidence that no two golfers swing identically in arm configuration -->
...
The golf swing is the same. A golfer has approximately 25--30 degrees of freedom (a commonly cited estimate depending on which joints are included in the model; exact counts vary across biomechanical models). But the task --- place the club face square to the target with maximum speed at impact --- requires control of only 6 variables: the position (3) and orientation (3) of the club head.
<!-- TODO: citation needed for the 25--30 DOF estimate for the golf swing -->
