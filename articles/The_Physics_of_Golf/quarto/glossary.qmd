...
**Clubhead speed**: The velocity of the clubhead at impact. This is the primary determinant of ball distance (along with launch angle and spin rate). Clubhead speed varies widely across skill levels; representative ranges are published by launch monitor manufacturers and in the biomechanics literature [@penner2003physics; @cochran1968search].

**Coefficient of restitution (COR)**: The ratio of the separation speed to the approach speed in a collision. The USGA limits COR for drivers to 0.83; typical measured values for conforming equipment are near this limit [@penner2003physics]. Note: COR is a speed ratio, not an energy ratio; the fraction of kinetic energy transferred also depends on the mass ratio of ball to clubhead.
...
**Degrees of freedom**: The number of independent ways a system can move. A single rigid body in 3D space has 6 degrees of freedom (3 translational, 3 rotational). The number of degrees of freedom in a human arm depends on the modeling assumptions for shoulder, elbow, and wrist joints.
...
**Drift-to-Control Ratio (DCR)**: See DCR.
...
**Follow-through**: The phase after impact where the golfer decelerates the club and body, coming to rest. The follow-through is important for balance and injury prevention.
...
**Injury prevention**: Strategies to reduce the risk of injury through training, technique, and equipment selection. Understanding force distribution is key to injury prevention.
...
**Intermuscular coordination**: The coordination of different muscles around a joint. Good intermuscular coordination allows efficient force production and injury prevention.
...
**Launch angle**: The *vertical* angle (elevation) at which the ball leaves the clubface at impact, measured from the horizontal. Launch angle significantly affects carry distance and ball flight. The *horizontal* component of the ball's initial direction---how far left or right of the target line it starts---is a separate quantity, sometimes called the **launch azimuth** or **horizontal launch angle**; launch monitors typically report the two independently.
...
**Overstretching**: Stretching beyond the normal limit, potentially causing injury to muscle or connective tissue. Proper warm-up reduces the risk of overstretching.
...
**Rotator cuff**: A group of four muscles (supraspinatus, infraspinatus, teres minor, subscapularis) surrounding the shoulder joint, responsible for shoulder stability and motion. The rotator cuff is vulnerable to injury in golf.
...
**Supraspinatus**: A rotator cuff muscle responsible for abduction of the shoulder. The supraspinatus is the most commonly injured rotator cuff muscle.
...
- **[Notation and Conventions](/pages/notation-conventions.html)** — Site-wide mathematical notation and sign conventions
- **[Lagrangian Reference](../../lagrangian-reference.html)** — Formal mechanics reference behind many entries in this glossary
- **[Screw Theory Reference](../../screw-theory-reference.html)** — Spatial kinematics reference for twists, wrenches, and screw axes
- **[Rotation Representations Reference](../../rotation-representations-reference.html)** — Rotation formalism used in the chapters on shaft and spine geometry
- **[Zero-Torque Counterfactual — canonical definitions](../../zero-torque-counterfactual.html#sec-ztcf-canonical)** — Canonical ZTCF/ZVCF definitions
:::
