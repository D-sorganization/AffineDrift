...
**Clubhead speed**: The velocity of the clubhead at impact. This is the primary determinant of ball distance (along with launch angle and spin rate). Clubhead speed ranges from about 70 mph for recreational amateurs to approximately 115--125 mph for PGA Tour professionals, with long-drive competitors reaching 140--155 mph.

**Coefficient of restitution (COR)**: The ratio of the separation speed to the approach speed in a collision. Golf balls have a COR of approximately 0.82, meaning the ball leaves the face at 82\% of the relative approach speed. Note: COR is a speed ratio, not an energy ratio; the fraction of kinetic energy transferred also depends on the mass ratio of ball to clubhead.
