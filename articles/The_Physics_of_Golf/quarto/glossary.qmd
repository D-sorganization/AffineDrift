...
**Degrees of freedom**: The number of independent ways a system can move. A single rigid body in 3D space has 6 degrees of freedom (3 translational, 3 rotational). A human arm with shoulder, elbow, and wrist joints has approximately 7--9 degrees of freedom (illustrative; exact counts depend on the joint model and which sub-axes are included; values vary across biomechanical models).
<!-- TODO: add citation for the DOF estimate for the human arm, e.g., robotics or musculoskeletal modelling references -->
