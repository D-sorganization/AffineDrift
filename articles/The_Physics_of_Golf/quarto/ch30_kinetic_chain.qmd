...
By the time the club reaches impact, it has been accelerated through a *sequence* of torques, each applied at just the right moment. The result: club speeds in the range of roughly 80--160 mph (depending on the golfer's level) emerge from proximal body segment velocities of roughly 5--20 mph. This is the kinetic chain, and it is a matter of *timing*, not raw muscular force.
<!-- TODO: citation needed for the club speed range (80--160 mph) and proximal body velocity range (5--20 mph); typical values cited from launch monitor and motion capture literature -->
...
<!-- TODO: citation needed for the 0--5 ms timing of peak club velocity relative to impact -->
...
<!-- TODO: citation needed for Hill's force-velocity relation applied to the wrist at golf-swing speeds; the ~80 mph / 1200°/s estimate should be supported by kinematic measurements -->
...
Force plate studies of the golf swing suggest a characteristic pattern in the timing of GRF during the downswing. For a driver swing, typical reported values are:
...
<!-- TODO: citation needed for GRF timing values (vertical GRF peak 80--100 ms before impact; horizontal GRF peak 30--50 ms before impact) from force plate studies -->
