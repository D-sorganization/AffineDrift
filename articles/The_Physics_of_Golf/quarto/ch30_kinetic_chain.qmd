...
Biomechanical data from high-speed video and marker tracking show the following approximate peak velocities (from [@cheetham2001importance; @hume2005role]):
...
High-speed force plate measurements reveal a characteristic pattern in the timing of GRF during the downswing [@winter2009biomechanics]. For a driver swing, the general pattern is:
...
Measurements of elite golfers reveal the following approximate energy distribution (from [@hume2005role; @sprigings2005golf]):
...
One of the most important insights from the ZTCF formalism (Chapter~\ref{ch:zero_torque_counterfactual}) is that the proximal-to-distal sequencing of the kinetic chain does *not* need to be programmed into the motor control system. Instead, it *emerges naturally* from the structure of the equations of motion when the body is modeled as a coupled kinetic chain with realistic mass, geometry, and stiffness parameters.
