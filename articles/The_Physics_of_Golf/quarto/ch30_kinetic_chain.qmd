...
At first glance, it seems that the wrist should be a major power source: the wrist muscles are substantial, and a violent wrist snap seems to intuitively contribute to club speed. However, Chapter @ch:muscle-force-generation showed that skeletal muscles operate under a fundamental constraint: they are weak at high speeds (Hill's force-velocity relation). By the time the club reaches near-impact speeds (say, 80 mph at the hands, which is $\sim 1200^{\circ}$/s in rotational terms), the muscle cannot exert much force.
