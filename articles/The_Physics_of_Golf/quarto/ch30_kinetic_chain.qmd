...
For a typical $\sim 50$ m/s clubhead swing, the approximate breakdown is: total muscular work $\approx 300$--$400$ J, clubhead KE at impact $\approx 220$ J, with the remainder ($\sim 15$--$25\%$) dissipated. The sinks are joint damping (~5--15%, see ch29) [@Nesbit2005], muscle--tendon viscoelastic losses and soft-tissue / wobble-mass damping (ch20), and aerodynamic drag on the club (~5--8%, ch19). The ZTCF analysis in ch06 starts from the conservative idealization to isolate drift dynamics; dissipation is restored in ch29. What is genuinely conserved in the idealization is the statement that, *in the absence of dissipation*, kinetic energy is progressively concentrated into smaller, more distal masses, thereby increasing segment velocity --- the energy cascade itself is real, but its gross magnitude is moderated by the sinks above.
