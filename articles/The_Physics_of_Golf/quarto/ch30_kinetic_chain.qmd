...
By the time the club reaches impact, it has been accelerated through a *sequence* of torques, each applied at just the right moment. The result: club speeds of 80--160 mph emerge from body velocities of 5--20 mph. This is the kinetic chain, and it is a matter of *timing*, not raw muscular force.
...
In a well-executed golf swing, the following sequence occurs:
  ...
  - **Club** ($i=6$): The club, driven by the decelerating arms and wrists, reaches maximum velocity at or shortly after impact, typically 0--5 ms after impact depending on the golfer and club.
...
High-speed force plate measurements reveal a characteristic pattern in the timing of GRF during the downswing. For a driver swing:
  ...
  - **Peak rotational torque**: The GRF torque about the vertical axis peaks around 30--50 ms before impact, driving the final acceleration of hip rotation.
...
One of the most profound insights from the ZTCF formalism (Chapter~\ref{ch:zero_torque_counterfactual}) is that the proximal-to-distal sequencing of the kinetic chain does *not* need to be programmed into the motor control system. Instead, it *emerges naturally* from the structure of the equations of motion when the body is modeled as a coupled kinetic chain with realistic mass, geometry, and stiffness parameters.
