...
Recall the coupled oscillator model introduced in @sec-x_factor. Each joint has a natural frequency $\omega_i$ determined by the local stiffness and inertia. For a joint with moment of inertia $I_i$ and coupling stiffness $k_i$ (stiffness of the joint's passive and active structures):
