...
- $P_{\text{input}} = \bm{u}^T \dot{\bm{q}}$: power from muscular torques (always non-negative; muscles do positive work).
...
Track the kinetic energy of each segment during the downswing. Assume a triple pendulum (torso, arm, club) with the following initial energies:
