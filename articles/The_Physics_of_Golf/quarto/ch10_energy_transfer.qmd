...
The **summation of speed principle** is often stated as: ``Each segment reaches peak speed sequentially—the hips fastest, then the shoulders, then the arms, then the wrist. Each segment's peak speed is higher than the previous one.'' This pattern is well documented in golf biomechanics [@cheetham2001importance; @hume2005role].
