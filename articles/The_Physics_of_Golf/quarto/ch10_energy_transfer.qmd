...
We've examined forces ([Chapter 6](./ch06_zero_torque_counterfactual.qmd#sec-zero_torque_counterfactual)), constraint forces ([Chapter 7](./ch07_constraint_forces.qmd#sec-constraint_forces)), multiple segments ([Chapter 8](./ch08_triple_pendulum.qmd#sec-triple_pendulum)), and parallel mechanisms ([Chapter 9](./ch09_parallel_mechanisms.qmd#sec-parallel_mechanisms)). Now we ask: **where does the energy go?**
...
9. **Efficiency:** A typical swing is about 50\% efficient—100 J of muscular input results in 50 J of kinetic energy in the ball. Published estimates of collision efficiency (club-to-ball) are $\sim 70\text{--}80\%$ [@Penner2001]; additional losses come from air resistance, inefficient constraint transfers, and incomplete energy capture at impact.
...
**What comes next:** This concludes our journey through the physics of the golf swing. We've examined forces ([Chapter 6](./ch06_zero_torque_counterfactual.qmd#sec-zero_torque_counterfactual)), their transmission through constraints ([Chapter 7](./ch07_constraint_forces.qmd#sec-constraint_forces)), multi-segment systems ([Chapter 8](./ch08_triple_pendulum.qmd#sec-triple_pendulum)), parallel body structure ([Chapter 9](./ch09_parallel_mechanisms.qmd#sec-parallel_mechanisms)), and energy flow (@sec-energy_transfer).
...
Simulate or model a double pendulum swing (or use the parameters from [Chapter 8](./ch08_triple_pendulum.qmd#sec-triple_pendulum)).
