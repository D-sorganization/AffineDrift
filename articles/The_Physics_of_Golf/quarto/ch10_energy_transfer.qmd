...
We've examined forces (Chapter @sec-zero_torque_counterfactual), constraint forces (Chapter @sec-constraint_forces), multiple segments (Chapter @sec-triple_pendulum), and parallel mechanisms (Chapter @sec-parallel_mechanisms). Now we ask: **where does the energy go?**
...
**What comes next:** This concludes our journey through the physics of the golf swing. We've examined forces (Chapter @sec-zero_torque_counterfactual), their transmission through constraints (Chapter @sec-constraint_forces), multi-segment systems (Chapter @sec-triple_pendulum), parallel body structure (Chapter @sec-parallel_mechanisms), and energy flow (Chapter @sec-energy_transfer).
...
Simulate or model a double pendulum swing (or use the parameters from Chapter @sec-triple_pendulum).
