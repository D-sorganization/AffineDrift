...
title: "Induced Acceleration Analysis: Quantifying Who Moves What"
...
Because the mass matrix $\boldsymbol{M}(\boldsymbol{q})$ is symmetric and positive definite (a consequence of the fact that kinetic energy is always positive for any nonzero velocity), its inverse always exists. Moreover, the multiplication $\boldsymbol{M}^{-1} \boldsymbol{\tau}$ is a *linear* operation in $\boldsymbol{\tau}$. This linearity is the mathematical basis for superposition in induced acceleration analysis.
