...
Recall from Chapter @sec-04_forces_and_torques that the equations of motion for an $n$-degree-of-freedom mechanical system take the form:
...
Readers who have followed the development in Chapter @sec-05_affine_structure will recognize that Equation @eq-iaa_superposition is closely related to the control-affine decomposition:
