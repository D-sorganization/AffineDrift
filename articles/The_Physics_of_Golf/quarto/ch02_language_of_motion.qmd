...
During the downswing, a golfer's shoulder might be rotating at $\dot{\theta}_s = 600 \text{ degrees/second} = 10.5 \text{ rad/s}$ [<!-- TODO: citation needed for typical peak shoulder rotation rates in golf -->].
