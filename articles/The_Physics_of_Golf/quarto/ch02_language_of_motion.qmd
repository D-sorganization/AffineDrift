...
During the downswing, a golfer's shoulder or upper torso can reach angular velocities on the order of $\dot{\theta}_s = 600 \text{ degrees/second} = 10.5 \text{ rad/s}$, with published golf kinematic studies reporting peak values in this general range [@kwon2012kinematic; @hellstrom2009kinematic].
...
2. **Velocity** $\dot{\bm{q}}$ is the rate of change of position. High angular velocities at impact (e.g., $\dot{\theta}_s = 600°/s$, which is in the range reported in golf kinematic studies [@kwon2012kinematic; @hellstrom2009kinematic]) are huge and create large inertial forces.
