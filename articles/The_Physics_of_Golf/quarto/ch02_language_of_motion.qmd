...
= \begin{bmatrix} q_1 \\ q_2 \\ \vdots \\ q_n \\ \dot{q}_1 \\ \dot{q}_2 \\ \vdots \\ \dot{q}_n \end{bmatrix}
$$
...
## Worked Example: Double Pendulum Kinematics {#sec-ch02-kinematics-example}

Let's make this concrete. Consider a double pendulum with:

- Upper arm has length $L_1 = 0.35$ m and mass $M_1 = 2.5$ kg. Its center of mass is at distance $L_{1,\text{cm}} = 0.25$ m from the shoulder.
