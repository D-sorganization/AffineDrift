...
You learned in @sec-zero_torque_counterfactual that the downswing is passive—gravity and Coriolis drive acceleration. But @sec-zero_torque_counterfactual left a critical question unanswered:
...
At the configuration from @sec-zero_torque_counterfactual ($q_1 = 45°$, $\dot{q}_1 = 8$ rad/s, $q_2 = 70°$, $\dot{q}_2 = 12$ rad/s), the unconstrained accelerations (from the ZTCF family) are:
