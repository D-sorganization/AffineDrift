---
title: "Constraint Forces: The Hidden Engines of the Swing"
...
Using the procedure from Section @sec-solving_constraint_forces, we solve for $\lambda$. The constraint acceleration condition is:
...
{Geometric}
For the wrist constraint in the double pendulum (Section @sec-double_pendulum_constraint_force), sketch the configuration of the arm and club when $q_1 + q_2 = 115°$. Identify the null space (allowed motion) and the direction of the constraint force.
...
For the double pendulum with constraint (Section @sec-double_pendulum_constraint_force):
