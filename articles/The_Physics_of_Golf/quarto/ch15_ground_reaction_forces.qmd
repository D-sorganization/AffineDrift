---
description: "Every golfer stands on the ground. This seems obvious, almost trivial. But it is not. The ground is a constraint on your motion. You cannot pass through..."
---

# Ground Reaction Forces: The Silent Foundation {#sec-grf}
...
In illustrative force-plate examples from golf swing studies, this weight shift happens dynamically throughout the motion. Roughly 60--80% of the ground reaction force is under the trail foot at the top of the backswing, and at impact, approximately 80--95% is under the lead foot [@Nesbit2005, @vena2011kinematic]. This transfer of ground reaction force is not just a consequence of the swing---it is an integral part of the driving mechanism.
...
Note: In the sign convention used here, $F_z = m\ddot{z} - mg$ (with upward positive), so $\ddot{z} = (F_z + mg)/m$. This is an upward acceleration of $23.1 / 9.81 \approx 2.35$ g's. This reflects the golfer actively extending the legs during the downswing push-off phase.
...
In the control-affine framework (@sec-05_affine_structure), the dynamics are:
$$
...
Consider a 90 kg golfer with a 5 kg arm. Suppose the golfer applies a torque of 100 N$\cdot$m at the shoulder (a plausible illustrative value consistent with inverse-dynamics studies [@Nesbit2005; @Gatt1998]; treat as a worked example rather than a specific measurement), causing the arm to accelerate.
