...
During a golf swing, the ground exerts forces in all three directions simultaneously. A force plate---an instrument embedded in the ground---measures these forces. Force plate studies of the golf swing report that the vertical component commonly reaches $1.2$ to $1.5$ times body weight at peak downswing, because the golfer is accelerating his center of mass upward and forward [@winter2009biomechanics].
...
During a static stance, the CoP is roughly beneath the center of mass. During a dynamic swing, the CoP moves. Standard sign and coordinate conventions for GRF and CoP follow Winter's biomechanics conventions [@winter2009biomechanics], with vertical force positive upward and the CoP defined as the point at which the net horizontal moment of the distributed contact traction vanishes.
