...
In the golf swing, this weight shift happens dynamically throughout the motion. Force-plate studies report that at the top of the backswing, a majority of the vertical ground reaction force shifts to the trail foot, and by impact, the preponderance shifts to the lead foot. The specific percentages vary with swing style and measurement protocol. This transfer of ground reaction force is not just a consequence of the swing---it is an integral part of the driving mechanism.
...
During a golf swing, the ground exerts forces in all three directions simultaneously. A force plate---an instrument embedded in the ground---measures these forces. Force plate studies of the golf swing report that the vertical component commonly reaches $1.5$ to $2.2$ times body weight at peak downswing for skilled golfers, because the golfer is accelerating his center of mass upward and forward [@Ball2007; @Okuda2002]. The lower end of this range (around $1.2{-}1.5\times$) is more typical of recreational players; elite players consistently produce higher peak forces [@Winter2009].
...
During a static stance, the CoP is roughly beneath the center of mass. During a dynamic swing, the CoP moves. Standard sign and coordinate conventions for GRF and CoP follow Winter's biomechanics conventions [@Winter2009], with vertical force positive upward and the CoP defined as the point at which the net horizontal moment of the distributed contact traction vanishes.

Horizontal GRF components are additionally bounded by the friction-cone inequality, $\sqrt{F_x^2 + F_y^2} \le \mu_s F_z$, where $\mu_s$ is the static coefficient of friction between shoe and turf. If a golfer tries to produce a horizontal impulse that violates this bound, the feet slip and the effective ground constraint is lost. Early in the downswing, the CoP may move forward (toward the target), indicating that the golfer is shifting weight anteriorly. Later in the downswing, as the golfer extends through the ball, the CoP may migrate toward the medial (inner) foot or the heel, depending on the swing mechanics.
...
This equation is important. It says: the GRF is a *reaction*---it is whatever is required to maintain ground contact while the internal forces (muscles) reshape the body. The muscles create internal torques, which accelerate body segments. These accelerations change the center-of-mass acceleration. The GRF adjusts to match.
...
::: {.callout-note}
## Drift GRF vs. Control-Induced GRF
