...
- [Impact Mechanics and Ball Flight](impact-mechanics-and-ball-flight.html) — the full treatment of the collision, gear effect, the ball flight laws, and closure rate in its mechanical context.
- [Launch Monitor Technology](technology-launch-monitors.html) — how radar and photometric devices measure what they measure, and why clubface orientation is inferred rather than observed on radar systems.
- [Launch Monitor Vendor Reference](launch-monitor-vendor-reference.html) — the catalogue of published vendor definitions, including which reference point each system uses and where the definitions are mutually incompatible.
- [The Physics of the Rolling Putt](putting-roll-models.html) — the delivered-direction sensitivity taken to its extreme: at putting speeds spin consequences of face–path mismatch vanish, leaving start-line direction as almost the entire delivery, where a degree of error is a missed three-metre putt.
