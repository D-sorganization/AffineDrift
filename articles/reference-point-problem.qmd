...
This is the whole phenomenon. The clubhead's angular velocity $\boldsymbol{\omega}$ near impact is large — a driver head is turning through hundreds of degrees in the last few hundredths of a second — and $\mathbf{r}$, the vector from the tracked reference point to the impact point, is a few centimeters. Their cross product is a velocity of order 1 m/s, added to a translation of order 50 m/s, and mostly at right angles to it. The result is a small rotation of the velocity direction: about a degree, sometimes three.
