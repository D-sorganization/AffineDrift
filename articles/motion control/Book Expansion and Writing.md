...
*Listed directory [Moving Target Control Theory Book](file:///c:/Users/diete/Downloads/Moving%20Target%20Control%20Theory%20Book) *

*Viewed [chapter4.tex](file:///c:/Users/diete/Downloads/Moving%20Target%20Control%20Theory%20Book/chapter4.tex) *

*Viewed [chapter4.tex](file:///c:/Users/diete/Downloads/Moving%20Target%20Control%20Theory%20Book/chapter4.tex) *

*Viewed [chapter1.tex](file:///c:/Users/diete/Downloads/Moving%20Target%20Control%20Theory%20Book/chapter1.tex) *
...
*User accepted the command `pdflatex chapter5.tex`*
...
This chapter provides the theoretical foundation for how the massive clubhead speeds are actually generated. It transitions from treating *underactuation* as a problem, to seeing it as a geometric advantage we can exploit. 
...
* **The Moving Target OCP:** Mathematically formulates the Optimal Control Problem (OCP) where terminal time $t_f$ is a *free variable*, and the terminal constraint is simply intersecting a manifold (striking the golf ball with a square face) while optimizing kinematics (maximizing negative clubhead speed). 
...
*Viewed [chapter11.tex](file:///c:/Users/diete/Downloads/Moving%20Target%20Control%20Theory%20Book/chapter11.tex) *