...
For an applied counterfactual modeling study examining how drift and active torque split during proximal-to-distal energy handoffs in the golf downswing, see [Proximal-to-Distal Energy Transfer in the Golf Swing](proximal-distal-energy-transfer.html).
