...
These values are estimates from the simplified planar model; instrumented swing capture data would be needed to confirm. The qualitative pattern (progressive loss of controllability approaching impact) is consistent with the timing described in athlete EMG studies and coaching intuition.
