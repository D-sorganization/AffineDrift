...
6. **No finite-horizon reachability result:** This article does not yet compute governed reachable sets for the golf model. Path correction, arrival-time adjustment, and impact tolerances remain unavailable until the contract in @sec-anisotropy is implemented.
:::
