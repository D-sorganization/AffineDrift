...
Two companions round out the loop from the putter side: [secondary-axis stability](secondary-axis-stability.qmd) constrains the inertial design of the delivery state this software simulates, and the [strokes-gained critique](strokes-gained-limitations.qmd) prices what the simulated shots are worth in score terms.
