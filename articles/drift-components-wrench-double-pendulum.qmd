...
*   **Proximal-to-Distal Energy Transfer:** For the applied experimental timing sweep and Robertson–Winter interface power accounting on this same 2-DOF double pendulum model ([Proximal-to-Distal Energy Transfer](proximal-distal-energy-transfer.html)).
