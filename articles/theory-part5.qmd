...
- **[Applications Appendix](appendix-applications.html)** — Applies the drift/input decomposition to simulation, measurement-model comparison, and ML feature construction
- **[Part 4: Worked Pendulum Dynamics](theory-part4.html)** — Supplies the independently checkable mathematical examples this protocol verifies
- **[Affine Nature of the Golf Swing](affine-nature-golf-swing.html)** — The unabridged theoretical foundations monograph this procedure accompanies
:::
