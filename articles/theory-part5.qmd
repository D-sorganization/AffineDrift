...
The theoretical framework presented in Parts I through IV relies on precise algebraic cancellations between inertial, Coriolis, and elastic terms. While analytically guaranteed by the control-affine derivation, these cancellations must also hold in a numerical environment to be practically useful. This section documents the implementation of the AffineDrift framework within a forward-dynamics simulation (Simulink). It serves as a numerical proof-of-concept, verifying that the abstract definitions of ZTCF and ZVCF can be computed robustly in the presence of integration error and discrete-time sampling.
