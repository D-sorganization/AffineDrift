  ...
  <div class="laymans-terms-content">
    <div class="laymans-terms-inner">
      ...
      <div class="laymans-item">
        ...
        <p>Every object has a stable and unstable way to spin. If you try to spin a book or tennis racket flat, it flips uncontrollably. Your putter can do this too if the weight is spread out in a way that creates a hidden wobble.</p>
        <div class="analogy">
<strong>Think of it like:</strong> Trying to balance a broomstick on your palm. If it's perfectly upright, it's fine, but the moment it tilts slightly, it wants to fall over completely.
        </div>
      </div>

      <div class="laymans-item">
        <h3>The Putter Trade-off</h3>
        <p>Most modern putters spread weight to the edges (High MOI) to stop the face from twisting when you miss the sweet spot. But this spread-out weight can make the putter harder to steer precisely during the swing itself.</p>
        <div class="analogy">
<strong>Think of it like:</strong> Driving a bus vs. a bicycle. The bus (high MOI) ignores bumps but is hard to turn quickly. The bike (central spine) feels every bump but goes exactly where you point it instantly.
        </div>
      </div>

      <div class="laymans-item">
        <h3>The "Central Spine" Solution</h3>
        <p>Moving weight to the center makes the putter align better with your swing path, reducing the wobble effect, even if it makes it slightly less forgiving on off-center hits.</p>
        <div class="analogy">
<strong>Think of it like:</strong> Carrying a heavy backpack tight against your back (stable, moves with you) vs. swinging it at arm's length (hard to control, pulls you around).
        </div>
      </div>
