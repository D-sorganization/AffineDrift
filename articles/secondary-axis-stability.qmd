...
{{< include _generated/trust/critique-annotations/secondary-axis-stability.qmd >}}

<!--
Revision History:
- v2: Added constrained vs. free-body callout warning; clarified that golf club is not a free rigid body; frontmatter standardized.
...
- **[Part 2: Counterfactual Diagnostics (ZTCF/ZVCF)](theory-part2.html)** — Role of the zero-torque counterfactual as a diagnostic baseline for rotational stability
- **[Intentional Constraint Collapse](intentional-constraint-collapse.html)** — Dynamic biological equivalent of inertial alignment through constraint-Jacobian modulation
- **[Force and Mobility Matrices](force-mobility-matrices.html)** — Mathematical relationship between the inertia tensor and task-space maneuverability
- **[Part 3: Drift Invariance and Force Taxonomy](theory-part3.html)** — Drift invariance and the structural partitioning of passive dynamics
- **[Impact Mechanics and Ball Flight](impact-mechanics-and-ball-flight.html)** — The collision physics that the stabilized delivery state feeds
- **[Rotation-Induced Spin](rotation-induced-spin.html)** — How the clubface impulse partitions into launch and spin
- **[The Physics of the Rolling Putt](putting-roll-models.html)** — The putter-side application of stable delivery geometry
- **[Simulating the Green](green-simulation.html)** — Software implementation of the putt physics this design targets
:::
