...
::: {.callout-important}
## Primary mechanism: principal-axis alignment

At putting speeds, the dominant physical content of this section is **principal-axis alignment**, not intermediate-axis instability. When the putter's principal axes are misaligned with the stroke plane, the inertia tensor contains off-diagonal terms in the stroke frame. This creates **inertial coupling** — a linear effect proportional to $\omega$, not $\omega^2$ — where a pure rotation torque induces parasitic accelerations in orthogonal directions. This misalignment effect is present at all stroke speeds and is the primary driver of face-angle inconsistency at putting speeds.

The intermediate-axis theorem (an $\omega^2$ effect) is an illustrative analogy that becomes the dominant mechanism only at full-swing angular velocities ($\omega \gg 10 \, \text{rad/s}$). At putting speeds, treat the intermediate-axis discussion above as a motivating analogy, not the central mechanism.
:::
...
However, maximizing $I_z$ does not control the alignment of the other principal axes relative to the stroke plane. Increasing separation between $I_1, I_2, I_3$ through extreme perimeter weighting can increase off-diagonal inertia terms in the stroke frame (worsening principal-axis misalignment), making the putter more sensitive to small deviations in stroke plane and lie angle through inertial coupling. At full-swing speeds, this also sharpens the intermediate-axis instability.

Thus, high-MOI perimeter weighting improves static impact robustness, but may degrade dynamic rotational robustness through inertial coupling and, at high angular velocities, intermediate-axis sensitivity.
...
All inertia values in the table above are in **kg·m²**. To convert: 1 kg·m² = 10^7 g·cm² = 10,000,000 g·cm². For example, the perimeter-weighted value I₃ = 0.00133 kg·m² = 0.00133 × 10,000,000 = **13,300 g·cm²**, which is approximately 1.5× the upper end of the 6,000–9,000 g·cm² range cited for manufactured high-MOI mallets.
