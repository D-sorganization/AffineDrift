...
The same $\boldsymbol{\omega}\times\mathbf{r}$ acts vertically. The arc contribution tilts the face-center velocity **upward** relative to the CG (the face center sits ahead of the CG on an arc that is turning up through its low point), while closure about a shaft leaning toward the golfer contributes a smaller downward term. The net for a driver is of order **0.7–0.8° shallower** attack angle at the face center than at the geometric center.
...
For a detailed mathematical derivation of how the clubface's own closing rotation generates gear-effect spin even on a dead-centre strike (independent of strike offset), see the companion article: [Rotation-Induced Spin: Gear Effect Without an Off-Centre Strike](rotation-induced-spin.qmd).
:::
