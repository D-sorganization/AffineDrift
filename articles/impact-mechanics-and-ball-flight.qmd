...
For a detailed mathematical derivation of how the clubface's own closing rotation generates gear-effect spin even on a dead-center strike (independent of strike offset), see the companion article: [Rotation-Induced Spin: Gear Effect Without an Off-Center Strike](rotation-induced-spin.qmd).
:::
