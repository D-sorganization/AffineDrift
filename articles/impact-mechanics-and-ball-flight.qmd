...
- **[The Physics of Golf: Chapter 28 Impact and Collision](The_Physics_of_Golf/quarto/ch28_impact_collision.html)** — Textbook derivation of relative contact velocity, impulse, and deformation in the golf strike
- **[Secondary Axis Stability in Golf Clubs](secondary-axis-stability.html)** — How head inertia and perimeter weighting shape the delivery state this collision consumes
- **[On the Limits of Strokes-Gained Inference for Individual Golfers](strokes-gained-limitations.html)** — How measured impact differences translate, and fail to translate, into score value
:::
