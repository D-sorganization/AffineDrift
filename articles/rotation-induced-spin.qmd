...
*Companion to [Impact Mechanics and Ball Flight](impact-mechanics-and-ball-flight.qmd) (Part VI) and [The Reference-Point Problem in Club Delivery Data](reference-point-problem.qmd). The verification status of every delivery input used here is recorded in `content-development/technology-research/closure-rate-literature-dossier.md`.*
