...
- $\mathbf{v}_Q$ is the velocity a **non-rotating** head would deliver uniformly to the contact. It is the term every impact model already carries — it produces the ordinary spin-loft backspin and the ordinary face-to-path sidespin, and it is the quantity a point-mass treatment of the ball is implicitly using when it drives the ball's center of mass with the clubhead velocity.
