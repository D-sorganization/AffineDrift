...
\begin{enumerate}[label=(\roman*)]
  ...
  \item \textbf{Joints are not revolutes.} The knee, for example, combines rolling,
        ...
        \cite{komistek2003invivo}. The glenohumeral (shoulder)
...
\begin{enumerate}
  ...
  \item \textbf{Contraction velocity} (force-velocity relationship): concentric
        ...
        \cite{Thelen2003,millard2013flexing} and Chapter~3).
...
\begin{enumerate}
  ...
  \item \cite{Arnold2010}: lower-limb muscle morphometry from imaging and cadaver studies
\item \cite{Holzbaur2005}: the corresponding upper-extremity model, and the source of the
biceps parameters used in Chapter~3
\end{enumerate}
