...
include refinements by \cite{Thelen2003} and \cite{MillardEvans2013}.
...
\begin{definition}{Active Force-Length Curve}{fl-curve}
  ...
  \end{equation}
  where $\gamma \approx 0.45$ \cite{thelen2003adjustment} controls the width of the
...
\begin{quote}
  ...
  \cite{thelen2003adjustment} for the ``generic'' adult Hill-type muscle, and
...
class MuscleParameters:
    ...
    # adults," J. Biomech. Eng. 125(1), 70-77 [thelen2003adjustment].
