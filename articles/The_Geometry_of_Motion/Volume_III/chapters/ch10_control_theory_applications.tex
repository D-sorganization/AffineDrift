...
\noindent
Agrachev \& Sachkov \cite{agrachev2004control}, Theorem~8.1 (Pontryagin's Maximum Principle),
...
\midrule
Vol~0   & Screw axes, PoE      & Joint kinematics, ISA analysis            & \cite[Ch.~2]{agrachev2004control} \\
Vol~I   & Contraction theory   & Stability of muscle-driven systems        & \cite[Ch.~4]{agrachev2004control} \\
Vol~I   & DDP/iLQR             & Optimal muscle excitation patterns        & \cite[Ch.~8]{agrachev2004control} \\
Vol~II  & Trajectory tubes     & Motor variability envelopes               & \cite[Ch.~3]{agrachev2004control} \\
Vol~II  & Phase variables      & Gait cycle parameterization               & \cite[Ch.~7]{agrachev2004control} \\
Vol~III & Hill model           & Force prediction                          & \cite[Ch.~6]{agrachev2004control} \\
Vol~III & Inverse dynamics     & Joint torque estimation                   & \cite[Ch.~5]{agrachev2004control} \\
Vol~IV  & Motor control        & Neural command generation                 & \cite[Ch.~8]{agrachev2004control} \\
\bottomrule
\end{tabular}
\end{center}
