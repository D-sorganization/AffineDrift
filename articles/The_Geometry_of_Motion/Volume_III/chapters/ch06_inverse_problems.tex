...
\begin{tikzpicture}[scale=0.9, >=Stealth, node distance=2.2cm]
  ...
  \node[draw, thick, minimum width=2.5cm, fill=red!10, align=center, right of=id] (muscle) {Muscle Force\\Estimation};
...
\end{tikzpicture}
\caption{The inverse dynamics pipeline: from raw experimental data to individual muscle force estimates.}
