...
\begin{principle}{The Coordination Function of Bi-articular Muscles}{biarticular}
  ...
  control theory \cite{agrachev2004control}, the moment arm matrix $R(\bm{q})$ is a covector
  ...
  \cite{agrachev2004control} (reachability and controllability of affine systems).
\end{principle}
...
analysis of affine control systems. Agrachev \& Sachkov \cite{agrachev2004control} develop
