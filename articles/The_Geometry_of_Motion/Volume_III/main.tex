...
% ──────────────────────────────────────────────
% Notation Concordance — Volume III
% ──────────────────────────────────────────────
...
%   Transpose:  bare ^T
%
% Additional biomechanics-specific macros are defined below.
...
This volume is under active development. Chapters~1--3 contain substantial
content; Chapters~4--10 are structural outlines with preliminary material that
will be expanded in future editions. Exercises, worked examples, and backmatter
(glossary, further reading) have not yet been written.
\end{gomdraftnotice}
...
\include{chapters/ch01_biology_vs_engineering}
\include{chapters/ch02_musculoskeletal_conventions}
\include{chapters/ch03_muscle_models}
\include{chapters/ch04_joint_kinematics}
\include{chapters/ch05_multibody_bio}
\include{chapters/ch06_inverse_problems}
\include{chapters/ch07_experimental_methods}
\include{chapters/ch08_inference}
\include{chapters/ch09_deformable_bodies}
\include{chapters/ch10_control_theory_applications}
