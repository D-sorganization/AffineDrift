---
pagetitle: "Forward Dynamics, Counterfactuals, and Drift"
description: "How torque removal, geometry, energy, finite-horizon control and impact events connect in golf and humanoid models."
css:
...
[]{#sec-ch7:intervention}

### Control-Affine Dynamics and the Meaning of Zero
[]{#def-ch7:drift}
[]{#def-ch7:input}
...
### Local Solutions and Their Domain
[]{#thm-ch7:picard-lindelof}
...
### Flow Maps and Linearized Propagation

[]{#prop-ch7:flow-properties}
...
## Mechanical Drift, Velocity Resets, and Constraints
...
### What a Zero-Velocity Counterfactual Removes
[]{#def-ch7:ZVCF}
...
### Contact Reactions Also Respond to Input
...
[]{#driftcontrol-ratio-evolution}

[]{#velocity-scaling}

[]{#the-driftcontrol-ratio}

[]{#magnitude-scaling}
[]{#sec-ch7:authority}

### A Drift-Control Ratio With Declared Units
[]{#def-ch7:DCR}
...
### Why Speed Alone Does Not Decide the Ratio
...
### Direction, Cancellation, and Task Sensitivity
...
## Finite-Horizon and Impact Counterfactuals
...
### Inputs Act Through the Remaining Trajectory
Along a smooth nominal trajectory with prescribed input $u(t)$, let
[]{#eq-ch7:nominal-jacobian}
...
### Impact Is an Event, Not Merely a Clock Time
...
### A Reproducible Attribution Protocol
[]{#alg-ch7:attribution}
...
## Energy and Parameter Interventions
...
### Energy Is a Balance Over a Boundary
...
### Changing Gravity, Mass, or an Actuator
...
### The Separation Must Be Identifiable
...
### Noise, Validation, and Model Choice
...
## Stability and Optimal Control Are Separate Questions
...
[]{#sec-ch7:stability}
[]{#prop-ch7:minimal-intervention}
[]{#prop-ch7:ZTCF-stability}


### A Contraction Statement With a Complete Proof
[]{#def-ch7:drift-jacobian}
...
\end{aligned}
$$
[]{#thm-ch7:drift-contraction}
[]{#thm-ch7:drift-contraction-proof}
...
### A Large Drift Ratio Does Not Determine Optimal Effort
...
$$
[]{#thm-ch7:minimal-intervention-full}
[]{#eq-ch7:lqr-cost}
For $a=10$, $P\approx20.05$: strong unstable drift calls for strong stabilizing feedback. For $a=-10$, $P\approx0.04988$: favorable stable drift reduces the optimal gain for this particular objective. The sign, horizon, input cost and target matter. The Riccati/HJB construction is standard [@TedrakeLqrSupplement]; these scalar examples expose the missing implication directly.
...
## Worked Example: An Underactuated Double Pendulum
...
[]{#sec-ch7:double-pendulum-full}
[]{#eq-ch7:initial-condition}


### Geometry, Inertia, and Torque Coordinates
...
### Two Integrated Branches and Their Actual Evidence
...
[]{#tab-ch7:double-pendulum-sim}

| Time (s) | $q_1$ | $q_2$ | $v_1$ | $v_2$ | $a_{0,1}$ | $5(M^{-1})_{11}$ | $\rho_1$ |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
Actual Trajectory With Constant Base Torque. Angles Are in Radians, Rates in Radians per Second, and Accelerations in Radians per Second Squared. The Final Column Is the First-Coordinate Ratio.

[]{#tab-ch7:double-pendulum-ZTCF}

| Time (s) | $q_1$ | $q_2$ | $v_1$ | $v_2$ | $\|\Delta q\|$ |
| --- | --- | --- | --- | --- | --- |
...
Zero-Torque Trajectory From the Same Initial State. The Final Column Is the Norm of Its Position Difference From the Actual Branch, in Radians.
...
### Reproducing and Checking the Numbers
...
## How the Pieces Fit Together in a Golf Swing
...
### Preparation, Transport, and Correction
...
### A Testable Version of the Effort-to-Ease Idea
