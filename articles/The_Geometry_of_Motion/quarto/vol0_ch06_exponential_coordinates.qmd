...
Because Quaternions map rotation so cleanly via this exponential structure, interpolating halfway between two orientations $q_1$ and $q_2$ (called Slerp - Spherical Linear Interpolation) traces the exact geodesic arc across rotation space. Interpolating Euler Angles, by contrast, creates chaotic, unpredictable wobbling.
