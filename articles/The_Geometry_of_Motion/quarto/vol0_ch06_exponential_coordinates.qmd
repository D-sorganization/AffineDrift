...
**6.2 (Computational)** Implement the SE(3) exponential using the closed-form $G(\hat{m{\omega}},	heta)$ formula. Compare runtime vs `scipy.linalg.expm` on $10^4$ random screws.
