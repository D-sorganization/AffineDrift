...
See Murray, Li, & Sastry (1994) §2.3 and Lynch & Park [@Lynch2017ModernRobotics] §3.3 for derivations.
...
This routine round-trips with Rodrigues' formula to machine precision on a test suite of angles including $0$, $\pi/6$, $\pi/2$, and $\pi - \varepsilon$. References: Shoemake 1985 for numerical stability at $\theta \approx \pi$; Park & Lynch [@Lynch2017ModernRobotics] §3.3 for the generic branch.
