...
### Learning Across Trials and Feedback Within a Trial
...
### Deriving a Convergence Condition
...
### Noise Places a Floor Under Repeated Corrections
...
![Learning Gain Changes Convergence and Noise](../figures/learning_convergence_limits.png){#fig-learning_convergence_limits fig-alt="One learning gain reduces tracking error while another diverges; stationary command variance increases with the learning gain in a noisy scalar model."}
...
### Tracking Does Not Identify the True Mechanics
...
### Policy Search Optimizes Its Declared Objective
...
### Valid Entry and Transfer in a Trajectory Library
...
### A Learning Experiment That Can Inform Golf
...
[Bristow, Tharayil, and Alleyne (2006)](https://www.diag.uniroma1.it/~deluca/rob2_en/A_survey_of_iterative_learning_control_CSMag_2006.pdf) surveys lifted ILC, convergence, filtering, and robustness.
[Sutton, McAllester, Singh, and Mansour (1999)](https://proceedings.neurips.cc/paper/1999/file/464d828b85b0bed98e80ade0a5c43b0f-Paper.pdf) develops policy-gradient results with function approximation.
[Tedrake, Manchester, Tobenkin, and Roberts (2010)](https://groups.csail.mit.edu/robotics-center/public_papers/Tedrake10.pdf) describes LQR-Trees and the assumptions behind its verification and coverage results.
...
1. Derive the lifted error recursion with the stated error sign and dimensions.
1. Verify transient growth for $H$ and convergence or divergence for both scalar learning gains.
1. Calculate the biased fixed point introduced by the stated filter.
1. Derive the stationary command variance under independent measurement noise.
1. Explain why perfect tracking cannot separate the two indistinguishable parameters.
1. Verify the finite-penalty constraint violation and the unstable average of stable systems.
1. State sufficient common-certificate conditions for a proposed controller blend.
1. Design a comparison that distinguishes better impact outcomes from identification of a biological learning mechanism.

## Case Study: The Complete Golf Swing {#case-study-the-complete-golf-swing}





### A Reproducible Golf Investigation
...
### Define the Shot Before Choosing a Motion
...
### Declare the Mechanical Plant and Its Authority
...
### Compute a Feasible Reference Before Analyzing Its Stability
...
### Keep Event Timing in the Outcome Calculation
...
### Turn Local Feedback Into a Precisely Scoped Claim
...
### Add Variability and Learning Without Changing the Meaning of Evidence
...
### What a Completed Case Study Must Publish
...
### Primary Reading and the Scope of the Examples

The modeling conventions can be pursued through [Bullo and Lewis's geometric mechanics text](https://motion.me.ucsb.edu/book-gcms/) and [Featherstone's spatial dynamics materials](https://royfeatherstone.org/teaching/index.html). The phase and hybrid conditions connect to [Grizzle and Chevallereau's treatment of virtual constraints and hybrid zero dynamics](https://grizzle.robotics.umich.edu/files/HZD_HandbookApril2015.pdf). [Majumdar and Tedrake (2017)](https://doi.org/10.1177/0278364917712421) develops verified funnel libraries for robotic motion planning. These references support the engineering methods; they do not constitute experimental validation of the golf protocol proposed here.

### Worked Checks and Exercises


1. Specify the contact guard, crossing direction, output map, and failure events for a proposed shot task.
1. Count independent coordinates and input rank after declaring grip and ground constraints.
1. Derive the smooth energy balance and state which impact assumptions it does not cover.
1. Recover the point model's exact contact and its first-order sensitivity to forward speed.
1. Derive the phase-indexed boundary condition using the actual phase rate.
1. Verify the ellipsoid output bound and its invariance under a nonsingular change of coordinates.
1. Separate the evidence needed for a simulated improvement, a nonlinear certificate, and a biological explanation.
