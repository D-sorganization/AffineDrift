...
Just as translation and rotation were unified into $T$, linear velocity $v \in \Reals^3$ and singular angular velocity $\omega \in \Reals^3$ are unified into a 6-dimensional **Spatial Velocity** vector, the same 6-D bookkeeping used in Featherstone's spatial-vector formulation and in formal screw-theory treatments of rigid-body motion [@featherstone2010guide6d; @crane2022screw_theory; @featherstone2008rigid].
...
When modeling the physics engines throughout *Tangent-Space Methods*, every mechanical coupling, robotic joint, actuator limit, and contact force is calculated exclusively using $6D$ Spatial Twists and Wrenches operating in $\se$ [@featherstone2010guide6d; @crane2022screw_theory].
