...
**Layout (scalar-first Hamilton):** we write $q = [q_0,\, q_1,\, q_2,\, q_3]^T = [w,\, \bm{v}]^T$ with the scalar part $w = \cos(\theta/2)$ first, matching Lynch & Park [@Lynch2017ModernRobotics] and MuJoCo.
