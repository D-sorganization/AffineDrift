...
If $\bm{p}_{end} = [x, y, z]^T$ is the Cartesian position of the end of our robotic arm (or a golf clubhead), Forward Kinematics is the nonlinear function $\bm{f}_{kin}: \configspace \to \Reals^3$ carrying joint angles to that position. When the full end-effector pose matters rather than position alone, the target space becomes $\SE$, the set of rigid-body poses:
