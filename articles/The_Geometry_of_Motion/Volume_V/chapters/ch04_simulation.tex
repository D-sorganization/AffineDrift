...
\begin{figure}[h]
  \centering
  \begin{tikzpicture}[
    every node/.style={draw, rounded corners, minimum width=2.2cm, text centered, font=\small},
    ]
    % State
    ...
    \draw[->] (integrate) -- (next);
    \draw[->] (12.8, -0.3) -- (12.8, -1.2) -- (0, -1.2) -- (0, -0.4) node[above, pos=0.5, fill=white] {repeat};
  \end{tikzpicture}
