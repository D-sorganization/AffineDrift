...
\index{stochastic trajectory}\index{motor variability}%
\index{signal-dependent noise}\index{minimum variance theory}%
\index{Todorov--Jordan theory}\index{uncontrolled manifold}%
\index{optimal feedback control}\index{OFC}%
\index{minimum intervention principle}%
\index{task-relevant variability}\index{synergy}%
\index{Wiener process}\index{It\^o SDE}%
\index{Fokker--Planck equation}\index{Kalman filter}%
\index{execution noise}\index{covariance propagation}
