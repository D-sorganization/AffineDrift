...
\index{underactuation}\index{passive dynamics}\index{zero dynamics}%
\index{feedback linearization}\index{actuation matrix}%
\index{double pendulum}\index{parametric excitation}%
\index{inertial coupling}\index{Coriolis matrix}\index{mass matrix}%
\index{annihilator}\index{constraint!dynamic}%
\index{control Lie algebra}\index{bang-bang control}\index{singular arc}
