...
still satisfying the orbital-stability condition. Only deviations \emph{away from}
the orbit matter.
...
stability---is the correct framework. The most defensible golf interpretation
is that some models exhibit transverse contraction near impact, and that
transverse LQR can tighten the admissible tube with phase-varying gains
matched to the modeled motion.
