...
% ══════════════════════════════════════════════
\section{Beyond LQR: The Need for Certified Invariance}
% ══════════════════════════════════════════════
...
We need a mathematically rigorous way to define a \emph{verified boundary} for the funnel. For the fully nonlinear equations of motion, the goal is to certify that any state starting inside the candidate set at time $t=0$ remains inside it for the modeled interval $t \in [0, t_f]$.
