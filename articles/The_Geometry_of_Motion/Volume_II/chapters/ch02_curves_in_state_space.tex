...
\index{curve!in state space}\index{arc length}\index{tangent vector}%
\index{Frenet--Serret frame}\index{curvature!of a curve}\index{torsion}%
\index{osculating plane}\index{normal vector}\index{binormal vector}%
\index{Fundamental Theorem of Curves}\index{reparameterization}%
\index{transverse dynamics}\index{orbit theorem}\index{Lie bracket}%
\index{control vector field}\index{sub-Riemannian geometry}
...
This result has a concrete implication: \emph{the stability of trajectory
