...
\noindent
In the language of Agrachev \& Sachkov's geometric control theory \cite{agrachev2004control},
the null space of $J_h$ IS the uncontrollable subspace of the system when the task variable
is taken as the output. Chapter~3.1 of \cite{agrachev2004control} develops exactly this theory:
...
\begin{itemize}
  ...
  \item Stage 3: exploit the drift dynamics $f(\state)$ by designing trajectories that
        ...
        \cite{agrachev2004control}, Chapter~4, which develops the geometric theory of accessible
