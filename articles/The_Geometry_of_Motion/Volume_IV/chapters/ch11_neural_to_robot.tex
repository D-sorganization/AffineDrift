...
The cerebellum's circuit architecture (Marr, 1969; Albus, 1971; Kawato et al., 1987)
directly suggests an adaptive control scheme:
\begin{itemize}
  \item \textbf{Granule cells} ($\sim$69 billion): create a compressed basis function
...
generate walking/running patterns. This architecture is inspired by Grillner's (1975)
