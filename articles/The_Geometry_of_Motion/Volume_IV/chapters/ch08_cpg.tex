...
\begin{tikzpicture}[scale=0.9]
  % Two neurons
  \draw (1, 1.5) circle (0.25) node[align=center, anchor=center, font=\tiny] {N1};
  \draw (3, 1.5) circle (0.25) node[align=center, anchor=center, font=\tiny] {N2};

  % Inhibitory coupling
  \draw[->, thick] (1.25, 1.3) -- (2.75, 1.3) node[align=center, anchor=south, midway, font=\tiny] {inhibit};
  \draw[->, thick] (2.75, 1.7) -- (1.25, 1.7) node[align=center, anchor=north, midway, font=\tiny] {inhibit};

  % Adaptation (self-feedback)
  \draw (1, 0.7) circle (0.12) node[align=center, anchor=center, font=\tiny] {adapt};
  \draw[->, thick] (1, 0.85) -- (1, 1.2);

  \draw (3, 0.7) circle (0.12) node[align=center, anchor=center, font=\tiny] {adapt};
  \draw[->, thick] (3, 0.85) -- (3, 1.2);

  % Tonic input
  \draw[->, thick] (0.2, 1.5) -- (0.75, 1.5) node[align=center, anchor=south, midway, font=\tiny] {$u$};

  % Outputs
  \draw[->, thick] (1, 2) -- (1, 2.5) node[align=center, anchor=south, font=\tiny] {$y_1$};
  \draw[->, thick] (3, 2) -- (3, 2.5) node[align=center, anchor=south, font=\tiny] {$y_2$};

  % Title
  \draw (2, 3.2) node[align=center, anchor=center, font=\small\bf] {Matsuoka Oscillator (Half-center)};
  \draw (2, 2.85) node[align=center, anchor=center, font=\tiny] {Mutual inhibition + adaptation = oscillation};
\end{tikzpicture}
