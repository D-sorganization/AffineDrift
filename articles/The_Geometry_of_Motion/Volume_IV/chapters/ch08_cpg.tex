...
\begin{itemize}
  \item Isolated lamprey spinal cord generates swimming patterns~\cite{CohenWallen1980}
  \item Deafferented cats produce coordinated stepping on treadmills~\cite{Grillner1975}
  \item Songbird pre-motor nuclei show rhythmic activity in vitro~\cite{Solis2005}
\end{itemize}
