...
\begin{tikzpicture}[scale=1.0]
  % Axes
  \draw[->, thick] (0, 0) -- (6, 0) node[anchor=north] {Dimension ($n$)};
  \draw[->, thick] (0, 0) -- (0, 5) node[anchor=east, rotate=90] {Computational Cost};
  ...
  \draw[green, thick] (0, 0.3) -- (6, 0.3) node[anchor=west] {\small Synergies: $O(k^3)$};

  % Shaded region (infeasible)
  \fill[red, opacity=0.1] (4, 5) -- (6, 5) -- (6, 0) -- (4, 0) -- cycle;
  \draw (5, 3) node[anchor=center] {\small Curse\\ \small region};

  \draw (3, 4.2) node[anchor=center, font=\small] {Exponential growth};
\end{tikzpicture}
