...
\include{chapters/ch03b_induced_acceleration_biomechanics}
...
\include{chapters/ch09_parallel_mechanisms_constrained_dynamics}
...
Linear Matrix Inequalities (LMIs) take the form $\mat{A}_0 + \sum_i x_i \mat{A}_i \prec 0$.
These are convex constraints. Tools like cvxpy and SciPy can solve LMI optimization problems
efficiently.
