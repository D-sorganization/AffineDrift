...
\begin{example}{Python Example: SO(3) Exp/Log}{app_so3_exp_log}
...
\begin{example}{Python Example: Sparse Solve with SciPy}{app_sparse_solve}
\begin{lstlisting}[language=Python]
import numpy as np
...
\begin{example}{Python Example: Lyapunov LMI in cvxpy}{app_lmi_cvxpy}
\begin{lstlisting}[language=Python]
import cvxpy as cp
import numpy as np
