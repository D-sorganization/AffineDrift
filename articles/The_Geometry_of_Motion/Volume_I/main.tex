...
%% Note: Volume 0 defines a different 'algorithmic' env (monospace wrapper).
%% If compiling the series as a single document, use \gomdeclaretheorems from
%% geometry_of_motion.sty and load the algorithmic package instead.
\usepackage{float}
