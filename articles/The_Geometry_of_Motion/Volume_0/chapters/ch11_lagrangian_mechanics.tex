...
for all trajectories $\dot{\mathbf{q}}$. Since this quadratic form vanishes for arbitrary $\dot{\mathbf{q}}$, the matrix $\dot{\mathbf{M}} - 2\mathbf{C}$ must be skew-symmetric:
