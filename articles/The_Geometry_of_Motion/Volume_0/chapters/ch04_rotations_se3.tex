...
\section{Euler Angles\index{Euler Angles} and Gimbal Lock\index{Gimbal Lock}}
...
This is known as an \textbf{Euler Angle} representation: $\bm{\theta} = [\theta_1, \theta_2, \theta_3]^T$. While highly intuitive for a human pilot, Euler Angles\index{Euler Angles} harbor a fatal mathematical flaw known as \textbf{Gimbal Lock\index{Gimbal Lock}}.
...
\begin{principle}{The SO(3) Manifold\index{Manifold}}{so3}
  ...
  If a Configuration Space\index{Configuration Space} $\configspace$ is simply a rigid body rotating around a point, we say $\configspace = \SO$.
\end{principle}
