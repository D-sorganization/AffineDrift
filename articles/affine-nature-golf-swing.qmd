...
$$ (M_{qq} - M_{q\eta} M_{\eta\eta}^{-1} M_{\eta q}) H_{qq} = I $$
The term in parentheses is the **Schur Complement** of $M_{\eta\eta}$, often denoted as the **Articulated Body Inertia** $\Delta$. Thus, the primary diagonal block is:
$$ H_{qq} = \Delta^{-1} = (M_{qq} - M_{q\eta} M_{\eta\eta}^{-1} M_{\eta q})^{-1}. $$
