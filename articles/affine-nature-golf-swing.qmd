...
- **[Applications Appendix](appendix-applications.html)** — The applications companion to this monograph: simulation, equipment comparison, and ML use of the same framework
- **[Part 2: Counterfactual Diagnostics](theory-part2.html)** — Defines the ZTCF and ZVCF operations developed in detail here
- **[Part 3: Drift Invariance and Force Taxonomy](theory-part3.html)** — The same-state decomposition and its interpretation in compact form
