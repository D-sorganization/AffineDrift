...
This article uses the $(q, \eta)$ subscript convention (q = joint coordinates, $\eta$ = flexible modes). The companion article *Part 4: Modal Approximation, Wrenches, and Pendulum Dynamics* (`theory-part4.qmd`) uses the equivalent $(r, f)$ convention (r = rigid, f = flexible): $M_{qq} \equiv M_{rr}$, $M_{\eta\eta} \equiv M_{ff}$, $M_{q\eta} \equiv M_{rf}$, $M_{\eta q} \equiv M_{fr}$.
:::
