...
This ratio is the mechanical 'gear ratio' of the system. It dictates how much 'kick' the flexible shaft receives for every unit of acceleration the golfer produces at the hands. Crucially, this transmission is purely inertial—it depends on the mass distribution of the club, not its stiffness. This means the golfer cannot 'turn off' the interaction; they can only manage it by managing their own acceleration.
