...
<section class="critics-comments">
  ...
  <div class="critics-comments-content">
    <div class="critics-comments-inner">
      ...
      <div class="critic-item">
        <div class="critic-perspective">
          <span class="critic-label">Interpretational Ambiguity:</span>
          <h3>Is "Braking" Always Bad?</h3>
        </div>
        <p class="critic-argument">
          The decomposition identifies negative input torque as "braking" or "inefficiency". However, in human movement, antagonistic co-contraction is a feature, not a bug—it stabilizes joints. Labeling it as "fighting the drift" implies error where there may be strategy.
        </p>
        <div class="author-response">
          <strong>Our Response:</strong> This is a valid distinction. We clarify that "Input Force" measures the <em>net</em> mechanical intervention, not the metabolic cost or intent. A negative input torque is mechanically dissipative but may be strategically essential for stability (impedance control). The framework diagnoses the mechanical cost, not the tactical utility.
        </div>
      </div>
