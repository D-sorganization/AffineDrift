...
Applying the Euler-Lagrange operator $\frac{d}{dt}(\frac{\partial \mathcal{L}}{\partial \dot{q}_{\text{sys}}}) - \frac{\partial \mathcal{L}}{\partial q_{\text{sys}}} + \frac{\partial \mathcal{R}}{\partial \dot{q}_{\text{sys}}} = \tau_{\text{gen}}$ yields the equations of motion:
