...
*   **Inverse dynamics limitations**: why calculated quantities are not the same as measured ones. (See: [Interpretation of Inverse Dynamics](inverse-dynamics.html))
*   **Impact and collision**: the physics the D-plane inversion depends on. (See: [The Physics of Golf, Chapter 28](The_Physics_of_Golf/quarto/ch28_impact_collision.html))
*   **Club fitting**: the delivery-state predictions these measurements feed. (See: [Club Fitting Simulation](technology-club-fitting.html))
*   **Heavy-hit decoupling**: why measured muscle effort cannot act during the collision itself. (See: [Multibody Impact Coupling and the Heavy Hit Hypothesis](technology-heavy-hit-impact-coupling.html))
:::
