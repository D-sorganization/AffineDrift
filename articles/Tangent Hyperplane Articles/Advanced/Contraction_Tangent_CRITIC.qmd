  ...
  <div class="laymans-terms-content">
    <div class="laymans-terms-inner">
      ...
      <div class="laymans-item">
        ...
        <p>The paper claims that finding the optimal setup guarantees stability, and that being stable means you have the optimal setup. In reality, you can have a perfectly stable system without it being the most efficient.</p>
        <div class="analogy">
<strong>Think of it like:</strong> driving a slow, heavy tractor. It is very stable and safe to drive, but it is definitely not the fastest or most efficient vehicle on the road.
      ...
      <div class="laymans-item">
        <h3>Missing Real-World Evidence</h3>
        <p>The author uses math to guess how human muscles coordinate during complex movements. However, the paper does not include any actual biological tests to prove that human brains work this way.</p>
        <div class="analogy">
<strong>Think of it like:</strong> writing a detailed recipe based only on looking at a photo of a cake. The result might look similar, but you have no proof it tastes the same without actually testing it.
      ...
      <div class="laymans-item">
        ...
        <p>The paper advertises a method with a guaranteed safety net, claiming the system will not fail. Yet, the rigorous mathematical proof needed to back up that guarantee is missing.</p>
        <div class="analogy">
