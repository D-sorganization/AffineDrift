  ...
  <div class="laymans-terms-content">
    <div class="laymans-terms-inner">
      <p class="laymans-terms-intro">
        A plain-language overview of the main criticisms aimed at the article connecting contraction theory and optimal control.
      </p>

      <div class="laymans-item">
        <h3>The One-Way Street of Optimization</h3>
        <p>The paper claims a two-way street between finding the most efficient path (optimality) and returning to that path when bumped off it (stability). In reality, it's mostly a one-way street: the most efficient path is usually stable, but a stable path isn't automatically the most efficient.</p>
        <div class="analogy">
<strong>Think of it like:</strong> driving a car. If you drive optimally to save gas, you are probably driving smoothly and safely (stable). But just because you drive safely doesn't mean you're getting the best gas mileage.
        </div>
      </div>

      <div class="laymans-item">
        <h3>Unsupported Human Biology Claims</h3>
        <p>The article tries to use its mathematical formulas to explain human movement, like muscle memory in a golf swing. However, it doesn't provide real-world biological data to prove that the human brain actually works exactly like these formulas.</p>
        <div class="analogy">
<strong>Think of it like:</strong> assuming a baseball player mathematically calculates wind speed and gravity equations in their head before hitting a home run. The math explains the result, but that's not how the player actually does it.
        </div>
      </div>

      <div class="laymans-item">
        <h3>Missing Proof for Guarantees</h3>
        <p>The author promises "certified stability," which sounds like an absolute guarantee that the system won't crash. But the paper skips the actual mathematical proof needed to back up that strong promise.</p>
        <div class="analogy">
<strong>Think of it like:</strong> a restaurant claiming their food is "100% Certified Organic," but refusing to show you the actual farm certification paperwork when you ask for it. A guarantee needs proof.
        </div>
      </div>

      <div class="key-takeaway">
        <strong>Key Takeaway:</strong> The paper has great mathematical ideas, but overpromises on its guarantees and stretches its claims too far into human biology without enough proof.
      </div>
    </div>
  </div>
</section>
