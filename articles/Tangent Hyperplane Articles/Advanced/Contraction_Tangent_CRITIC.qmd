  ...
  <div class="laymans-terms-content">
    <div class="laymans-terms-inner">
      <p class="laymans-terms-intro">
        This critique looks at a theory that tries to connect how systems stay stable with how they save energy, and uses this to explain human movement. Here are the main issues with the paper, explained simply.
      </p>

      <div class="laymans-item">
        <h3>Efficiency Doesn't Mean Stability</h3>
        <p>The paper claims that systems saving the most energy are naturally the most stable. However, being efficient and being stable are two different things. A system can be incredibly safe but still use a lot of energy.</p>
        <div class="analogy">
<strong>Think of it like:</strong> driving a heavy tractor. It is very stable and won't flip easily, but it is definitely not a fast or efficient way to travel.
        </div>
      </div>

      <div class="laymans-item">
        <h3>Math Doesn't Always Equal Reality</h3>
        <p>The author uses pure math to guess how our brain controls our muscles. But they don't include any real-world physical tests to prove this is actually true. Just because the math works on paper doesn't mean our biology actually uses it.</p>
        <div class="analogy">
<strong>Think of it like:</strong> writing a detailed recipe based only on looking at a photo of a cake. The final cake might look similar, but you have no proof it tastes right without actually baking it.
        </div>
      </div>

      <div class="laymans-item">
        <h3>Guarantees Without Proof</h3>
        <p>The paper promises its new method is completely safe and won't fail. However, it skips showing the actual proof needed to back up such a bold claim. We can't trust that it works perfectly without seeing the full evidence.</p>
        <div class="analogy">
<strong>Think of it like:</strong> a lock company claiming their newest lock is completely unbreakable, but refusing to show the test results to prove it.
        </div>
      </div>

      <div class="key-takeaway">
        <strong>Key Takeaway:</strong> While the math connects interesting ideas, the paper's broad claims about guarantees and human biology lack the necessary proof to be fully trusted.
      </div>
    </div>
  </div>
</section>
...
<h3>The Pragmatic Value of the "Duality" Framework</h3>
        ...
        <p class="critic-argument">The critique that the stability-optimality mapping is mathematically asymmetric (LQR yields contraction, but the inverse is non-unique) is formally correct, but it arguably misses the point for applied engineering. In modern control design, treating this relationship as a bidirectional "duality" is not a mathematical oversight, but a necessary, productive heuristic. Bridging these concepts allows practitioners to inject geometric stability constraints directly into optimization frameworks, significantly accelerating the design of safe, high-performance robotics. Insisting on strict mathematical isomorphisms over operational utility risks gatekeeping tools that, empirically, work exceptionally well.</p>
        <div class="author-response">
<strong>Our Response:</strong> We acknowledge the power of this operational heuristic; engineering routinely outpaces formal theory by relying on what works in practice. The framework is indeed a strong design accelerator. However, clarity of taxonomy remains important. If the text explicitly framed this as a <em>pragmatic</em> duality rather than a formal mathematical equivalence, it would empower engineers without misleading theorists.
        </div>
      </div>
...
<h3>Mathematical Frameworks as Predictive Biological Models</h3>
        ...
        <p class="critic-argument">Dismissing the muscle synergy claims (Section 7) due to a lack of immediate empirical data fundamentally misunderstands how theoretical computational neuroscience operates. New organizing principles—like the hypothesis that biological synergies maximize contraction rates—must be mathematically formalized <em>before</em> experimentalists know what to look for. Historically, foundational models like minimum-jerk or minimum-variance were proposed entirely on mathematical elegance before data verified them. By framing contraction maximization mathematically, the authors are providing a precise, falsifiable model that gives meaning and direction to future EMG and motion capture studies.</p>
        <div class="author-response">
<strong>Our Response:</strong> This is a highly valid perspective. Theoretical formulation is a necessary precursor to discovery, and the contraction-maximization hypothesis is both compelling and testable. The intention of our critique is not to suppress theoretical exploration, but to urge the authors to clearly label these sections as "predictive models" rather than "established facts." This ensures that readers appropriately distinguish the rigorously proven control math from the pioneering biological hypotheses.
        </div>
      </div>
...
<h3>Rethinking "Certified" in the Context of Optimization-Based Control</h3>
        ...
        <p class="critic-argument">Demanding an exhaustive, global analytical proof to justify the term "certified stability" (Theorem 4.1) applies an anachronistic standard to modern optimization-based control. In contemporary, high-dimensional robotics, analytical proofs are often intractable. Instead, "certified" has evolved to mean that the control algorithm mathematically embeds and verifies stability constraints (like SDP conditions) <em>at runtime</em>. Because the solver rigorously checks these conditions step-by-step before executing control, the system is practically and mathematically certified by the algorithmic structure itself, rendering the demand for offline global proofs largely obsolete.</p>
        <div class="author-response">
<strong>Our Response:</strong> We concede that runtime algorithmic guarantees represent a paradigm shift in how stability is practically verified, and treating SDP enforcement as a form of certification is reasonable. Acknowledging this modern standard, our critique's focus refines: the article would be significantly strengthened by explicitly defining "certified" as "algorithmically guaranteed at runtime" rather than allowing readers to assume a classical, offline analytical proof exists.
        </div>
      </div>
