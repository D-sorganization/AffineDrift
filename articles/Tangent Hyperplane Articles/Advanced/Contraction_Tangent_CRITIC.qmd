    ...
    <div class="critics-comments-inner">
      ...
      <div class="critic-item">
        <div class="critic-perspective">
          ...
          <h3>Engineering Pragmatism over Perfect Duality</h3>
        </div>
        <p class="critic-argument">The critique emphasizes that the stability-optimality duality is a "one-way street" because not every contraction metric is a Riccati solution. While mathematically true, many control engineers argue this is a pedantic distinction for practical applications. In engineering, finding <em>any</em> valid contraction metric is often the primary goal for proving safety. The fact that the inverse optimal problem lacks a unique solution doesn't negate the immense utility of using LQR techniques as a systematic way to generate valid contraction metrics for complex systems.</p>
        <div class="author-response">
          <strong>Our Response:</strong> This is a fair practical point. LQR is indeed a phenomenal tool for finding valid metrics. Our critique aims to correct the <em>theoretical framing</em> of the original paper, which suggested a fundamental, bidirectional equivalence that does not exist, potentially misleading researchers attempting inverse optimal control without additional constraints.
        </div>
      </div>
      ...
      <div class="critic-item">
        <div class="critic-perspective">
          <span class="critic-label">Alternative View:</span>
          <h3>In Defense of Theoretical Biomechanics</h3>
        </div>
        <p class="critic-argument">The critique strongly attacks the claim that "Synergies Maximize Contraction Rate" for lacking immediate empirical validation. However, in theoretical biology and computational motor control, proposing mathematically elegant optimization principles—such as minimum jerk, minimum variance, or maximal contraction—is a standard first step. These theoretical priors are necessary to drive new experimental paradigms. Waiting for full empirical data before publishing a theoretical framework stifles the generation of testable hypotheses.</p>
        <div class="author-response">
          <strong>Our Response:</strong> We acknowledge that theoretical models often lead experimental validation. However, the original article presented this hypothesis almost as established fact rather than a speculative prior. Our critique enforces a clear boundary between established motor control literature (e.g., Optimal Feedback Control) and novel, yet-to-be-verified hypotheses.
        </div>
      </div>
      ...
      <div class="critic-item">
        <div class="critic-perspective">
          <span class="critic-label">Alternative View:</span>
          <h3>Practical Engineering vs. Formal Verification</h3>
        </div>
        <p class="critic-argument">The critique is overly harsh regarding the missing formal mathematical proofs for "Certified Stability" (Theorem 4.1). In applied robotics and high-DOF trajectory optimization, empirical stability—demonstrated by consistent convergence of the Contraction-DDP algorithm across varied initial conditions—is often sufficient. Demanding rigorous Sum-of-Squares (SOS) verification or strict uniform boundedness for real-time robotic controllers is practically impossible and ignores the utility of highly effective engineering heuristics.</p>
        <div class="author-response">
          <strong>Our Response:</strong> We agree that engineering heuristics are incredibly valuable and formal verification is not always computationally feasible. The issue arises solely from the use of the word "Certified." In control theory, "certified" implies a formal, checkable mathematical guarantee. If the algorithm provides strong empirical robustness but lacks formal proof, it should simply be termed "empirically robust" to avoid misleading safety-critical implementations.
        </div>
      </div>
