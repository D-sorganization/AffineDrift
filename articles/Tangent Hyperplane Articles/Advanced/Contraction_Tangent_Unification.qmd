...
def compute_contraction_metric(A, Q, lam=1.0, dt=0.01):
    """
    ...
    Args:
        ...
        dt: Time step (for discrete-time approximation)
...
# ========== DDP Forward Pass ==========
@jit
def forward_pass(x0, us, Ks, ks, params, dt, alpha=1.0):
...
# ========== Main DDP Loop ==========
def ddp_solve(x0, xT, T_horizon, params, Q, R, QT,
    ...
    for iter in range(max_iters):
        ...
        for alpha in [1.0, 0.5, 0.25, 0.1]:
            xs_new, us_new = forward_pass(x0, us, Ks, ks, params, dt, alpha)
