  ...
  <div class="laymans-terms-content">
    <div class="laymans-terms-inner">
      ...
      <div class="laymans-item">
        ...
        <p>This is about machines or motions that naturally fix their own mistakes without needing constant new instructions. If a sudden bump pushes you off your path, the system automatically pulls you back to where you belong. The correction happens predictably and smoothly, no matter the disruption.</p>
        <div class="analogy">
<strong>Think of it like:</strong> Dropping a marble into a smooth, curved bowl. No matter where you drop it along the edge, it will always roll directly to the very bottom center.
      ...
      <div class="laymans-item">
        ...
        <p>People used to think that finding the absolute best way to do something was entirely different from finding the safest, most reliable way to do it. We now know that the tension needed to perfectly perform a task is exactly what keeps you perfectly steady. Doing the task best automatically makes it the most secure.</p>
        <div class="analogy">
<strong>Think of it like:</strong> Riding a bicycle at a good pace. The forward momentum that helps you reach your destination efficiently is the exact same force keeping the bike upright and balanced.
      ...
      <div class="laymans-item">
        ...
        <p>Instead of thinking of movement on a flat surface, this approach views movement on a surface curved specifically for your goal. The system shapes the environment so that reaching your destination is always the easiest, most natural path. Any deviation from the plan feels like walking steeply uphill, so you naturally drift back down into place.</p>
        <div class="analogy">
