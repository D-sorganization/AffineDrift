...
**Planned additions for final thesis:**

1. Detailed derivation of Euler-Lagrange equations from variational calculus
2. Proof of Pontryagin's Maximum Principle
3. Examples: minimum-time, minimum-energy, tracking problems
4. Connection to LQR (Hamiltonian reduces to Riccati equation for quadratic costs)
5. Constrained optimization via augmented Lagrangians
...
1. Higher-order integration schemes (RK4, adaptive)
2. Convergence analysis: $\Delta t \to 0$ limit
3. Numerical stability and stiffness considerations
4. Error accumulation and bounds
5. Code examples in Python/Julia
6. Comparison of methods (explicit vs implicit, fixed vs adaptive step)
...
1. Detailed DDP/iLQR derivations with Riccati recursions
2. Convergence proofs and stability guarantees
3. Computational complexity analysis
4. Extensions: constrained MPC, robust MPC, stochastic MPC
5. **Case Study 1**: Spacecraft rendezvous
6. **Case Study 2**: Robot arm manipulation
7. **Case Study 3**: Quadrotor trajectory planning
8. Code implementations with benchmarks
