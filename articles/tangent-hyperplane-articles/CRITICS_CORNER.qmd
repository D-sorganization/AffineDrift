...
This document identifies the **strongest possible objections** to the Tangent Hyperplane thesis and answers each one rigorously. We assume hostile, intelligent reviewers who will interpret ambiguities uncharitably.
...
**Verdict:** Valid concern. Solution: Explicit discussion of regularization and hybrid systems. The limitation stands, but the framework remains broadly useful.
