...
Traditionally, control engineers treated these as separate problems requiring separate solutions. They would:
...
"Contraction" has a narrow technical meaning: errors shrink on their own.
...
From the main thesis, you learned that nonlinear systems admit an exact linear *approximation* at any instant. To first order, the dynamics follow simple, linear rules on a **tangent plane**, and the error grows as the square of the step size.
...
**The key point:** In LQR-like cases, the Riccati matrix from optimal control can serve as a contraction metric for the local closed-loop system.
...
## The Algorithms: How to Use This
