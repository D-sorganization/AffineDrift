...
2. **Cite specific results where claimed:**
   ...
   > This formula is derived in Burden et al. (2015, Theorem 3.2) using the calculus of variations. We provide a sketch here for completeness; see @burden2015metrically for the full proof.
