...
- Anyone curious about why LQR, MPC, and DDP work
...
*Goal: Understand the claims well enough to evaluate or extend them*
- Read the main pages, appendices, and critique pages together
...
**What You'll Learn:**
- Part I: Where tangent spaces provide exact infinitesimal structure
...
- Worked DDP/iLQR algorithm sketches with case studies
...
**What You'll Learn:**
- Contraction theory (Lohmiller & Slotine) via tangent-bundle language
- Conditional links between stability analysis and optimal-control calculations
- Contraction metrics as Riemannian geometry on tangent spaces
- How contraction constraints can be added to trajectory optimization, and what must be checked before claiming convergence
...
**Applications:**
- Checking DDP convergence conditions for specific systems
- Designing controllers with explicit local stability certificates
- Understanding when LQR assumptions are strong enough for the intended claim
...
**Why it's wrong:** The tangent space (derivative) is **exact**. What's approximate is using it far from the linearization point. DDP/iLQR re-linearize at every step, so each step stays near the point where the linear model holds.
...
A: Read CRITICAL_REVIEW.md and CRITICS_CORNER.qmd carefully. Novel aspects: geometric framing, residual-as-feature, unification across methods.
...
**If you have 1 day:** Read the Unified Thesis with the critique pages open
**If you have 1 week:** Read the Unified Thesis, one advanced article, and implement a small case study
**If you have 1 month:** Read the full package, compare the critiques, and test one extension in your domain
