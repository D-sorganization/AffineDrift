...
\fancyhead[RE]{\textit{Control of Moving Targets}}
\fancyhead[LO]{\textit{\nouppercase{\leftmark}}}
...
\begin{description}[leftmargin=1.5cm, labelwidth=1.2cm, font=\bfseries\color{chapblue}]
  ...
  \item[Ch.~8] \textbf{Phase-Variable Control.}
  ...
  \item[Ch.~9] \textbf{Stochastic Trajectories and Motor Variability.}
    Signal-dependent noise in biological actuators. The minimum-variance theory of
    human movement. Why optimal trajectories are smooth.
