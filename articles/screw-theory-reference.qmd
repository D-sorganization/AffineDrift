...
=
\bigl(J_s(q)^\top\bigr)^{+}\tau
=
\bigl(J_s(q)^\top\bigr)^{+} B u,
$$
...
- **[Lagrangian Reference](lagrangian-reference.html)** — Scalar energy approach to control-affine equations of motion
- **[Rotation Representations Reference](rotation-representations-reference.html)** — Euler angles, quaternions, axis-angle, and angular velocity in 3D
- **[Mathematical Notation Reference](../pages/notation.html)** — Normative symbols, twists, wrenches, and control-affine conventions
- **[Force and Mobility Ellipsoids](force-mobility-matrices.html)** — Geometric interpretation of directional strength and mobility using Jacobians
- **[The Null Space of the Constraint Jacobian](null-space-constraint-jacobian.html)** — Unconstrained motion and reciprocal wrench systems in closed chains
- **[Tangent Hyperplanes I: Geometry](tangent-hyperplanes-series/part-1-geometry.html)** — Lie group manifolds, tangent spaces, and local linearizations
:::
