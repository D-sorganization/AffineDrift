...
\begin{implication}
A minimal radar architecture --- one CW Doppler module for speed plus two angle-radar modules for
...
This is the strongest architectural signal in the market for a radar-first design's
roadmap.
\end{keypoint}
