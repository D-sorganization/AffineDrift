...
This is an opportunity for any implementer: the formalism is public-domain mathematics, distinct from the specific claimed pipelines in \cref{app:patents}.
...
Apply \cref{eq:screw-ls} to each sensor in a given architecture to see the ceiling precisely.
