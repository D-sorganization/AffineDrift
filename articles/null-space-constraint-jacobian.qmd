...
$$
    \text{Optimal swing} \approx \mathbf{f}(\mathbf{x}) + \text{control corrections}
$$

(The relative contribution of drift vs. control forces depends on task and skill level; see [citation]. Drift is a significant component of expert swing dynamics, but active control remains substantial — consistent with working estimates of roughly 15/85 Nm passive/active torque ratios.)
