...
- **[Screw Theory Reference](screw-theory-reference.html)** — Wrenches, twists, and reciprocal screw systems in constrained multibody chains
- **[Tangent Hyperplanes I: Geometry](tangent-hyperplanes-series/part-1-geometry.html)** — Tangent spaces as kernels of constraint gradients: the same null-space structure in geometric form
- **[Superposition in Affine Control Systems](superposition.html)** — The fixed-state linear force-to-acceleration map that the constraint Jacobian partitions
- **[Force and Mobility Ellipsoids](force-mobility-matrices.html)** — Mobility ellipsoids for the constrained motion directions
- **[Degrees of Freedom and the Curse of Dimensionality](degrees-of-freedom-and-dimensionality.html)** — How constraints and structure collapse effective dimensionality
