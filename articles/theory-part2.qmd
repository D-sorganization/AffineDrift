...
## Drift--input decomposition {#drift-vs-input-decomposition}
...
::: {.callout-note title="Key Properties"}
...
$$\tau_{\text{total}}(t) = \mathrm{ID}\big(q(t), \dot{q}(t), \ddot{q}(t), \eta(t), \dot{\eta}(t), \ddot{\eta}(t)\big),$$

where $\mathrm{ID}(\cdot)$ denotes the inverse dynamics operator for the coupled rigid--flexible model.
...
::: {.callout-important title="Scope and Limitations"}
...
::: {.callout-warning title="Interpretational Cautions"}
