...
| **Foresight** | Not stated for path; claims face-plane measurement generally | [What we measure](https://www.foresightsports.com/pages/what-we-measure) |
...
> **Horizontal Swing Plane:** The angle of the club's geometric center relative to the ground, measured at the lowest point of the swing.

Technology is marketed as "Fusion Tracking" --- radar combined with camera. Club path availability is gated by model and package tier.
...
That is a marketing claim, but it is a *technical* marketing claim and it is squarely at odds with FlightScope's published definition. Note the limit of what it establishes: Foresight says path is measured "in a horizontal plane relative to the target line" without naming the clubhead point, so it *implies* face-referencing without stating it.
...
### III.2 Instant of measurement

- **TrackMan:** at maximum compression (mid-contact), explicitly pre-impact for path and attack angle
- **Uneekor:** "at the time of impact"
- **Full Swing:** "prior to impact"
- **FlightScope:** "measured at impact"; face-to-path "at the moment of separation" on one page

Since the face continues to close by 1--2° during contact, first-contact and maximum-compression conventions differ systematically, and the difference is larger for faster-closing players.
