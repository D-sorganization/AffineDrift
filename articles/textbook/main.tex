...
\textit{J.\ Basic Engineering}, 82(1):35--45.

\bibitem{RawlingsMayne2009}
Rawlings, J.~B. and Mayne, D.~Q. (2009).
\textit{Model Predictive Control: Theory and Design}.
Nob Hill Publishing.

\bibitem{vanderSchaft2000}
van~der~Schaft, A.~J. (2000).
\textit{L$_2$-Gain and Passivity Techniques in Nonlinear Control} (2nd ed.).
Springer.
...
\bibitem{AndreuPraly2009}
Andrieu, V., Praly, L., and Astolfi, A. (2009).
High gain observers with updated gain and homogeneous correction terms.
\textit{Automatica}, 45(2):422--428.

\bibitem{PhamTabuadaSlotine2009}
Pham, Q.-C., Tabuada, P., and Slotine, J.-J.~E. (2009).
A contraction theory approach to stochastic incremental stability.
\textit{IEEE Trans.\ Automatic Control}, 54(4):816--820.
