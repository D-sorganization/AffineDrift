...
# and shrinks to 0.50 along u_2; the force ellipsoid is the reciprocal.
```
...
- **[Drift-Control Ratio](controllability-drift-ratio.html)** — How mobility ellipsoids quantify the battle between passive inertia and active control
...
- **[Intentional Constraint Collapse](intentional-constraint-collapse.html)** — The strategy of aligning the force ellipsoid's major axis with impact loads
- **The Effective Plant** — How geometry dictates the baseline mechanical impedance
- **[The Null Space of the Constraint Jacobian](null-space-constraint-jacobian.html)** — The mathematical home of internal forces in parallel mechanisms
- **[Superposition in Affine Control Systems](superposition.html)** — The fixed-state linear input map whose geometry the mobility ellipsoid describes
- **[Tangent Hyperplanes II: Dynamics](tangent-hyperplanes-series/part-2-dynamics.html)** — The linearized input map that mobility ellipsoids visualize at each state
