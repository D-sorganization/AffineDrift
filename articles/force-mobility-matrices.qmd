...
- directions in which little force can be produced or resisted
    (low constraint).
...
- **low force capability** in that same direction.
...
The ramp is a constraint surface, and its geometry dictates both the ease
