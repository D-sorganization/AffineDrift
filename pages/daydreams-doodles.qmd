    ...
    <article class="main-article">
      <div class="article-content">
        <aside class="status-banner status-banner--exploratory">
          <h3 class="status-banner__title">Physical Demonstrations</h3>
          <p class="status-banner__body">
            Curated computational and physical case studies highlighting passive dynamics, fluid-structure interaction, and emergent mechanics.
          </p>
        </aside>
