...
- [Passive Distributed Control](../articles/passive-distributed-control.html) — How passive mechanics can shape motion without active input
- [Drifter Manifesto](drifter-manifesto.html) — The control-affine framework for understanding passive dynamics
- [Collaborate](collaborate.html) — Submit ideas for exploratory topics
