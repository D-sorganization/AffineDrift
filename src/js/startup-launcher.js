...
(function () {
  ...
  function createSplashScreen() {
    ...
    // Use querySelector on the splash element itself so it works before insertion
    ...
    const summary = {
      'Navigation Start to DOM Ready':
        metrics.domContentLoaded != null
          ...
          : 'N/A',
      'Navigation Start to All Resources':
        metrics.resourcesLoaded != null
          ? (metrics.resourcesLoaded - metrics.navigationStart).toFixed(2) + 'ms'
          : 'N/A',
      'Time to Interactive':
        metrics.timeToInteractive != null ? metrics.timeToInteractive.toFixed(2) + 'ms' : 'N/A',
      ...
      'First Contentful Paint': metrics.firstContentfulPaint
        ...
        : 'N/A',
      'Splash Duration':
        metrics.splashHidden != null && metrics.splashShown != null
