...
(function () {
  ...
  function createSplashScreen() {
    ...
    // Find progress element within the splash container (it might not be in DOM yet)
  ...
  function hideSplash() {
    ...
    // Use performance.now() directly as it is relative to navigation start
  ...
  function logFinalMetrics() {
    ...
    const summary = {
      ...
      'Splash Duration':
        metrics.splashHidden && metrics.splashShown
