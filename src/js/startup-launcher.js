...
(function () {
  ...
  function createSplashScreen() {
    ...
    // Use querySelector on the splash element to ensure we get the reference
    // even if the splash screen hasn't been inserted into the DOM yet
  ...
  function logFinalMetrics() {
    ...
    const summary = {
      ...
      'First Contentful Paint': metrics.firstContentfulPaint
        ...
        : 'N/A',
      'Splash Duration': metrics.splashHidden
