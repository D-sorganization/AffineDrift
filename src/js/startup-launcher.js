...
(function () {
  ...
  function logFinalMetrics() {
    ...
    const summary = {
      'Navigation Start to DOM Ready': metrics.domContentLoaded != null ? metrics.domContentLoaded.toFixed(2) + 'ms' : 'N/A',
      'Navigation Start to All Resources': metrics.resourcesLoaded != null ? metrics.resourcesLoaded.toFixed(2) + 'ms' : 'N/A',
      'Time to Interactive': metrics.timeToInteractive.toFixed(2) + 'ms',
      'First Paint': metrics.firstPaint != null ? metrics.firstPaint.toFixed(2) + 'ms' : 'N/A',
      'First Contentful Paint': metrics.firstContentfulPaint != null ? metrics.firstContentfulPaint.toFixed(2) + 'ms' : 'N/A',
