...
(function () {
  ...
  function createSplashScreen() {
    ...
    // Use querySelector on the created element to ensure we find it
    // even if it hasn't been inserted into the DOM yet
  ...
  function logFinalMetrics() {
    ...
    const summary = {
      'Navigation Start to DOM Ready': metrics.domContentLoaded != null ? (metrics.domContentLoaded - metrics.navigationStart).toFixed(2) + 'ms' : 'N/A',
      'Navigation Start to All Resources': metrics.resourcesLoaded != null ? (metrics.resourcesLoaded - metrics.navigationStart).toFixed(2) + 'ms' : 'N/A',
      'Time to Interactive': metrics.timeToInteractive != null ? metrics.timeToInteractive.toFixed(2) + 'ms' : 'N/A',
      ...
      'Splash Duration': metrics.splashHidden != null ? (metrics.splashHidden - metrics.splashShown).toFixed(2) + 'ms' : 'N/A'
    };
