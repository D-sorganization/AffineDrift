...
(function () {
  ...
  function createSplashScreen() {
    ...
    // Use querySelector on the splash element itself since it might not be in DOM yet
  ...
  function logFinalMetrics() {
    ...
    const summary = {
      ...
      'Splash Duration': (metrics.splashHidden != null && metrics.splashShown != null) ? (metrics.splashHidden - metrics.splashShown).toFixed(2) + 'ms' : 'N/A'
    };
