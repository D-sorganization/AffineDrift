...
(function () {
  ...
  function createSplashScreen() {
    ...
    // Use querySelector on the splash element itself to ensure we find it
    // even if it hasn't been inserted into the DOM yet (e.g. async wait for body)
  ...
  function logFinalMetrics() {
    ...
    const summary = {
      ...
      'Navigation Start to All Resources': metrics.resourcesLoaded != null
        ...
        : 'N/A',
      'Time to Interactive': metrics.timeToInteractive != null
      ...
      'Splash Duration': (metrics.splashHidden != null && metrics.splashShown != null)
