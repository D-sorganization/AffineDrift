...
- [ ] Write critic's corner section
- [ ] Write layman's summary
...
- What existing articles to reference
- What level of rigor is expected
- What notation conventions to follow
-->
...
- [ ] Builds on (doesn't contradict) existing content
