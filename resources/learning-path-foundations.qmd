...
<section class="resources-section">
  <div class="container">
    <div class="page-section">
      <h2 class="section-heading">Foundations Learning Path</h2>
...
- **Grant Sanderson (3Blue1Brown)** Linear Algebra: A Geometric Intuition
  - Content: matrices as transformations, eigenvectors, and determinants
...
- **Paul, "Robot Manipulators"** Chapter 2 (link frames)
  - Alternative: Modern Robotics above is preferred
...
- **Strogatz, "Nonlinear Dynamics and Chaos"** Chapters 1–4
  ...
  - Strength: best book for intuition

- **MIT OpenCourseWare**: Differential Equations (optional video companion)
  - Lectures: linear systems, eigenvalues, and phase portraits
...
- **Russ Tedrake**, "Underactuated Robotics" Chapters 1–2 (free online)
  - Format: Online textbook (accessible)
  - Time: 4–5 hours reading + 3–4 hours problems
  - Focus: intuition before math
...
- **Åström & Murray**, "Feedback Systems" Chapters 1–6 (free online, Princeton Press)
  ...
  - Scope: basics through state space
...
Adjust the mix to how you learn best:
...
5. **Ask questions:** [Contact](../pages/contact.html) or [Collaborate](../pages/collaborate.html)
