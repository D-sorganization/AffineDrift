...
<section class="resources-section">
  <div class="ad-page-container">
    <div class="page-section">
      <h1 class="section-heading">Biomechanics & Motor Control Learning Path</h1>
...
- **AffineDrift Proximal-to-Distal Case Study**
  - Read [How a Golf Swing Carries Energy](../articles/proximal-distal-a-journey-through-the-swing.html) for the accessible system-boundary and interface-power narrative.
  - Inspect the [technical monograph](../articles/proximal_distal_energy_transfer/index.html) for governed multibody, counterfactual, identifiability, and uncertainty contracts.
  - Challenge one mechanism in the [interactive workbench](../articles/proximal-distal-model-workbench.html).
