    ...
    <div class="standard-page-layout">
      ...
      <main class="main-content-area">
        <div class="page-section">
          <h1 class="section-heading">Websites</h1>
      ...
      <div class="resource-card">
        ...
        <h2>Roy Featherstone's Website</h2>
      ...
      <div class="resource-card">
                <div class="resource-content">
        <h2>World Scientific Congress of Golf (WSCG) Presentations</h2>
        <p class="resource-description">
      ...
      <div class="resource-card">
                <div class="resource-content">
        <h2>Penn State Golf Biomechanics Course</h2>
        <p class="resource-description">
      ...
      <div class="resource-card">
                <div class="resource-content">
        <h2>Dave Tutelman Golf Website</h2>
        <p class="resource-description">
      ...
      <div class="resource-card">
                <div class="resource-content">
          <h2>Motion Research Group - Golf Biomechanics and Club Optimization</h2>
          <p class="resource-description">
      ...
      <div class="resource-card">
                <div class="resource-content">
          <h2>MIT Underactuated Robotics</h2>
          <p class="resource-description">
      ...
      <div class="resource-card">
                <div class="resource-content">
          <h2>Modern Robotics Course Wiki</h2>
          <p class="resource-description">
      ...
      <div class="resource-card">
                <div class="resource-content">
          <h2>Caltech MLS Wiki (Mathematical Introduction to Robotic Manipulation)</h2>
          <p class="resource-description">
      ...
      <div class="resource-card">
                <div class="resource-content">
          <h2>Visualizing Quaternions (Ben Eater)</h2>
          <p class="resource-description">
      ...
      <div class="resource-card">
                <div class="resource-content">
          <h2>International Society of Biomechanics (ISB)</h2>
          <p class="resource-description">
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function updateWebsitesHistory() {
    let history = [];
    try {
      const raw = localStorage.getItem('affinedrift_websites_history');
      if (raw) history = JSON.parse(raw);
      if (!Array.isArray(history)) history = [];
    } catch (e) {
      localStorage.removeItem('affinedrift_websites_history');
    }
    
    const currentPage = {
      title: document.title.replace(' - AffineDrift', '').replace('AffineDrift - ', ''),
      url: window.location.pathname.substring(window.location.pathname.lastIndexOf("/") + 1) || 'resources-websites.html'
    };
    ...
    if (history.length === 0) {
      websitesHistoryList.textContent = '';
      const li = document.createElement('li');
      li.className = 'history-empty';
      li.textContent = 'No recent websites yet';
      websitesHistoryList.appendChild(li);
      return;
    }
    ...
    websitesHistoryList.appendChild(fragment);
  }
