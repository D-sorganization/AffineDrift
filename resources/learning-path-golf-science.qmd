...
<section class="resources-section">
  <div class="ad-page-container">
    <div class="page-section">
      <h1 class="section-heading">Golf Science Learning Path</h1>
...
- Want to understand swing physics without deep mathematics (optional)
...
- **AffineDrift Proximal-to-Distal Study Library**
  - Begin with [How a Golf Swing Carries Energy](../articles/proximal-distal-a-journey-through-the-swing.html) for the visual explanation.
  - Use the [technical monograph](../articles/proximal_distal_energy_transfer/index.html) for the governed equations, counterfactuals, and evidence boundaries.
  - Run the [interactive workbench](../articles/proximal-distal-model-workbench.html) to compare declared model states and controls.
...
A: Basic physics (high school level) is fine for modules 1–2. Module 4 requires some calculus/control theory; the [Control Theory path](learning-path-control-theory.html) has lighter version if you want foundations.
