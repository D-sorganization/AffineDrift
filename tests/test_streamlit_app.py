...
def test_main_runs_entry_sequence() -> None:
    ...
    with (
        patch.object(streamlit_app, "_configure_page") as configure_page,
        patch.object(streamlit_app, "_initialize_session_state") as initialize_session_state,
        patch.object(streamlit_app, "_inject_custom_css") as inject_custom_css,
    ...
    inject_custom_css.assert_called_once_with()
