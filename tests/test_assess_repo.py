...
def test_assess_test_coverage():
    ...
    with patch("pathlib.Path.rglob") as mock_rglob:
        ...
        result = assess_repo.assess_test_coverage(Path("/tmp"))  # nosec B108  # noqa: S108
        # 2 files <= 5 => score 3
...
def test_assess_test_coverage_high():
    ...
    with patch("pathlib.Path.rglob") as mock_rglob:
        ...
        root = Path("/tmp")  # nosec B108  # noqa: S108
...
def test_assess_security():
    ...
    with patch("pathlib.Path.glob") as mock_glob:
        ...
        result = assess_repo.assess_security(Path("/tmp"))  # nosec B108  # noqa: S108
        # Base 7 + 2=  9
