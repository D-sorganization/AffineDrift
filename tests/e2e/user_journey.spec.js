...
test.describe("User Journey", () => {
  ...
  test("should allow a user to navigate from home to article and back to top", async ({
    page,
  }) => {
    ...
    const articleLink = page
      .locator(".home-sidebar a")
      .filter({ hasText: "Drifter Manifesto" })
      .first();
  ...
  test("should allow searching for a topic", async ({ page }) => {
    ...
    const hasCustomSearch = await page.evaluate(
