...
def verify_lightbox_focus():
    with sync_playwright() as p:
        ...
        page.evaluate("""
           ...
           lightbox.setAttribute('tabindex', '-1'); // This is critical
           ...
           window.triggerLightbox = function() {
             ...
             // The issue: lightbox.focus() failing.
             // Maybe because it's not visible yet?
             // But we set opacity and visibility.
             // Maybe display is none? (default for div is block, but class might set none)
             ...
             if (document.activeElement === lightbox) {
                 ...
                 console.log('Focus FAILED. Active is:', document.activeElement.className);
             }
           };
