...
def verify_lightbox_focus():
    with sync_playwright() as p:
        ...
        page.evaluate("""
           ...
           // Force styles.css overrides
           lightbox.style.cssText = 'position:fixed; top:0; left:0; width:100%; height:100%; z-index:2000; display:flex; opacity:0; visibility:hidden;';
           ...
           window.triggerLightbox = function() {
             ...
             console.log('Is visible?', lightbox.offsetWidth > 0);
