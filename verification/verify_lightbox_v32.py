...
def verify_lightbox_focus():
    with sync_playwright() as p:
        ...
        page.evaluate("""
           ...
           // If display:none, offsetParent is null.
           // If visibility:hidden, offsetParent is null? No, usually null.
           // If opacity:0, offsetParent is body (visible but transparent).

           lightbox.style.display = 'flex'; // Ensure block level
           lightbox.style.opacity = '0';    // Hidden but layout
           ...
           window.triggerLightbox = function() {
             ...
             console.log('Is visible?', lightbox.offsetParent !== null); // Should be true
