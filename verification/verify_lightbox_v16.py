...
def verify_lightbox_focus():
    with sync_playwright() as p:
        ...
        page.evaluate("""
           ...
           // Ensure it is technically visible for focus
           ...
           // Initially hidden? No, let's make it visible but transparent if needed?
           // No, standard is hidden.
           ...
           window.triggerLightbox = function() {
             ...
             // The browser needs a repaint to acknowledge visibility before focus?
             // Or maybe requestAnimationFrame?
             requestAnimationFrame(() => {
                 console.log('Focusing lightbox (raf)...');
                 lightbox.focus();
