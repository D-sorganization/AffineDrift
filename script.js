...
function initAriaLabels() {
  // ⚡ Bolt Optimization: Use live HTMLCollections instead of querySelectorAll for better performance
  ...
  // Single pass over all inputs to optimize search inputs and form elements
