"""Data models and constants for the Mypy Autofix Agent.

Defines the core data structures (MypyError, Fix, AgentReport) and the
constant lookup tables used across the autofix pipeline.
"""
...
KNOWN_UNTYPED_MODULES: frozenset[str] = frozenset(
    {
        "mujoco",
        "dm_control",
        "pinocchio",
...
COMMON_TYPE_IMPORTS: dict[str, str] = {
...
IMPORT_SUPPRESSIBLE: frozenset[str] = frozenset({"import-untyped", "import-not-found"})

# Error codes eligible for last-resort suppression
GENERIC_SUPPRESSIBLE: frozenset[str] = frozenset(
    {
        "assignment",
        "arg-type",
        "return-value",
