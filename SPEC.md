...
| Date       | PR    | Changes    |
| ---------- | ----- | ---------- |
| 2026-09-07 | #4227 | Correct the complete paired superposition chapter, replacing inconsistent mechanics and pendulum tables with independent verification and precise passivity, constraints, actuator and reachability conditions; rebuild Volume I. |
