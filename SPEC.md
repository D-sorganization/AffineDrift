...
| Date       | PR    | Changes    |
| ---------- | ----- | ---------- |
| 2026-09-08 | #4277 | Separate conservative Coriolis coupling from physical damping in the paired Physics of Golf chapter; make the state and energy mappings explicit and correct the two-joint inverse-mass example. |
