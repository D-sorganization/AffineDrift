...
|------|---------|---------|
| 2026-04-02 | 1.0.11 | perf(js): optimized DOM queries in `accessibility.js` by replacing `querySelectorAll` with live HTML collections (`getElementsByTagName`, `getElementsByClassName`) and merged input iteration |
