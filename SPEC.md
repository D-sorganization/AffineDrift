...
| 2026-04-14 | 1.0.27  | security(xss): Fixed DOM-based XSS vulnerability in `script.js` history list component by safely validating and sanitizing `href` properties                                                                                                                                                                                                                                                                                                                                                                                                                    |
