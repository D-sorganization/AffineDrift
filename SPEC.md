...
| 2026-05-29 | 1.0.113 | ux(palette): Added `title` attributes (native tooltips) to icon-only buttons (like navigation anchor links) and generic buttons (like save/clear in notes workspace) to provide explicitly visible hover contexts for sighted users. |
