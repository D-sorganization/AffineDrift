...
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-06-09 | 1.0.118 | refactor(dry): Removed the byte-identical copies of `double_pendulum_drift`, `double_pendulum_B`, and `generate_reference_trajectory` from `src/tools/rl_funnel_benchmark.py`; the benchmark module now re-exports the canonical implementations from `rl_funnel_dynamics` (public import surface preserved via `__all__`), and a regression test pins the symbols to the canonical objects so the duplication cannot return.                                                                                                                                                               |
