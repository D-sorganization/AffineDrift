...
| Date       | PR    | Changes    |
| ---------- | ----- | ---------- |
| 2026-09-12 | #4358 | Complete strokes-gained joint-intervention and dispersion qualifications; repair accessible table headers, expanded explanations and dark-theme reading; bind the completed route review to reproducible evidence. |
