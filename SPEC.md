...
| Numerical Profiling | `src/tools/utils/numerical_profiling.py` | Benchmark harness and memory profiling for DDP solver and ball flight simulation |
...
| F16 | Numerical Profiling Infrastructure | ✅ | `src/tools/utils/numerical_profiling.py` provides `run_numerical_benchmark` (timing + tracemalloc memory), `profile_memory` decorator, and `NumericalProfileResult` dataclass with structured log output for DDP solver and ball flight simulation benchmarking |
...
|------|---------|---------|
| 2026-04-02 | 1.0.11 | perf(profiling): Added numerical profiling infrastructure (`numerical_profiling.py`) with `run_numerical_benchmark` (tracemalloc + timeit), `profile_memory` decorator, and `NumericalProfileResult` dataclass; 27 TDD tests covering DDP solver and ball flight simulation benchmarks (issue #2075) |
