...
| ---------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-04-09 | 1.0.20  | perf(frontend): Optimized email copy link extraction in `js/forms.js` by replacing string array allocation (`.split("?")[0]`) with memory-efficient `indexOf` and `substring` methods                                                                                                                                                                                        |
