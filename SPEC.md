...
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-06-09 | 1.0.124 | chore(rust)+ci(DRY): Deleted the dead `rust/golf_physics` crate (a pyo3 duplicate of `src/golf_simulation`, never built, imported, or exercised — no maturin/setuptools-rust config, no Python consumer) and removed the never-firing `rust-quality-gate` job from `ci-standard.yml` whose change-detection required a non-existent repo-root `Cargo.toml`. CI no longer pretends to exercise Rust and there is one canonical Python physics implementation (issue #3231, Option A).                                                                                                        |
