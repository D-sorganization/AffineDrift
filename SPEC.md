...
| Date       | PR    | Changes    |
| ---------- | ----- | ---------- |
| 2026-09-07 | #4232 | Reconcile all paired Physics of Golf glossary definitions across mechanics, impact, anatomy, tissue and evidence; add collision derivation and verified sources, repair aliases and reading layout, and rebuild the textbook PDF. |
