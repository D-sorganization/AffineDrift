...
| ---------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-06-09 | 1.0.119 | fix(quality): Repaired the service-worker cache-busting hash sources in `scripts/update_sw_cache_version.py` (three of eight configured paths — `js/script.js`, `css/styles.css`, `css/base.css` — did not exist and were silently skipped, so edits to `styles.css` never invalidated client caches), made missing hash sources a loud `ValueError` per DbC with pytest coverage written test-first, and deleted confirmed-dead code: the unreferenced legacy `script.js` monolith (superseded by `js/` modules), the unreferenced `scripts/deploy_assets.py` (subset duplicate of `sync_frontend_assets.py`), and the tautological `tests/test_architecture_dbc.py`. |
