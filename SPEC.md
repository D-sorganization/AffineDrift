...
| F13 | PR site-build and dependency-audit gate | ✅     | `ci-standard.yml` audits Python dependencies with blocking `pip-audit`, measures coverage across the full `src/` tree, renders the Quarto site in PR CI, syncs frontend assets, and runs Playwright smoke tests against the generated docs                                                        |
...
| ---------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-04-11 | 1.0.33  | fix(security): added javascript: URI guard to legacy script.js history items to prevent XSS from localStorage, and cleaned up SPEC.md nested conflicts |
| 2026-04-11 | 1.0.32  | fix(physics): corrected d-plane weighting in short-iron models and clarified launch physics in ch31 |
| 2026-04-11 | 1.0.31  | fix(textbook): corrected Jacobi formula factor in Liouville proof and added proof-integrity verification tests |
