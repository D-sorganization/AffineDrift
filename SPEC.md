...
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-06-09 | 1.0.118 | test(dbc): Added adversarial Design-by-Contract precondition tests and property-based invariant tests for the `ILQRSolver.optimize` boundary — negative tests for non-callable dynamics, non-finite/mismatched/empty state and control inputs, and non-positive `dt`/`tol`/`max_iters`, plus Hypothesis invariants pinning output trajectory shapes, the uniform monotonic time grid, the `x_traj[0] == x0` postcondition, output finiteness, and the bounded iteration count.                                                                                                              |
