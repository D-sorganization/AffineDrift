...
3.  **Collapse of the "Frozen Strategy" Defense**: The defense argues that $u=0$ leaves the "Effective Plant" intact. But the _math_ says $u=0$ leaves _only_ gravity and shaft elasticity. The math actively contradicts the defense.
