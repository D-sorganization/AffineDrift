...
- **Featherstone, R. (2008).** _Rigid Body Dynamics Algorithms_. (Closed-loop constraints and indeterminate forces).
- **Yamaguchi, G. T. (2001).** _Dynamic Modeling of Musculoskeletal Motion_. (Indeterminacy in muscle recruitment and closed chains).
