...
- Latest publication: nonlinearity PR #4246 protected-squash-merged as e56a4b3bb7a97230bcafb99d0d559f1f614349a4 after all current checks passed. Deployment34142203580 completed successfully. Closed #4242 needs no lease renewal.
- Machine learning #4244: both complete editions corrected, all topics/16 exercises preserved, shared executable backpropagation added and Volume0 PDF292 pages rebuilt. Full run4331 passes plus one bibliography-field parser failure; URL formatting corrected and all29 focused reference/learning tests pass. Coverage92.41%; static34/content128 (four skips), mypy75 and Python quality pass. All111 section views,28 equation edges,57 final targets,six explicit code-left views,19 chapter pages,three bibliography pages and corrected contents page inspected. Dark bibliography and TOC number-spacing defects fixed. See machine-learning-review.md for derivations, exact source-reading limits and failures. No PPO or human training evidence claimed. Ready PR #4247 on fix/4244-machine-learning-rigor; corrected Python3.12 type alias passes all push hooks. CI34145727144 failed only the missing figure alt attribute in its every-route check; explicit fig-alt added and the identical local verifier passes four light/dark desktop/mobile evidence items after deployment polyfill cleanup. All Python checks and eight textbook builds passed remotely. Protected merge/deployment pending; renewed claim through19:24:41UTC. Do not commit/push while tests/renders run. Full405-source corpus remains open.
...
- Active #4242: complete original9,578-word nonlinearity article rewritten on fix/4242-nonlinearity-rigor, based a4cdbdbf. Final8,250words/53headings; all72 legacy targets resolve. Full4306 tests pass,29skips,129deselections,59warnings,200.21s,coverage92.36%. Final eight focused tests pass after extracting the declared gravity constant. Static34,content128/four skips,Ruff,Black636,mypy74 and targeted Python quality pass. All159 section views,22 actual equation right edges,table right/tail and nine code views inspected. Final named-constant code views checked; first desktop position was shifted by lazy math, so the corrected initialized/repositioned capture has been visually verified. No print artifact. Ready PR #4246 contains the complete correction at3b03d5d3, rebased before its first push onto protected main419f9496 with an identical content tree. Protected merge/deployment remain pending; no jobs may run during commit/push. Claim through16:31:38UTC. See REVIEW.md and nonlinearity-review.md for full derivations, failure details and primary-source limits.
- Next #4244: complete9,456-word Volume0 machine-learning print chapter and1,100-word web edition have now been read, including figure, code and all16 exercises. Issue4244 records confirmed mechanics/objective, Bellman/gradient/PPO, learned-physics/adjoint, identifiability and code errors; checked free and leased through17:23:33UTC for codex/technical-review-20260906. Canonical sources remain unchanged; temporary machine-learning-review.md is for the next wave, not this PR. Preserve full paired scope despite different edition lengths. The405-source corpus remains unfinished.
