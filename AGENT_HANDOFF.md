...
- Active #4248: complete paired degrees-of-freedom/URDF chapter corrected on fix/4248-dof-urdf-rigor. Reconciled mobility/closure, elbow geometry, velocity versus torque null spaces, constrained actuation, anthropometry, URDF/importer semantics, sensitivity and identification. Shared independently tested2R model and downloadable XML added; all seven exercises retained. Full suite4,361 passes plus one stale figure-count expectation; corrected expectation and all53 focused tests pass, coverage92.47%. Static34/content128 with four skips, mypy76, Ruff/Black and isolated push mypy pass. All168 section views, eight actual equation edges,54 final targets and20 chapter PDF pages inspected; final code/wording, five bibliography pages and contents checked. Contents number spacing fixed; final566-page PDF retained. All67 live anchors,21 LaTeX labels and22 index terms retained. Four-view deployment verifier passes with zero serious/critical axe violations. See dof-urdf-review.md for exact derivations, source-reading limits and failures. No complete human model, Drake execution or human-control strategy is claimed. Claim expires19:11:39UTC. Ready PR #4249; all push hooks passed and the commit was rebased onto protected main0f711115 with identical tree b8b7b6b5. Protected checks/merge/deployment pending; no jobs may run during commit/push.
- Latest protected publication: machine-learning PR #4247 merged as0f71111543bc907cfd749a60732a8db6abc90f3c after the missing figure-alt repair and all checks passed. Deployment34149681983 completed successfully through build, verification and publication. Detailed ML evidence and prior CI failure are preserved in machine-learning-review.md and REVIEW.md. Closed #4244 needs no lease renewal.
