...
- Issue #4187 on fix/manifesto-rigid-flexible-foundations: canonical first article and paired foundational sections corrected. Local 3,949 tests/29 skips, 13 independent/source checks, 25 combined checks, 128 content/four skips, 34 static contracts (with merged validator repair), 348-source scan; three web routes, 24/24/25 revised displays, 198/509/597 math containers, zero errors/no 1440/390 overflow, nine screenshots inspected. Commit/PR pending. Parent is old case dd513dd8: rebase only this correction onto merged #4188 before publication. Case #4188 final4e9185b4 is in CI; learning #4186 merged e611e3ad, deploy33988300905 pending; stochastic live. #4189 is claimed after full Theory Part 4 read; appendix edits have not started. Corpus remains open.
