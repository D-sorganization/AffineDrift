...
- User-directed epic #4009 governs this review. Full-corpus #4021 and route batches #4054–#4061 remain open; the 405-source inventory does not certify every claim. Preserve the immutable upstream monograph boundary.
- Nineteen correction batches through PR #4196 are published. Full scope, individual merge revisions, primary reading, numerical checks and print/web inspection history are recorded in docs/development/technical-review/REVIEW.md. Review scope by source is in corpus-review-index.csv. Earlier partial checks do not clear entire routes.
- Tangent foundations #4196 merged as 04e3826179d0d5c7e93c888660859b53cce3cf0c; deployment33996201945 succeeded. Control/cases PR #4199 merged fe332df65278ddd7284b8f0a76a6cab2ba8f6c93 after every final-head check passed; deployment33997700775 is pending; local 4,029 tests, 23 new checks, 69 combined post-rebase checks. Together they complete the unified tangent reference's substantive review.
- Issue #4197 on fix/impact-contact-and-closure-rigor corrects the long impact reference outside Part V and fully reviews rotation-induced-spin/reference-point-problem. Local 4,048 full-suite passes, 29 skips, 92.32% coverage, plus all 24 final focused checks (five added after full-suite collection); 34 static contracts, 128 content/four skips, 348-source scan. Published coupled calculation separately reproduced. Three rendered routes, 73 displays, 296/80/52 math containers, zero math errors/no 1440/390 page overflow; initial 30 and affected final views inspected. PR #4201 is open from rebased content a3337f71 on control merge fe332df6. All 89 combined contact/control/validator checks pass after rebase; final CI/publication pending.
- Issue #4198 remains claimed and open for the aerodynamic/evidence section, which is fully read but not corrected in #4197. Primary verification includes Naruo's full original paper, Lyu 2018/2020, Choi 2006, McNally 2023 and the June 17, 2026 ODS notice. Temporary QA artifacts are not publication authority.
