...
- Active wrist #4299 / PR #4304 on `fix/4299-wrist-constraint-mechanics`; all local review/checks complete. Root4850/29 skips (src coverage92.98%), content130, JavaScript351, static34, title631, Ruff/Black/mypy and critical10 pass. All14 PDF pages,143 web captures and4 Qt views inspected. See `docs/development/technical-review/wrist-review.md`. Replayed onto a37f5cae as be5612c6; range-diff confirms the identical wrist patch. All push hooks pass, including isolated mypy after installing missing optional UI dependencies. Ready PR #4304 is open. CI found three HTML-validity defects; native landmarks and iframe CSS now pass local HTML lint, tracked CSS62 and fresh browser/axe checks. Updated protected checks and publication remain. PoE4300 published f07bf036 (deployment34292478895/artifact10082702228 pass956/239). Biology4296 published via d7e51655 (artifact10081509020). Next long chapter #4303 has both complete editions read and an issue under epic4009, and has a codex lease through 2026-09-09T03:42:54UTC; no edits yet. Corpus405 remains unfinished. Never mutate checkout during local tests/build/QA.
