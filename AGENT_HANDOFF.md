...
- Computational-brain #4303 is on `fix/4303-computational-brain-review`, replayed as 52f80227 onto protected main 19170f82. Both editions, fourteen worked exercises, two paired figures and the rebuilt 550-page PDF are reviewed. Replay root suite: 4,900 passed, 29 skipped; affected checks 64, static contracts 34 and the new cross-article link gate pass. Earlier full presentation review covers 17 chapter PDF pages, contents/bibliography, 14 responsive/theme cases and 113 math expressions. See `docs/development/technical-review/brain-review.md` for derivations and evidence limits. Ready PR #4306 is open; protected checks and publication remain. The old pushed `fix/4303-computational-brain` branch is a saved checkpoint; do not replay its wrist ancestors.
...
- Corpus 405 remains unfinished: 224 sources have only an index, with additional partially reviewed sources. The next long chapter is swing plane/launch: both original editions and eight exercises are read; geometry, collision, optimization and variance errors are identified. Preaudit notes are local and no new chapter edits are made yet. Brain lease renewed through 2026-09-09T08:55UTC. Never switch, commit or push during local tests/build/QA.
