...
- Active computational-brain #4303: `fix/4303-computational-brain`, based on wrist head bcc0b6dc. Both complete editions,14 exercises and independent derivations are corrected; two paired figures and rebuilt550-page PDF are inspected. Root4867/29 skips, src92.98%, content130, affected64, static34, title631, Ruff/Black/mypy pass. Final responsive14 and113 math expressions pass; chapter-only contrast/math-size fixes are visually checked. Source boundaries and all14 worked answers are in `docs/development/technical-review/brain-review.md`. No PR yet; save/push this checkpoint before repairing wrist, then return here and replay only commits after bcc0b6dc onto protected main after wrist merges.
- Wrist #4299 / PR #4304 is open with protected auto-merge enabled. CI34302378496 passed numerical/unit/browser suites but its all-route verifier failed two newly published standalone companions for missing canonical links, navigation and theme support (artifact10085985439). Repair those pages on `fix/4299-wrist-constraint-mechanics`; preserve the verifier contract. Full derivations and earlier validations remain in `wrist-review.md`. Both codex leases run through2026-09-09T05:42UTC. PoE4300 is published at f07bf036 (artifact10082702228 passes956/239); biology4296 via d7e51655 (artifact10081509020). Corpus405 remains unfinished:224 entries still have only an index, with additional partially reviewed sources. Never switch/commit/push during local tests/build/QA.
