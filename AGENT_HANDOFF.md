...
- Next: check inbox, refresh claim evidence, commit explicit canonical paths, replay only #4338 commits after 06c7742b741e9a79d2856c9b8de51e98e73f9716 onto passive squash a1ef3f22 or a checked descendant, compare the resulting tree, then normal push/PR/auto-merge and exact live verification. Never replay passive commits. Follow with a separate complete companion-critique scope, then longest pending fascia/triple-pendulum/brain chapters. Corpus remains unfinished (205 indexed rows plus partial reviews).
