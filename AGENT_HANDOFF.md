...
- Active #4347 under #4009/#4021/#4054, branch `fix/4347-brain-control-rigor`, worktree `C:/Users/diete/Repositories/AffineDrift-technical-review`. Parent HEAD 1cc701de1b44c581634b860dddcc0d349c77c31a; implementation SELF; PR not created. Complete paired brain chapter rewrite is ready. Audit `docs/development/technical-review/brain-control-review.md` records every technical decision, mathematical example, primary-source reading limit and failure history. Ten worked answers, shared vector figure and final 544-page PDF; all 14 chapter pages, relevant bibliography and 27 full web captures read.
...
- Next: commit explicit canonical files with normal hooks, fetch parent squash 8808f68ab8b7e39c5110ce260473d02dbff63c45, verify its tree equals old parent 1cc701de, replay only new commits onto it preserving the validated tree, then normal push and focused PR closing #4347. Use protected squash auto-merge and verify live artifacts. Update the single SPEC row from issue to PR. All QA sessions reaped; idle preview 8767 remains. Six identified render-only generated files restored byte-for-byte; never stage scratch files en masse.
