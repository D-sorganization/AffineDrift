...
- Foundations #4280 / ready PR #4284 awaits protected auto-squash. Complete paired chapter, preface,15 exercises and numerical helper validated; derivations and full print/web/coverage evidence are in docs/development/technical-review/gom-foundations-review.md. CI found one missing dependency in the symbolic derivation test (4671 other tests passed): requirements now pins the locally validated SymPy1.14.0. Recheck the focused test and push this dependency repair without bypasses. Lease expires13:41:46UTC. Spine #4283 has a separate uncommitted scratch draft and saved documentation stash; resume after this repair and replay only spine changes onto the eventual protected squash. No commit/push during QA. Corpus unfinished.
