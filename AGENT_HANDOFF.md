...
- Active #4288 on fix/4288-rotation-conventions-rigor (base 5f9008e6): paired rotation chapter, quaternion program and 18 exercises corrected; final print/web QA complete. Focused 127 and root 4,828 pass; coverage 79.04%; all 14 responsive cases pass. See docs/development/technical-review/rotations-review.md for complete evidence and failed attempts. Claim expires 18:34:23 UTC. Replay only rotation commits after 5f9008e6 onto protected main before first push; then verify protected CI and exact deployment. No commit/push/switch during QA; corpus unfinished.
