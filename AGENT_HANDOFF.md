...
- Corpus 405 remains unfinished: 221 sources still have only an index, with additional partially reviewed sources. Launch-monitor #4309 is a native child of #4009, leased through 2026-09-09T16:53:26Z. Its complete source and approximately 7,100-word rewrite, two reproducible figures and 24 focused checks are complete locally. Root 4,949 passes, 29 skips, 92.65% coverage; content 130, static 34, title 633, style, type and site-link checks pass. Rendered review verifies 128 mathematical expressions, 34 displays, 20 historical destinations, 14 responsive/theme cases and keyboard access. Clipped transpose glyphs, SVG font substitution and cramped table wrapping are corrected. Ready PR #4312 is pushed after all hooks pass. Reviewed checkpoint 70f0d252 was replayed alone onto published main 6b6876c0 as 382daa9e with an identical complete tree. Protected CI/review, merge and production verification remain. See docs/development/technical-review/launch-monitors-review.md. Never switch, commit or push during local tests/build/QA. Do not mark the corpus epic complete.
