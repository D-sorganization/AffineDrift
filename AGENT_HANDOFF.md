...
- Active #4353 under #4009/#4021/#4054, branch `fix/4353-double-pendulum-rigor`, worktree `C:/Users/diete/Repositories/AffineDrift-technical-review`. Checkpoint SELF. Complete paired Chapter 3 rewrite corrects inertia, gravity signs, Coriolis rate factors, physical power, endpoint curvature and chaos/coaching inference. Audit `docs/development/technical-review/double-pendulum-review.md` records derivations, numerical evidence and exact source-reading limits; six worked answers and a shared computed geometry figure are included.
...
- Next: restore six proven render-only files, explicitly stage canonical files and commit. PR #4352 has merged; prove parent/squash tree equality and replay this implementation onto b5362af0005c8ae1ad00e81390e9151991157155 before first push. Open protected PR fixing #4353, update its single SPEC row and delivery evidence. Never stage the thousands of scratch files. Central development-log checker retains pre-existing peer #3903/#3902 metadata gaps; preserve peer entries.
