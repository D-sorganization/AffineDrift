...
- Active #4326, native child of #4009 / corpus #4021 / Physics #4054: branch `fix/4326-motor-learning-rigor`, worktree C:/Users/diete/Repositories/AffineDrift-technical-review, stack base aa8ae5b30a5f46ff3aae228cd7ff3ac727ab5e75; PR not created. Both original motor-learning editions (688 LaTeX / 636 Quarto lines) and twelve exercises read completely. Findings and verification plan are in docs/development/technical-review/motor-learning-review.md. No corrected content or validation yet. DL-#4326 is refreshed. Lease expires 2026-09-10T01:06:56Z, central presence renewal pending. Next: verify primary studies, then derive and test error/learning/covariance examples before paired correction. Motion PR #4325 is merged as4cf3514d. Repair PR #4329 has normal squash auto-merge enabled; replay only commits after aa8ae5b3 onto its squash before first push. Preserve peer impact/joint-friction work and immutable publication; no Git mutation during QA.

- Active publication repair #4327, epic #4009 / corpus #4021: branch `fix/4327-nonlinear-callouts`, worktree C:/Users/diete/Repositories/AffineDrift-technical-review, implementation 1dec5dd8fe602d17a7aeeb7c48b13559eb6e40be; documentation checkpoint SELF; PR https://github.com/D-sorganization/AffineDrift/pull/4329 open; base motion squash4cf3514d. Rotation deployment 34413839463 failed one of 956 cases: nonlinear-control-insights mobile light, three inaccessible raw-markup code blocks. Exact artifact 10128793137 and local reproduction are documented in docs/development/technical-review/nonlinear-callouts-review.md. Both explanation panels are now native details/summary disclosures with qualified mechanics and an eight-line scoped CSS file; the rest of the article still needs full technical review. Render, root5,097/29skips/79.19%coverage, final content130/static34, scoped Stylelint, link gate and12expanded keyboard/theme cases pass. All20detail images are inspected; all original IDs survive. Canonical14-case deployment-cleaned verification passes without failures. DL-#4327 refreshed. Lease through 2026-09-10T01:14:09Z, presence through 01:29:51Z (renewed to cover CSS). Normal hooks pass. Only implementation a15358ef was replayed after1693a3f3 onto4cf3514d before first push; parent trees were identical. Normal squash auto-merge is enabled. Next: verify protected checks/exact publication. No Git mutation during tests/render/QA. Motor-learning #4326 has resumed from audit commit fb417372; both original editions and all twelve exercises were read, primary verification has started. Original checkout, peer impact work, immutable publication and scratch are preserved.

- Active #4324, epic #4009 / corpus #4021: complete motion-capture correction on `fix/4324-motion-capture-rigor`, worktree C:/Users/diete/Repositories/AffineDrift-technical-review, implementation b1a4a030a03044158aea1af747782d53d913c02a; documentation checkpoint SELF; PR https://github.com/D-sorganization/AffineDrift/pull/4325 merged as4cf3514dc82a6c267f43df39a89b57247cc0ba27; exact production pending. Parent squash 625b0fc4ff1135eaef3bf81b0852089f4129c1f1. Complete source review and bounded primary evidence are in docs/development/technical-review/motion-capture-review.md. Root 5,097 passes, 29 skips, 79.19% coverage; final focused 19, content 130, static 34, titles 636, Ruff/Black 687, strict mypy 91 and link/quality gates pass. Complete article visual reading, 70 math expressions, 26 preserved destinations, 14 width/theme cases, keyboard tables, 12 equation and 36 table detail images pass bounded QA. Native Quarto callout fixes invisible expanded explanation. Axe has zero serious/critical findings; preexisting minor/moderate findings and harness failures are recorded. Canonical article, tests, review/index, handoff and devlog are the only staged scope; scratch stays untracked. DL-#4324 is refreshed. Lease through 2026-09-10T00:01:08Z; presence through 00:05:45Z; inbox has no messages/conflicts and an unrelated identity warning. Normal commit/push hooks pass; implementation 6c004373 was replayed alone onto 625b0fc4 before first push, preserving the peer CSS formatting-only change. Normal squash auto-merge is enabled. Next: verify protected checks/publication. Rotation #4323 merged; its exact production verification remains. Preserve all original heading destinations, ADR 0001 boundaries, peer changes and immutable publication. No Git mutation during tests/build/QA.

- Active correction #4322, native child of #4009 / corpus #4021: branch `fix/4322-rotation-converter-reference`, worktree C:/Users/diete/Repositories/AffineDrift-technical-review, implementation 12169b9b8d0a36138d5b27bbdd493a58314d34ea, PR https://github.com/D-sorganization/AffineDrift/pull/4323 merged as 625b0fc4ff1135eaef3bf81b0852089f4129c1f1; documentation checkpoint SELF. Complete converter/reference review corrects SO(3) singularities, conventions, validation and physical interpretation, with shared Python implementation and separated browser engine/UI/viz. Root 5,078 passes, 29 skips, 79.19% coverage; final Python 18, full Jest 395 before two additional fallback tests (final UI 12), content 130, static 34, Ruff/Black 686, strict mypy 91, tracked quality and canonical link gate pass. Complete HTML review covers 178 math expressions, 37 displays, 23 historical destinations, 28 width/theme cases, 22 table/code and 36 math keyboard-scroll cases. Both themes have zero serious/critical axe findings; optional-3D failure preserves numerical results. Published Python code matches source and passes 13 assertions. Detailed evidence, failed attempts and source boundaries are in docs/development/technical-review/rotation-converter-review.md. No PDF changes. Implementation 1b52b0fa was replayed alone after f0a5b6c2 onto energy squash 4aea9755 before first push; parent trees were identical, all normal hooks pass. Next: repair deployment failure via #4327, then verify exact production evidence. Lease expires 2026-09-09T22:51:27Z. Central presence registered successfully through 23:49:18Z (comment 5609216406); inbox has no messages but reports an unrelated rejected-identity warning, recorded in the review. Immutable publication, original checkout, peer changes and untracked scratch are preserved; no subagents or Git mutation during QA.
