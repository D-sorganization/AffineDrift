...
- User-directed epic #4009 governs the review. Full-corpus #4021 and route batches #4054–#4061 remain open; the 405-source inventory does not certify every claim. Preserve the immutable upstream monograph boundary.
- Twenty correction batches through #4199 are published. Full scope, primary reading, numerical checks and print/web history are in docs/development/technical-review/REVIEW.md; source review scope is in corpus-review-index.csv.
- Contact/closure #4201 merged fb3df92f54940f0f19b20d5f34775f67d92a232b at 23:40 UTC; deployment33999279815 remains pending. Final CI passed; 24 focused checks and 89 post-rebase checks passed. Three routes were visually verified.
- Aerodynamic #4198 on fix/impact-aerodynamics-and-evidence completes the long impact reference. Local 4,075 tests/29 skips/92.32% coverage, 22 new checks, 34 static contracts, 128 content/four skips and 348-source scan pass. Published flight independently reproduced; original figure and all 21 final browser views inspected; 63 display equations, 254 math containers, zero math errors/no 1440/390 page overflow. PR #4203 is open from rebased content8473e5b6 on contact mergefb3df92f. All 88 combined aerodynamic/contact/validator checks pass after rebase; final CI and publication pending.
- Energy-transfer article and bibliography fully read; issue #4202 claimed for mechanical ledgers, coordinate conventions, empirical sequencing and bibliography corrections. Primary reading is in progress. No claim of completion for that route or the remaining corpus.
