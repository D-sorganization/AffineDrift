...
- Active #4294 / PR #4296 on `fix/4294-biology-nonlinear-dynamics`. Paired biology chapters, preface, bibliography and book reading page are corrected; full 72-page volume rebuilt. Root 4796/29 skips, coverage 79.04%, content 130/4 skips, static 34 and mypy 86 pass. All 21 affected PDF pages and 30 browser scroll captures inspected. Final 14 responsive cases and both serious/critical axe gates pass; 54 theme tests pass. Protected delivery pending. Full derivations and failed attempts: `docs/development/technical-review/biology-review.md`. No checkout mutation during tests or QA.
