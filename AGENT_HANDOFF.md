...
- Issue #4169 records the full configuration-manifold chapter findings: joint topology, coordinate singularities, force covectors, geodesics, energy, attitude frames, and unsupported golf inference. It is claimed by codex for the next correction.
