...
- **Null-space evidence boundary:** SELF adds the existing readable-math stylesheet and leaves the two short explanatory callouts expanded. The shared collapsible header failed Enter activation despite correct role/tabindex; global repair is tracked in epic child4374. Current browser56238 passes209 expressions/46 displays,14 width/theme cases,184 regions and46 keyboard scroll checks. Supplemental review verifies eight visible callouts, four keyboard-scrollable tables and eight bibliography width/theme cases; only existing moderate landmark-unique findings remain. All29 initial reading images and six light bibliography images were read; the29 latest full-reading images and six dark bibliography images still need visual inspection. Production-route verification, durable evidence binding and inventory reconciliation remain outstanding. Do not mark either route fully reviewed yet.
