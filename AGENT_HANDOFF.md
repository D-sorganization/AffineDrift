...
- Multibody #4222: complete article rewritten with Cartesian, body-power, constraint, spatial, task and coordinate derivations. Branch fix/multibody-v3-rigor in AffineDrift-technical-review; protected PR pending. Full suite 4,248 passed; 16 new mechanics cases; 22 final focused cases including deployment links; content 128/four skips; configured mypy 74. All 105 section views and 12 final targeted views inspected. The article and new CSS/tests plus REVIEW.md, findings note, inventory and SPEC belong to this wave. Claim expires 09:41 UTC. Final 34 static checks pass; protected publication remains pending. Both repaired hybrid links were followed successfully in the browser.
- Next longest chapter: ch03_superposition.tex was fully read; paired QMD read through line 560 so far, with no edits or claim yet. Findings include mismatched Christoffel units, body-frame transport omission, wrong QMD Coriolis signs/factors, inconsistent pendulum tables, contact reaction dependence, actuator-affinity conflation and unsupported passivity/contraction claims. Finish both-source review, register/claim the issue, derive and verify before correction. Keep full corpus and final whole-book consistency work open.
