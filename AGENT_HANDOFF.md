...
- Active #4288 / PR #4289 on fix/4288-rotation-conventions-rigor, rebased onto protected main 10d4e7cb. Content commit b2496cf9 has exactly the locally validated tree (pre-rebase fe7bcf2c). Paired rotations, included program and 18 exercises corrected; print/web QA complete, focused 127 and root 4,828 pass, coverage 79.04%, all 14 responsive cases pass. Verify protected CI, merge and exact deployment; full evidence in docs/development/technical-review/rotations-review.md. Claim renewal recorded on issue. No commit/push/switch during QA; corpus unfinished.
