...
- Twenty-one correction batches through contact/closure #4201 are published; deployment33999279815 succeeded. Scope, primary reading and numerical/print/web evidence are recorded in docs/development/technical-review/REVIEW.md and corpus-review-index.csv.
- Aerodynamic #4203 merged 13ebbfcbe9039038e3caea1c4a2dba7f70cd5b4d at 00:23 UTC on 6 September. Deployment34001155414 is pending. All final CI passed; the long impact reference is substantively reviewed across #4197/#4198.
- Energy-transfer #4202 on fix/energy-transfer-ledgers-and-evidence is corrected locally: complete inertial and segment-power equations, independently checked acceleration/energy counterexamples, observer/reference distinctions, primary study interpretation, pinned work-error metric and bibliography. Full 4,095 tests/29 skips/92.32% coverage, 20 new checks, 37 combined article checks, 34 static contracts, 128 content/four skips and 348-source scan pass. Web: 31 displays/196 math containers, no math errors or 1440/390 page overflow; 27 views and three refined table views inspected. PR #4205 is open from rebased content b57e25242c6f39367e4b37225f05ac45ca89d0ae on aerodynamic merge13ebbfcbe9039038e3caea1c4a2dba7f70cd5b4d. All 79 combined energy/article/validator checks pass after rebase; final CI and publication are pending.
- The complete Volume 0 linear-algebra print chapter and its web edition were read; #4204 is claimed for eigen/SVD, stability, basis/Jacobian, metric/duality, conditioning and physical-interpretation corrections. Findings and planned independent examples are in the untracked QA linear-algebra-findings.md; no correction is yet certified.
