...
- Duality #4236: both complete ch06_duality editions (9,763/9,458 original words; compiled Chapter7) are corrected. Riccati identities, value/norm rates, finite horizons, geometry, robustness, disturbance attenuation, filtering and golf evidence are reconciled. Print/web numerical authority is shared and independently checked. Initial full run timed out at60s in an existing DDP benchmark; the full retry with CI's120s limit passes4291 tests,29 skips,129 deselections,59 warnings in287.52s,coverage92.36%. Focused9,static34,content128/four skips,Ruff,Black,mypy74 and targeted custom quality checks pass. All13 print pages and114 section web views plus targeted edges are inspected; see REVIEW.md. PR #4237 is open with protected auto-squash enabled. The planned rebase was blocked by a normalization-only handoff status and the push still ran; a normal merge of protected main then preserved the exact reviewed tree. Current synchronization merge is c13c715e3da2f119b63274c85481e9f4b9fa5381. Do not force-push; see REVIEW.md for the complete sequence. Claim expires14:06UTC.
- Next long source is Physics ch30_kinetic_chain: both complete editions are now read, including all exercises (9,580/8,767 original words). Issue #4238 records six finding groups under Physics route batch #4054. The claim was checked free and posted for codex/session technical-review-20260906 through15:10:37UTC. Canonical correction is pending; no kinetic-chain content is included in PR #4237. All405 sources remain in scope; no full-corpus completion is claimed.
