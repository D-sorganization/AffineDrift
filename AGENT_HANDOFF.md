...
- **Active chapter review:** #4369 on `fix/4369-muscle-torque-rigor`, checkpoint SELF, saved rewrite655b6514; this merge integrates published-main source93bbfd29. Both complete sources are rewritten with work-conjugate signs, feasible forces, power, stiffness, contact and inference treatment; all11 exercises have answers. Nine independent mechanics tests pass. Initial16-page isolated PDF fully read; final changed PDF pages and web captures11-28 still require visual review; captures00-10 were inspected and confirm undersized figure labels. The complete revised web source was reread. Full book535 pages compiles; changed chapter is print Chapter13, zero-based pages178-192. Automated web checks:163 expressions,16 displays,14 width/theme cases,68 regions,24 keyboard scrolls; no serious/critical axe issues. See `docs/development/technical-review/muscle-torque-review.md` for exact boundaries. Validation: full root5318 passed/29 skipped/132 deselected, coverage79.35%;32 focused tests and configured mypy91 pass. The initial root failure was a stale figure-count expectation; its repair also checks Chapter16 parity and both shared assets. Next: enlarge figure labels, clarify the whole-body speed-coordinate contact Jacobian, then complete final visual/production QA before a regular PR.
