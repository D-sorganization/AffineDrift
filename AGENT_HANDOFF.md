...
- Issue #4189 on fix/modal-appendices-and-pendulum-models: canonical Part 4 and both long-edition appendices corrected. Local 3,964 tests/29 skips/92.32% coverage, 15 independent/source checks, 128 content/four skips, 34 static contracts with merged validator, 348-source scan. Three web routes with 28 scoped displays each, 136/524/542 math containers, no errors or 1440/390 overflow; nine final screenshots and three figure views inspected. Rebased onto merged foundations #4191 (e4977cd7); PR next. Case deployment33990065773 succeeded; foundations deployment is pending. Counterfactual/invariance #4190 is claimed, sources read, edits next; corpus remains open.
