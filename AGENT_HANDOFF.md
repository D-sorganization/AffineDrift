...
- Applications #4218 is fully corrected in both editions. PR #4221 protected-squash-merged as 21c7d89b9d5e30583b8ae6b48535aee100a0b457; deployment 34095687458 remains in progress. All protected checks passed. The rigid adapter and v2 fixture retain corrected-model checkpoint 9a809cbe947d4d80be39bf31b6feaa59b53192f1. Preserve the historical v1 fixture. The subsequent hybrid full suite passes all 4,232 tests.
...
- Hybrid #4220: all three complete source editions rewritten and verified. Branch fix/hybrid-tangent-rigor in AffineDrift-technical-review; PR #4223 is open with protected auto-squash merge enabled; publication pending. Full suite 4,232 passed, content 128 passed/four skips, static 34 and configured mypy 74 pass. All 213 section views and 27 final targeted views inspected; raw equation labels and dark bibliography background corrected. See REVIEW.md for derivations, sources and exact limits. Claim expires 08:39 UTC.
- Next #4222: complete 10,924-word multibody-drift-control-v3.qmd read, findings recorded in docs/development/technical-review/multibody-v3-review.md; claimed through 09:41 UTC. No article edits yet. Derive and correct framework equivalence, constrained dynamics, spatial twists, power/energy and full controlled linearization before clearance.
