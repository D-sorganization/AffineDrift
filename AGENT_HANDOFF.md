...
- Physics glossary #4232: both complete editions and all 422 unique definitions are corrected in PR #4233, protected-squash-merged as 954d3975fcb777d09582fc0140c44c54b1e87a06. All protected checks passed. Deployment34117093101 remains in progress at this checkpoint. Full suite4268 and complete glossary/bibliography print and browser QA passed; see REVIEW.md for derivations and scope.
- Variational #4234: both complete editions (9,915/9,414 original words) are corrected after full reading. Remainders, ordered propagation, nonlinear flow derivatives, adjoint boundaries, pendulum numbers, QR, LTV stability, authority and geometric numerics are reconciled. Full suite4282 passes with29 skips,129 deselections and59 warnings; coverage92.36%; focused14, static34, content128/four skips, mypy74 and quality checks pass. Complete14-page PDF chapter and117 section browser views inspected. Final bounded-input/metric qualifiers are rebuilt and targeted QA checked. See REVIEW.md for precise evidence. Claim expires13:11UTC. No PR yet; only this wave must be replayed after ab5ac555e019efdb9d103dfbe604198ee167e72d onto protected main before first push.
- Next long source is the paired Volume I duality chapter; full reading, issue registration and claim remain pending. All405 sources are still in scope; no full-corpus completion is claimed.
