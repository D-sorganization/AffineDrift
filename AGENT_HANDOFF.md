...
- User-directed epic #4009 covers every textbook/article. Full-corpus #4021 and route batches #4054–#4061 remain open; the 405-source inventory records actual scope and does not certify unreviewed claims. Preserve the immutable upstream monograph boundary.
- Twenty-three correction batches through energy-transfer #4205 are published. Aerodynamic #4203 merged 13ebbfcbe9039038e3caea1c4a2dba7f70cd5b4d (deployment34001155414 success); energy #4205 merged 703344ebeaecda8f2faae518ee45d05bde0b4b5d (deployment34042314215 success). Earlier scopes and evidence are in docs/development/technical-review/REVIEW.md.
- The independent partial linear-algebra PR #4214 merged 3ccd69daa7c0d53ab31e7432c88fd846269a8ba2 and deployed34052864741 successfully. Follow-up #4215 completes both full editions: coordinate/rank distinctions, temporal control/observation, spectral counterexamples, metric/force duality, inverse sensitivity, spatial inertia/truss assembly and numerical/exercise corrections. Branch fix/linear-algebra-complete-derivations starts at that merge. Twenty-five new checks, extracted examples, 34 static contracts, 128 content/four skips, 348-source scan, Ruff, Black, CSS formatting and configured mypy pass. Full-suite result and publication update follow in REVIEW.md; merge/deploy are pending.
- Volume 0 PDF is rebuilt (301 pages); revised chapter physical pages17–46 all visually inspected. Web:29 displays/155 math containers/no math errors;24 desktop/mobile/dark views inspected. Eight wide equations scroll at17.78px and the comparison table fits390px. Local CSS fixes mobile readability. The final proof heading was shortened to eliminate the last chapter overfull warning; test gravity value was named for the code-quality rule, with25 focused checks passing again.
- Issue #4216 now completes the full 11,633-word critique review and rewrite: corrected Riccati/covariance/metric/penalty/noise/hybrid arguments, withdrawn invented evidence and a linked golf-swing investigation. Twenty-one new checks; 29 combined critique/reference checks pass. Full suite: 4,187 passed, 29 skipped, 129 deselected, 92.32% coverage; static34/content128 plus four skips/syntax348 and code checks pass. Thirty final critique views and three paired stochastic excerpt views inspected; 16 wide math containers scroll at17.78px on390px without page overflow. Paired reference QMD/TEX only fixes two stochastic product-spacing errors. No tracked PDF rebuilt. Detailed derivation/source/QA log is in REVIEW.md. PR #4219 uses fix/contraction-critique-complete on protected linear mergeec715e25.
- Linear PR #4217 merged ec715e258127fd30ee0897a611890ac5ee524911 after all protected checks; deployment34086327872 is running. Critique PR #4219 is open from b5518477 on that merge, with29 focused checks and all hooks passing. Current branch fix/contraction-critique-complete contains no applications-model edits. Required CI, merge and deployment remain pending.
- Applications #4218 is claimed through07:16 UTC. Both full editions and the existing model/tests/relevant generator were read. Local model checkpoint f377fc5c on fix/applications-model-rigor corrects kinetic-energy assembly, mode normalization, spring symmetry and rigid-counterfactual energy consistency: six red checks become49 combined green checks. It is based on old critique03ab0d96; replay only f377fc5c onto the current critique head before continuing. No generator/chapter edit or full validation yet. All mathematical/numerical/evidence issues remain to be corrected in both editions. See the issue and REVIEW.md. The405-source epic remains open.
- Worktree AffineDrift-technical-review is separate from the original AffineDrift checkout on unrelated fix/4211-deploy-website-rotation-converter. Verify live GitHub state before resuming. Keep temporary QA under docs/development/technical-review; browser CLI goto/snapshot can write root .playwright-cli and fail hygiene. Use run-code with explicit evidence paths, and move only our own temporary artifacts safely. Do not commit/push during a running build/render/test in the same worktree.
