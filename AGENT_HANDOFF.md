...
- Review slice #4254 is locally verified on `docs/4253-impact-dynamics-acoustics`,
  based on `39fa6cca`; PR not created. Provider: Tools #5068; consumer: UpstreamDrift #9700.
...
- Screw-axis publication is PR #4251. Every commit/push hook passed; the unpublished correction was rebased onto protected main1c45083f with identical reviewed tree b55231452a6681a87cd2fa83f3b5518073203bc4. Source head5cb1dc04; protected checks, merge and deployment pending. The next longest fully unaudited source is the paired Volume I contraction chapter; its full review is beginning, with no correction yet claimed.

- Active #4250: complete paired screw-axis chapter corrected on fix/4250-screw-axes-rigor. Finite relative displacement, twist fields, body/space conventions, inverse-transpose wrench transforms, grip power, reciprocal constraints and fully specified four-bar statics are reconciled. All15 exercises,55 print labels,24 index terms and five legacy web IDs retained. New independently checked examples have22 passing cases and100% statement coverage. Full root4,384 passes,29 skips,129 deselections; coverage78.59% configured src+scripts,92.5% for the same data restricted to src (compare prior src-only92.47%). Static34,content128/four skips,mypy77,Ruff/Black and separate targeted quality pass. All111 section views,22 equation edges,42 final targets,three final heading views,15 chapter PDF pages and contents/bibliography inspected. Final284-page Volume0 PDF retained; inherited book-wide duplicate labels remain outside certification. Mobile diagram presentation refined with keyboard-accessible horizontal scrolling; final verification14/14 with zero serious/critical axe violations. See screw-axes-review.md for all derivations, sources, failures and exact validation scope. No commit/push may overlap any test/render/browser QA job. Claim expires20:40:47UTC.
