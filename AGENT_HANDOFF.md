...
- **Mocap/C3D publication compatibility (AffineDrift #3959 / AFF-M3):** branch
  ...
  - Authoritative RED: test-only `dce77c11201ff38e60fadb34305862cb4ea01ba0`
    (tree `f59787c73a5b7193c88e25d7590c2ce1acd14619`), Actions run
    `33020153344`, job `98348290886`, OGLaptop-4, explicit `-n 0`; collection
    failed because `scripts.verify_mocap_c3d_publication` did not exist.
  - Implementation GREEN: `6b1747e62866c92c6e1a5bf496346ba209ec7912`
    (tree `ea3cbe8a2a71c8ff02b9f341f66110f1cac72cb1`), Actions run
    `33021666258`, job `98353255659`, OGLaptop-4, explicit `-n 0`; 10/10
    contract cases passed, Ruff passed, and Black left all five scoped files
    unchanged. A final exact-head rerun is required after this handoff update.
