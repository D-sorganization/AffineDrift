...
- Multibody #4222 and hybrid link repair #4225: PR #4226 protected-squash-merged as 4230258ef0d08459ec73df1df4516adb71671d8d. Deployment34106420009 succeeded through all build and deploy steps. Main-health #4224 can be reconciled against that successful publication. All 4,248 multibody-wave tests and visual checks passed. See REVIEW.md for exact scope.
- Superposition #4227: complete paired chapter corrected on fix/superposition-chapter-rigor. Full suite 4,265 passed, 29 skips, 129 deselections, coverage92.36%; twenty focused, 34 static, content128/four skips, mypy74 pass. All102 section views, fifteen final targeted views and fourteen chapter print pages inspected; Volume I PDF169 pages rebuilt. The stale Coriolis notation guard was updated to the explicit vector/matrix distinction in both editions. Claim expires11:08UTC. Final commit, protected PR and publication pending. Replay only this wave from base13ebd43de2192b092d8a2459515549721549d12a onto merged main before first push.
- Next source: Physics of Golf glossary TEX was read completely (10,020 original words). Paired QMD read, focused issue/claim, and all corrections remain pending. Findings include inertial/centrifugal confusion, erroneous COR limit interpretation, holonomic velocity restrictions, generalized momentum conservation, wrist-axis/lag confusion, unsupported tissue/feedback/sequence claims, malformed emphasis, circular cross-references and duplicate Wrapping entries. Do not label this glossary reviewed or corrected yet.
