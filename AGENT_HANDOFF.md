...
- **Next action:** push the completed implementation and exact evidence binding, create a regular PR, then verify protected merge and revision-matched live publication. Complete implementation is `e079999a136b5b8dc2c63c37f7c3989adb5603c0`; all two route reviews/four findings bind its actual committed evidence bytes. Leave governed critique `crit-strokes-gained-non-ergodic` open. Do not call corpus review complete.
