...
- Hybrid #4220: complete reference, critique and accessible companion corrected. PR #4223 protected-squash-merged as d3873c9e94afcb7cf54fb88c648f0cf3539b48a9. Deployment 34100279949 failed before publication on two links to an excluded critique manuscript. Repair #4225 and main-health #4224 are claimed through 10:46/10:53 UTC; the two links now target the published critiques index, and the stronger existing route test passes. The corrected CRITIC source remains intentionally excluded from public routes. Publish the repair with the multibody wave and verify deployment before claiming the hybrid wave is live.
- Multibody #4222: complete article rewritten with Cartesian, body-power, constraint, spatial, task and coordinate derivations. Branch fix/multibody-v3-rigor in AffineDrift-technical-review; PR #4226 open with protected auto-squash merge enabled. Full suite 4,248 passed; 16 new mechanics cases; 22 final focused cases including deployment links; content 128/four skips; configured mypy 74. All 105 section views and 12 final targeted views inspected. The article and new CSS/tests plus REVIEW.md, findings note, inventory and SPEC belong to this wave. Claim expires 09:41 UTC. Final 34 static checks pass; protected publication remains pending. Both repaired hybrid links were followed successfully in the browser.
- Next longest chapter: both complete ch03_superposition.tex and QMD sources were read, including all exercises. Findings registered as #4227 in docs/development/technical-review/superposition-review.md; no chapter edits yet. Findings include mismatched Christoffel units, body-frame transport omission, wrong QMD Coriolis signs/factors, inconsistent pendulum tables, contact reaction dependence, actuator-affinity conflation and unsupported passivity/contraction claims. Claim #4227, derive and verify before correction. Keep full corpus and final whole-book consistency work open.
