...
- Variational #4234: both complete editions (9,915/9,414 original words) are corrected after full reading. Remainders, ordered propagation, nonlinear flow derivatives, adjoint boundaries, pendulum numbers, QR, LTV stability, authority and geometric numerics are reconciled. Full suite4282 passes with29 skips,129 deselections and59 warnings; coverage92.36%; focused14, static34, content128/four skips, mypy74 and quality checks pass. Complete14-page PDF chapter and117 section browser views inspected. Final bounded-input/metric qualifiers are rebuilt and targeted QA checked. See REVIEW.md for precise evidence. Claim expires13:11UTC. PR #4235 is open at 0682ae24 after replaying only this wave onto protected main; normal protected auto-squash is enabled. Publication pending.
- Next long source is the paired Volume I duality chapter; both complete editions and the numerical generator are read. Issue #4236 records the findings; canonical correction is pending. All405 sources are still in scope; no full-corpus completion is claimed.
