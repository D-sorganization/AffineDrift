...
- Active #4291 on `fix/4291-inverse-dynamics-manuscripts`, base vendor head09a2471d. Four TeX editions, two explanatory notes, twelve original JPGs and stale PDF/HTML companions fully reviewed. All26 revised PDF pages visually pass; seven changed pages reinspected after final fixes. Both existing PDF filenames carry the identical verified13-page main manuscript. HTML guide eight width/theme views and axe pass. Independent mechanics/numeric checks, static34, title631, content130/4skips, Ruff, Black and mypy86 pass. Final root tests4782/29skips pass with79.04% coverage; no commit or PR yet. Read `docs/development/technical-review/inverse-manuscript-review.md`, especially the withdrawn reviewer drag-sign diagnosis: the original handwritten39.9% reduction is consistent under its own basis and remains a hypothetical scenario, not measured iron drag. Replay only this batch after09a2471d onto protected main before first push. No commit/push/switch during QA; corpus unfinished.
