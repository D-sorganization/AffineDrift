...
- **Current repair checkpoint:** SELF on `fix/4358-strokes-delivery`, regular PR4368. CI run34714267081 passed E2E but failed Python exact numerical JSON reproduction at final floating-point digits. A comparison with declared rtol1e-13/atol1e-14 now preserves exact structure/types/integer inputs and stored serialization; all47 focused numerical tests pass, including12 new regression cases; combined69 and root5309 pass (29 skip,132 deselected,59 warnings;79.35% coverage). Ruff/Black100/mypy91 pass. Artifact and scientific source bytes are unchanged. Every bound file was independently checked from repair commit `713a4ca5eeb13e0b8d4b43a79d3832e8e73a14f4`; the two route reviews and four findings now bind that commit. Push this pointer checkpoint and await fresh CI before protected merge.
- **Saved next chapter:** #4369 progress is committed and pushed at `0ca919d1` on `fix/4369-muscle-torque-rigor`. Eight independent mechanics tests pass; full root5305/79.35%. Its audit and handoff record sign, transpose, force feasibility, power, coupled coordinates, integrability and stiffness derivations. Public Chapter16 correction is still outstanding. Resume after integrating the strokes delivery.
...
- **Remaining corpus:** muscle-to-joint torques (~5283 original words; full print source read, web only first110 lines; sign/transpose, feasibility, anatomy, inverse-estimation and unsupported coaching issues identified, no edits/claim yet), nullspace (~5174), curiosity (~5123), many indexed/partial entries, and five read DCR critiques #4340. Review index is not proof of full review. Central DL checker reports peer DL1595/3903/3902 metadata gaps; preserve those entries. This checkpoint updates DL4358/4355/4353 and the corpus index; the overall goal is deliberately still active.
