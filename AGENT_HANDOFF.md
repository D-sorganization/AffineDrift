...
- Next: restore six proven render-only files, explicitly stage canonical files, commit and open the protected PR. All local QA sessions are reaped. Replay onto the double-pendulum squash only after all QA sessions are reaped; parent fe8ee652 and squash e9ad402e have equal tree d8932835286b0ed9ed2e31bc4066073d6b9fbd94. Open a ready PR and use protected squash auto-merge. Never stage scratch files or mutate Git while local tests/render/browser QA run. Idle preview port 8767 remains.
