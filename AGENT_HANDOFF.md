...
- Active wrist #4299 on `fix/4299-wrist-constraint-mechanics`; all local review/checks complete. Root4850/29 skips (src coverage92.98%), content130, JavaScript351, static34, title631, Ruff/Black/mypy and critical10 pass. All14 PDF pages,143 web captures and4 Qt views inspected. See `docs/development/technical-review/wrist-review.md`. Replayed onto a37f5cae as be5612c6; range-diff confirms the identical wrist patch. Isolated pre-push typing now passes after installing its missing optional UI dependencies; protected PR delivery remains. PoE4300 published f07bf036 (deployment34292478895/artifact10082702228 pass956/239). Biology4296 published via d7e51655 (artifact10081509020). Next long chapter #4303 has both complete editions read and an issue under epic4009, but no edits or claim yet. Corpus405 remains unfinished. Never mutate checkout during local tests/build/QA.
