...
- PR #4165 closed #4164 and merged as `627918628c52ef0320136f201668a5f816717f8a`; final CI passed 3,767 tests, 92.29% coverage, all eight book builds, and every check. Deployment 33968761331 succeeded through every revision-matched live route; direct live inspection confirms 135 math expressions without errors or mobile overflow. It corrects the full aerodynamic chapter in both editions: air-relative forces, distributed moments, inverse signs, energy, input dependence, reproducible forward counterfactuals, ball flight, and environmental sensitivity. Validation: 3,767 tests, 29 skips, 92.32% coverage; 128 content checks and 34 static contracts. The 573-page PDF and all nine revised pages are inspected; HTML has 135 math expressions, zero math errors, and no page overflow at 1440/390 pixels. Adjacent chapters and the remaining corpus still need their own audits.
- PR #4167 merged as `e79dbdee039a00b3a83f9732c3f2d6515c31c0b8` with every check green (3,781 CI tests and eight book builds); deployment 33972606460 was superseded by the next merge; combined publication is tracked in 33974016554. Its correction for #4166 on `fix/motion-control-foundations` rebuilds the motion-control introduction in four source editions, corrects the repeated chapter-two input-rank bound, and refreshes dependent evidence digests without broadening existing review claims. Local validation: 3,780 tests, 29 skips, 92.32% coverage; 128 content checks; all 34 static contracts; 13 new mathematical/regression checks. Four PDFs rebuilt (107/83/10/16 pages), with all 27 revised introduction pages, covers, preface, and targeted rank passages inspected. Website: 1,072 math expressions, zero errors, no overflow at 1440/390 pixels. Full chapter-two and remaining corpus audits remain pending.
- PR #4170 merged as `9efa16e9a9f6931c3a820f8a85878063e426607d` after all checks passed (3,797 CI tests and eight book builds). Deployment 33974016554 includes both motion corrections and succeeded through every revision-matched live route. Its correction for issue #4168 on `fix/motion-curve-geometry` rebuilds the complete curve chapter in all four source editions. It separates state/configuration/physical geometry, repairs regularity and Frenet conventions, derives force and path-timing constraints, and replaces the false transverse-stability formula with exact coordinates and checked counterexamples. Sixteen new numerical/regression checks pass. Local full suite: 3,796 tests, 29 skips, 92.32% coverage; 128 content checks and 34 static contracts. Three PDFs regenerated and revised pages inspected; web volume has 1,035 math expressions without errors and no mobile overflow, with all 21 revised display equations actually typeset. The remainder of both books still needs full review.
- PR #4172 for issue #4169 on `fix/configuration-manifold-mechanics` is fully corrected in four source editions: joint topology, rotation singularities, force covectors, kinetic geometry, passive energy, frame-consistent attitude tracking, and golf inference. Local suite: 3,812 tests, 29 skips; 128 content checks, four skips; 34 static contracts; 15 new numerical/source checks. Three PDFs (94/71/10 pages) and all 29 revised pages are inspected. All 17 revised web displays typeset without errors or mobile overflow. Merged as `0ed10bdb28705e829e1aa99d2662ecda7731a977` after all final-head checks passed, including 3,812 CI tests and all eight book builds; deployment 33975676795 succeeded through every revision-matched live route.
- PR #4174 for issue #4171 on `fix/orbital-stability-mechanics` fully corrects the orbital chapter in four editions: timed/set/finite-event stability, exact transverse coordinates, Floquet limits, hybrid timing, nonnormal transients, event outputs, and Riccati/tube conditions. Local validation: 3,828 tests, 29 skips, 92.32% coverage; 128 content checks, four skips; 34 static contracts; 16 new mathematical/source checks. Three PDFs (88/66/9 pages) and all 27 revised pages are inspected. All 20 revised web displays typeset, the new figure loads, and desktop/mobile pages have no overflow. Merged as `c6496781dc9f96894dd0f78eb8c8b563e474c2cd` after every check passed, including 3,828 CI tests and all eight book builds. Deployment 33977761586 succeeded through every revision-matched live route.
- Issue #4173 on `fix/trajectory-optimization-rigor` fully corrects the trajectory-optimization chapter in four editions: free-time OCP, Hamiltonian signs, collocation, feasibility, clubhead kinematics, multiplicative noise, event covariance, and statistical scope. Local suite: 3,844 tests, 29 skips, 92.32% coverage; 128 content checks, four skips; 34 static contracts; 16 new mathematical/source checks. Three PDFs (88/70/9 pages), all 27 revised pages, and all 14 revised web displays are inspected. The shared figure loads; desktop/mobile pages have no overflow. PR #4178 is open; final-head CI and publication remain pending. CI false positive #4181 is repaired in the syntax scanner: valid starred operator names are allowed while corrupt argument subscripts remain detectable; four new regression cases and the 348-file corpus scan pass. Visual inspection additionally found the long-section opacity defect #4176; its threshold repair passes two real-browser regressions, 325 JavaScript tests (19 skipped), and 34 static contracts. Next full chapter: funnel synthesis #4175, claimed by this session.
- Issue #4175 on `fix/nonlinear-funnel-certificates` fully corrects the funnel chapter in four editions: moving-boundary invariance, saturation and disturbance floors, impact goals, forward/backward sets, SOS strictness, whole-interval verification, volume and output sensitivity, and golf inference. Local full suite: 3,862 tests, 29 skips, 92.32% coverage; 128 content checks, four skips; 34 static contracts; 18 new mathematical/source checks. Three PDFs (90/77/10 pages), all 29 revised pages, and all nine revised web displays are inspected. The web volume has 1,055 math containers, no math errors or desktop/mobile overflow, and verified parent opacity. Commit/PR/CI/publication remain pending. Subsequent findings: #4177 (claimed), #4179, #4180; these chapters are not yet corrected.
- Issue #4177 on branch fix/phase-control-rigor fully corrects phase coordinates, virtual constraints, internal dynamics, actuation power, and hybrid contact in four editions. Local validation: 3,880 tests, 29 skips, 92.32% coverage; 14 focused checks; 128 content checks/four skips; 34 static contracts and 348-source syntax scan. Three PDFs (92/80/6 pages), all 18 revised print pages, and 12 actual web displays verified; 1,108 math containers, zero math errors, opacity one, no 1440/390 page overflow. Commit/PR/publication pending. Funnel PR #4182 awaits browser CI; trajectory PR #4178 merged, deployment 33981540954 pending. Stochastic #4179 and learning #4180 are claimed but not corrected. Full corpus remains open.
- Issue #4179 on fix/stochastic-motor-variability fully corrects noise models, units, moment stability, mechanical uncertainty transport, effort objectives, contact risk, and golf interpretation in four editions. Local: 3,900 tests/29 skips/92.32% coverage; 20 focused checks, 128 content/four skips, 34 static contracts, 348-source syntax scan. Three PDFs 93/85/7 pages; all 21 revised pages and 12 web displays verified, 1,173 math containers, zero math errors, no 1440/390 overflow, light/dark appearance inspected. Commit/PR/publication pending. PR #4178 deployed successfully; #4182 merged (3defe864), deployment 33983136557 pending; #4183 final e5c8c54f awaits browser CI. Learning #4180 is drafted only; corpus remains open.
- Issue #4180 on fix/learning-controller-rigor fully corrects ILC convergence and noise, identification limits, policy-search claims, and controller-library guarantees in four editions. Local: 3,920 tests/29 skips/92.32% coverage; 20 focused checks, 128 content/four skips, 34 static contracts, 348-source syntax scan. Three PDFs 94/90/7 pages; all 20 revised pages and 10 web displays verified, 1,224 math containers, no math errors or 1440/390 overflow, light/dark inspected. Local content commit 0bd259a8; PR pending. Final validation also repaired a false-positive rejection of a valid LaTeX endgroup command: old validator fails the new regression, fixed validator passes all 42 structure tests and the full article structure scan. Phase #4183 merged as 693e4a5f, deployment 33984854219 pending; funnel deploy succeeded; stochastic #4185 final75406b7f awaits browser CI. #4184 is drafted only; corpus remains open.

- Issue #4184 on fix/golf-case-study-and-glossary corrects all four case-study editions and all three shared glossary/reading-list copies. Local: 3,936 tests/29 skips/92.32% coverage, 16 mathematical/source checks, 128 content/four skips; 34 static contracts and 348-source scan pass with pending #4186 validator repair. Five PDFs 299/189/100/94/6 pages; all 33 revised pages inspected, eight web displays and 1,260 math containers verified with no math errors or desktop/mobile overflow. Final print headers/page breaks inspected. PR #4188 opened from rebased content 341abc6e on merged learning #4186 (e611e3ad); all 58 combined case/validator checks pass after rebase. Phase is published; stochastic #4185 merged 11f3e623, deploy33986589045 pending. Full corpus remains open.
- Issue #4187 on fix/manifesto-rigid-flexible-foundations: canonical first article and paired foundational sections corrected. Local 3,949 tests/29 skips, 13 independent/source checks, 25 combined checks, 128 content/four skips, 34 static contracts (with merged validator repair), 348-source scan; three web routes, 24/24/25 revised displays, 198/509/597 math containers, zero errors/no 1440/390 overflow, nine screenshots inspected. PR #4191 opened from rebased content 6e6d8002 on merged case #4188 (6ad676bb); all 55 combined foundation/validator checks pass after rebase. Learning deployment33988300905 succeeded. Modal #4189 source corrections pass 3,964 local tests and are completing static/browser validation. Counterfactual/invariance #4190 is claimed; full corpus remains open.
- Issue #4189 on fix/modal-appendices-and-pendulum-models: canonical Part 4 and both long-edition appendices corrected. Local 3,964 tests/29 skips/92.32% coverage, 15 independent/source checks, 128 content/four skips, 34 static contracts with merged validator, 348-source scan. Three web routes with 28 scoped displays each, 136/524/542 math containers, no errors or 1440/390 overflow; nine final screenshots and three figure views inspected. PR #4193 opened from rebased content89e55f2f on merged foundations #4191 (e4977cd7); all 57 combined modal/validator checks pass. Case deployment33990065773 succeeded; foundations deployment is pending. Counterfactual/invariance #4190 is claimed, sources read, edits next; corpus remains open.
- Issue #4190 on fix/counterfactual-invariance-and-evidence completes canonical Parts 2/3/5 and both long editions, with Koike bibliography correction and evidence digest refresh. Local 3,986 tests/29 skips/92.32% coverage; 22 new mathematical/source checks; 128 content/four skips; 34 static contracts and 348-source scan. Six routes: 201/114/90/13/551/580 math containers, zero math errors/no 1440/390 overflow, all 27 final screenshots inspected. PR #4195 opened from rebased content6e6eaee5 on merged modal #4193 (56cd949c); all 64 combined counterfactual/validator checks pass. Foundations deployment33991664176 succeeded; modal deployment pending. Tangent reference #4192 claimed/read, source edits next; full corpus remains open.
- Issue #4192 on fix/tangent-reference-foundations corrects unified-reference Parts I/II, conclusion and appendices. Local 4,006 tests/29 skips/92.32% coverage; 20 new checks; 128 content/four skips; 34 static contracts and 348-source scan. All 159 displays typeset, 743 math containers, no errors or 1440/390 page overflow; 15 target views inspected. PR #4196 is open; content rebased as d40f1741 onto counterfactual #4195 merge db5dc202, with 46 combined post-rebase checks passing. Modal #4193 is published through deployment33993093520; counterfactual deployment is pending. Part III fully read and tracked in #4194, with 17 independent prototype checks passing; source corrections next. Full corpus remains open.
- Issue #4194 on fix/tangent-reference-control-and-cases completes unified-reference Part III; the entire manuscript is now substantively reviewed across #4192/#4194. Local 4,029 tests/29 skips/92.32% coverage, 23 new checks, 47 combined checks, 128 content/four skips, 34 static contracts, 348-source scan. Published orbital code separately reproduced; all 165 displays/732 math containers verified, zero math errors or 1440/390 page overflow, 18 final views inspected. PR #4199 rebased as fad0ea3e onto foundations merge 04e38261; 69 combined checks pass after rebase. Counterfactual #4195 is published; foundations deployment33996201945 is in progress. Long impact/flight reference fully read, findings #4197/#4198 claimed; contact and linked rotation/reference-point corrections are in progress in the separate review worktree. Full corpus remains open.
